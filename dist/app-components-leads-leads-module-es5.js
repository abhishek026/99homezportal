(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app-components-leads-leads-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsLeadsDataSetupDataSetupComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsLeadsEnquiryAddEnquiryAddComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsLeadsEnquiryEnquiryCustomUserEnquiryComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = "<ng-content select=\"[input-def]\">\n  \n</ng-content>\n";
      /***/
    },
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsLeadsLeadsHomeLeadsHomeComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsLeadsLeadsComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsLeadsManageCampaignManageCampaignComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsLeadsDataSetupDataSetupComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsLeadsDataSetupDataSetupComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _services_closing_reason_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ../services/closing-reason.service */
      ...
      var _services_enquiry_services_post_enquiry_data_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../../../services/enquiry-services/post-enquiry-data.service */
      "./src/app/services/enquiry-services/post-enquiry-data.service.ts");
      /* harmony import */
      ...
      var _services_institute_setting_service_institute_setting_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      ...
      function () {
        var DataSetupComponent = /*#__PURE__*/function () {
          function DataSetupComponent(service, appC, services, httpService, auth, postData, router, apiService, commonService) {
          ...
          _createClass(DataSetupComponent, [{
            ...
            value: function ngOnInit() {
              ...
              this.auth.institute_type.subscribe(function (res) {
                if (res == 'LANG') {
                  _this.isProfessional = true; // batch module
                } else {
                  _this.isProfessional = false; //course module
                }
              }); // this.getAllReasons();
            ...
            key: "toggleCreateNewReason",
            value: function toggleCreateNewReason() {
            ...
            value: function getAllReasons() {
              ...
              this.service.getAllReasons().subscribe(function (data) {
                _this2.auth.hideLoader();

                _this2.dataStatus = false;
                _this2.getAllClosingReasons = data;
              }, function (error) {
                _this2.auth.hideLoader();

                _this2.dataStatus = false; // this.errorMessage(error);
              });
            }
          }, {
            key: "saveInformation",
            value: function saveInformation(row, index) {
              ...
              if (row.new_source_name == "" || row.new_source_name == null) {
                this.appC.popToast({
                  type: 'error',
                  body: "Closing reason can't be empty"
                });
              } else {
                ...
                if (row.new_source_name.trim() == '') {
                  ...
                  this.service.updateClosingReason(obj, row.closing_reason_id).subscribe(function (data) {
                    ...
                    _this3.services.showErrorMessage("success", "", "Reason updated successfully");

                    _this3.getAllReasons();
                  }, function (err) {
                    _this3.auth.hideLoader();
            ...
            key: "createNewReason",
            value: function createNewReason() {
              var _this4 = this;
              ...
              if (this.createNewReasonObj.closing_desc == "") {
                ...
                if (this.createNewReasonObj.closing_desc.trim() == '') {
                  ...
                  this.service.createReason(this.createNewReasonObj).subscribe(function (data) {
                    ...
                    _this4.services.showErrorMessage("success", "", "Reason Created Successfully");

                    _this4.showToggle = false;

                    _this4.getAllReasons();

                    _this4.createNewReasonObj.closing_desc = "";
            ...
            key: "EditSource",
            value: function EditSource(obj, name) {
              obj.isEdit = true;
              obj.new_source_name = name;
            }
          }, {
            key: "cancelEditSource",
            value: function cancelEditSource(obj) {
              obj.isEdit = false;
              obj.new_source_name = '';
            }
          }, {
            key: "updateSource",
            value: function updateSource(obj) {
              var _this5 = this;
              ...
              if (obj.new_source_name.trim() != '') {
                if (this.sourceDetails.filter(function (x) {
                  return x.name == obj.new_source_name.trim() && x.id != obj.id;
                }).length == 0) {
                  this.auth.showLoader();
                  this.httpService.putData("/api/v1/enquiry_campaign/master/lead_source", data).subscribe(function (res) {
                    _this5.auth.hideLoader();

                    _this5.services.showErrorMessage('success', '', 'Source updated successfully');

                    _this5.getSourceDetails();
                  }, function (err) {
                    _this5.auth.hideLoader();

                    _this5.services.showErrorMessage('error', '', err.error.message);
                  });
                } else {
            ...
            key: "deleteSource",
            value: function deleteSource(obj) {
              var _this6 = this;
              ...
              this.auth.showLoader();
              this.httpService.deleteData('/api/v1/enquiry_campaign/master/lead_source', data).subscribe(function (res) {
                _this6.auth.hideLoader();

                _this6.services.showErrorMessage('success', '', 'Source deleted successfully');

                $('#deleteModal').modal('hide');

                _this6.getSourceDetails();
              }, function (err) {
                _this6.auth.hideLoader();

                _this6.services.showErrorMessage('error', '', err.error.message);
            ...
            value: function getSourceDetails() {
              var _this7 = this;

              var url = "/api/v1/enquiry_campaign/master/lead_source/" + sessionStorage.getItem('institute_id') + "/all";
              this.auth.showLoader();
              this.httpService.getData(url).subscribe(function (res) {
                _this7.auth.hideLoader();

                _this7.sourceDetails = res;
              }, function (err) {
                _this7.auth.hideLoader();
              });
            }
            ...
            key: "addSourceData",
            value: function addSourceData() {
              var _this8 = this;

              var url = "/api/v1/enquiry_campaign/master/lead_source";

              if (this.createSource.name.trim() != '') {
                if (this.sourceDetails.filter(function (x) {
                  return x.name == _this8.createSource.name.trim();
                }).length == 0) {
                  this.auth.showLoader();
                  this.httpService.postData(url, this.createSource).subscribe(function (el) {
                    _this8.auth.hideLoader();

                    _this8.services.showErrorMessage('success', '', 'Source added successfully');

                    _this8.getSourceDetails();

                    _this8.createSource.name = '';
                  }, function (err) {
                    _this8.auth.hideLoader();

                    _this8.services.showErrorMessage('error', '', err.error.message);
                  });
                } else {
                  this.services.showErrorMessage('error', '', 'Source name already exist!');
                }
            ...
            key: "addReferData",
            value: function addReferData() {
              var _this9 = this;

              if (this.createReferer.name.trim() != '') {
                if (this.referList.filter(function (x) {
                  return x.name == _this9.createReferer.name.trim();
                }).length == 0) {
                  this.auth.showLoader();
                  this.httpService.postData('/api/v1/enquiry_campaign/master/lead_referred_by', this.createReferer).subscribe(function (el) {
                    _this9.createReferer.name = '';

                    _this9.auth.hideLoader();

                    _this9.fetchReferInfo();

                    _this9.services.showErrorMessage('success', '', 'Referrer Added Successfully');
                  }, function (err) {
                    _this9.auth.hideLoader();

                    _this9.services.showErrorMessage('error', '', err.error.message);
                  });
                } else {
            ...
            key: "fetchReferInfo",
            value: function fetchReferInfo() {
              var _this10 = this;

              this.auth.showLoader();
              this.httpService.getData('/api/v1/enquiry_campaign/master/lead_referred_by/' + sessionStorage.getItem('institute_id') + "/all").subscribe(function (data) {
                _this10.auth.hideLoader();

                _this10.referList = data;
              }, function (err) {
                _this10.auth.hideLoader();
            ...
            key: "checkValuetype",
            value: function checkValuetype(value) {
            ...
            value: function fetchPrefillData() {
              ...
              this.auth.showLoader();
              var url = '/api/v1/masterData/type/CUSTOM_COMPONENT_TYPE';
              this.httpService.getData(url).subscribe(function (res) {
                _this11.auth.hideLoader();

                _this11.componentShell = res;
                console.log("type value", _this11.componentShell);
              }, function (err) {
                _this11.auth.hideLoader();
              });
            }
            ...
            key: "fetchCustomFild",
            value: function fetchCustomFild() {
              var _this12 = this;

              this.auth.showLoader();
              var url = '/api/v1/instCustomComp/getAll/' + sessionStorage.getItem('institute_id') + "?page=1";
              this.httpService.getData(url).subscribe(function (res) {
                _this12.auth.hideLoader();

                _this12.custumFieldList = res;
                console.log("custom filed data", _this12.custumFieldList);
              }, function (err) {
                _this12.auth.hideLoader();

                _this12.custumFieldList = [];
              });
            }
          }, {
            key: "addNewCustomField",
            value: function addNewCustomField() {
              var _this13 = this;
              ...
              if (this.editCustomFormField.label.trim() != "-1") {
                if (this.editCustomFormField.type != "-1") {
                  ...
                  if (this.editCustomFormField.type == "3" || this.editCustomFormField.type == "4") {
                    ...
                    if (this.validateDropDown(this.editCustomFormField.prefilled_data)) {
                      if (this.validateDropdownDefvalue(this.editCustomFormField.prefilled_data, this.editCustomFormField.defaultValue)) {
                        this.auth.showLoader();
                        this.postData.addNewCustomComponent(this.editCustomFormField).subscribe(function (res) {
                          _this13.auth.hideLoader();

                          _this13.services.showErrorMessage('success', '', 'Form-Field added successfully');

                          _this13.fetchCustomFild();

                          _this13.cleareForm();
                        }, function (err) {
                          _this13.auth.hideLoader();

                          _this13.services.showErrorMessage('error', '', 'Label name is already created with the same name');
                        });
                      } else {
                  ...
                  /* Date Custom Component */
                      ...
                      if (this.editCustomFormField.is_searchable == "N" && this.editCustomFormField.defaultValue.trim() == "") {
                        ...
                        this.postData.addNewCustomComponent(this.editCustomFormField).subscribe(function (res) {
                          ...
                          _this13.services.showErrorMessage('error', '', 'There was an error processing your request' + err.error.message);
                        });
                      } else {
                    ...
                    /* Textbox and Checkbox */
                        ...
                        this.postData.addNewCustomComponent(this.editCustomFormField).subscribe(function (res) {
                          ...
                          _this13.services.showErrorMessage('error', '', 'Label name already exists');
                        });
                      }
                } else {
            ...
            key: "onClickeditCustomField",
            value: function onClickeditCustomField(obj) {
            ...
            key: "onClickAddField",
            value: function onClickAddField(types) {
              this.isEditCustumFormField = types;
            }
          }, {
            key: "updateCustumField",
            value: function updateCustumField() {
              var _this14 = this;

              var data = this.editCustomFormField; //Case 1 Label/Type is not empty and MaxLength and Sequence
                  ...
                  if (this.validateDropDown(data.prefilled_data)) {
                    if (this.validateDropdownDefvalue(data.prefilled_data, data.defaultValue)) {
                      ...
                      this.postData.updateCustomComponent(data).subscribe(function (res) {
                        ...
                        _this14.services.showErrorMessage('success', '', 'Form-Field  Updated Successfully');

                        _this14.cleareForm();
                      }, function (err) {
                        _this14.auth.hideLoader();

                        _this14.services.showErrorMessage('error', '', err.error.message);
                      });
                    } else {
                      this.services.showErrorMessage('error', 'dropdown default value should be present in prefilled data', '');
                    }
            ...
            key: "selecteCustomformId",
            value: function selecteCustomformId(obj) {
              this.component_id = obj;
            }
          }, {
            key: "deleteCustumfomField",
            value: function deleteCustumfomField() {
              var _this15 = this;

              var obj = this.component_id;
              this.auth.showLoader();
              this.postData.deleteCustomComponent(obj).subscribe(function (res) {
                _this15.auth.hideLoader();

                _this15.services.showErrorMessage('success', 'Form-field Deleted ', 'requested form-field deleted Successfully');

                _this15.fetchCustomFild();

                $('#deleteModal').modal('hide');
              }, function (err) {
                _this15.auth.hideLoader();

                _this15.services.showErrorMessage('error', '', err.error.message);
              });
            }
          }, {
            key: "cleareForm",
            value: function cleareForm() {
              this.isEditCustumFormField = "";
              this.emptyCustomField();
            }
          }, {
            key: "emptyCustomField",
            value: function emptyCustomField() {
              this.editCustomFormField = {
                comp_length: '',
                description: "",
                institution_id: sessionStorage.getItem('institute_id'),
            ...
            key: "updateRefer",
            value: function updateRefer(obj) {
              var _this16 = this;
              ...
              if (obj.new_source_name.trim() != '') {
                if (this.referList.filter(function (x) {
                  ...
                  this.auth.showLoader();
                  this.httpService.putData('/api/v1/enquiry_campaign/master/lead_referred_by', data).subscribe(function (res) {
                    _this16.auth.hideLoader();

                    _this16.services.showErrorMessage('success', '', 'Reference updated Successfully');

                    _this16.fetchReferInfo();
                  }, function (err) {
                    _this16.auth.hideLoader();

                    _this16.services.showErrorMessage('error', '', err.error.message);
                  });
                } else {
                  this.services.showErrorMessage('error', '', 'Referrer name already exist!');
                }
            ...
            key: "deleteRefer",
            value: function deleteRefer(obj) {
              var _this17 = this;
              ...
              this.auth.showLoader();
              this.httpService.deleteData('/api/v1/enquiry_campaign/master/lead_referred_by', data).subscribe(function (res) {
                _this17.auth.hideLoader();

                _this17.services.showErrorMessage('success', '', 'Reference deleted Successfully');

                $('#deleteModal').modal('hide');

                _this17.fetchReferInfo();
              }, function (err) {
                _this17.auth.hideLoader();
                ...
                if (err.status == 500) {
                  ...
                  _this17.services.showErrorMessage('error', '', err.error.message);
                } else {
                  _this17.services.showErrorMessage('error', '', err.error.message);
                }
              });
            ...
            value: function getStateList() {
              ...
              this.httpService.getData(url).subscribe(function (res) {
                ...
                if (res.result.length > 0) {
                  _this18.stateList = res.result[0].stateList;
                }
              }, function (err) {
                _this18.auth.hideLoader();

                _this18.services.showErrorMessage('error', '', err);
              });
            ...
            value: function getCityList() {
              ...
              this.httpService.getData(url).subscribe(function (res) {
                ...
                if (res.result.length > 0) {
                  _this19.cityList = res.result[0].cityList;
                }
              }, function (err) {
                _this19.auth.hideLoader();

                _this19.services.showErrorMessage('error', '', err);
              });
            }
          }, {
            key: "searchArea",
            value: function searchArea() {
              ...
              var url = "/api/v1/cityArea/area/view/".concat(sessionStorage.getItem('institute_id'), "?country_ids=").concat(this.filter.country_ids, "&state_ids=").concat(this.filter.state_ids, "&city_ids=").concat(this.filter.city_ids, "&is_active=").concat(is_active_status);
              this.auth.showLoader();
              this.httpService.getData(url).subscribe(function (res) {
                _this20.auth.hideLoader();

                _this20.countryStateAreaList = res.result;
                _this20.tempArealist = res.result;
              }, function (err) {
                _this20.auth.hideLoader();

                _this20.services.showErrorMessage('error', '', 'Please check your internet connection or contact at support@proctur.com if the issue persist');
              });
            }
          }, {
            key: "searchDatabase",
            value: function searchDatabase() {
              ...
              if (this.areaSearchInput == undefined || this.areaSearchInput == null) {
                ...
                this.countryStateAreaList = this.tempArealist.filter(function (item) {
                  return Object.keys(item).some(function (k) {
                    return item[k] != null && item[k].toString().toLowerCase().includes(_this21.areaSearchInput.toLowerCase());
                  });
                });
              }
            }
            ...
            value: function updateArea() {
              ...
              if (this.editAreaName.trim().length > 0) {
                ...
                this.httpService.putData(url, obj).subscribe(function (res) {
                  ...
                  _this22.editAreaName = '';
                  _this22.editIsActiveStatus = true;

                  _this22.services.showErrorMessage('success', '', res.message);
                  ...
                  _this22.services.showErrorMessage('error', '', err);
                });
              } else {
            ...
            value: function deleteArea() {
              ...
              var url = "/api/v1/cityArea/area/delete/".concat(sessionStorage.getItem('institute_id'), "/").concat(this.deleteAreaId.id);
              this.auth.showLoader();
              this.httpService.deleteData(url, null).subscribe(function (res) {
                _this23.auth.hideLoader();

                _this23.services.showErrorMessage('success', '', res.message);

                _this23.deleteAreaId = '';
                $('#deleteModal').modal('hide');
                ...
                _this23.services.showErrorMessage('error', '', err.error.message);
              });
            }
          }, {
            key: "toggleAddArea",
            ...
            key: "toggleNewPopupsVisisbility",
            value: function toggleNewPopupsVisisbility(type) {
              this.isEditcustumfield = type; //this.emptyObject();
            }
          }, {
            key: "cancelRow",
            ...
            value: function validateDropDown(data) {
              var arr = data.split(',');
            ...
            key: "validateDropdownDefvalue",
            value: function validateDropdownDefvalue(tocheck, tomatch) {
            ...
            key: "validateDropDownUpdate",
            value: function validateDropDownUpdate(data) {
              var arr = data.split(',');
              /* boolean for non empty value */
            ...
            key: "saveLeadSettings",
            value: function saveLeadSettings() {
              var _this24 = this;

              var dataToSend = {}; // if (this.leadSettings.gst_enabled) {
              ...
              this.apiService.savePartialData(dataToSend).subscribe(function (res) {
                ...
                _this24.commonService.showErrorMessage('success', '', "All your setting saved successfully");

                _this24.cancel();
              }, function (err) {
                _this24.auth.hideLoader();

                _this24.commonService.showErrorMessage('error', '', err.error.message);
        ...
        DataSetupComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          ...
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/leads/data-setup/data-setup.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./data-setup.component.scss */
          "./src/app/components/leads/data-setup/data-setup.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [_services_closing_reason_service__WEBPACK_IMPORTED_MODULE_1__["ClosingReasonService"], _app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"], _services_message_show_service__WEBPACK_IMPORTED_MODULE_3__["MessageShowService"], _services_http_service__WEBPACK_IMPORTED_MODULE_4__["HttpService"], _services_authenticator_service__WEBPACK_IMPORTED_MODULE_5__["AuthenticatorService"], _services_enquiry_services_post_enquiry_data_service__WEBPACK_IMPORTED_MODULE_6__["PostEnquiryDataService"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"], _services_institute_setting_service_institute_setting_service__WEBPACK_IMPORTED_MODULE_8__["InstituteSettingService"], _services_common_service__WEBPACK_IMPORTED_MODULE_9__["CommonServiceFactory"]])], DataSetupComponent);
        return DataSetupComponent;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsLeadsEnquiryAddEnquiryAddComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsLeadsEnquiryAddEnquiryAddComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EnquiryAddComponent", function () {
      ...
      var _services_enquiry_services_post_enquiry_data_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../../../services/enquiry-services/post-enquiry-data.service */
      "./src/app/services/enquiry-services/post-enquiry-data.service.ts");
      /* harmony import */


      var _services_fetchprefilldata_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../../../services/fetchprefilldata.service */
      "./src/app/services/fetchprefilldata.service.ts");
      /* harmony import */
      ...
      var _services_login_services_login_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ../../../services/login-services/login.service */
      "./src/app/services/login-services/login.service.ts");
      /* harmony import */


      var _services_multiBranchdata_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ../../../services/multiBranchdata.service */
      "./src/app/services/multiBranchdata.service.ts");
      /* harmony import */


      var _services_common_api_call_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ../../../services/common-api-call.service */
      "./src/app/services/common-api-call.service.ts");
      /* harmony import */


      var _utils_commonUtils__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ../../../utils/commonUtils */
      ...
      var EnquiryAddComponent =
      /** @class */
      function () {
        var EnquiryAddComponent = /*#__PURE__*/function () {
          function EnquiryAddComponent(prefill, router, poster, login, auth, multiBranchService, commonServiceFactory, httpService, commonApiCallService) {
            var _this25 = this;

            _classCallCheck(this, EnquiryAddComponent);
            ...
            this.isRippleLoad = false; // state and city list
            ...
            this.schoolModel = false; // Changes by - Nalini to hide Add bulk Enquiry and Upload Enq for custom user (As discussed with Nitin)
            ...
            this.auth.schoolModel.subscribe(function (res) {
              _this25.schoolModel = false;

              if (res) {
                _this25.schoolModel = true;
              }
            });
            ...
            commonApiCallService.fetchMasterData().subscribe(function (data) {
              _this25.masterDataList = data;
            });

            if (this.schoolModel) {
              commonApiCallService.getAllFinancialYear().subscribe(function (data) {
                _this25.instAcademicYrList = data;
              });
            }
          }
          /* OnInit Initialized */
          ...
          _createClass(EnquiryAddComponent, [{
            key: "ngOnInit",
            value: function ngOnInit() {
              var _this26 = this;
              ...
              if (sessionStorage.getItem('permissions') == undefined || sessionStorage.getItem('permissions') == '' || sessionStorage.getItem('permissions') == null || this.role_feature.LEAD_ENQUIRY_FULL_ACCESS) {
                ...
                if (JSON.parse(sessionStorage.getItem('permissions')).length == 1) {
                  if (this.role_feature.LEAD_MANAGE_ENQUIRY) this.permission = true;
                }
              }
              ...
              this.auth.isMainBranch.subscribe(function (value) {
                _this26.isMainBranch = value;

                if (_this26.isMainBranch == "Y") {
                  _this26.newEnqData.source_instituteId = sessionStorage.getItem('institute_id');

                  _this26.multiBranchInstituteFound(_this26.newEnqData.source_instituteId);
                }
              });
              this.multiBranchService.subBranchSelected.subscribe(function (res) {
                _this26.subBranchSelected = res;

                if (_this26.subBranchSelected) {
                  _this26.newEnqData.source_instituteId = sessionStorage.getItem('institute_id');
                  var mainBranchId = sessionStorage.getItem('mainBranchId');

                  if (mainBranchId != null) {
                    _this26.multiBranchInstituteFound(mainBranchId);
                  }
                }
              });
            ...
            key: "checkCustomeComponentElement",
            value: function checkCustomeComponentElement(index) {
              if (!(index % 3)) {
                return true;
              } else {
                return false;
            ...
            key: "convertToEnquiryDetected",
            value: function convertToEnquiryDetected() {
              this.convertEnquiry = true;
              var data = JSON.parse(sessionStorage.getItem('enquiryPrefill'));
              this.newEnqData = {
                name: data.name,
                phone: data.phone,
                email: data.email,
            ...
            value: function getStateList() {
              ...
              var url = "/api/v1/country/state?country_ids=".concat(this.newEnqData.country_id);
              this.auth.showLoader();
              this.httpService.getData(url).subscribe(function (res) {
                _this27.auth.hideLoader();

                if (res.result.length > 0) {
                  _this27.stateList = res.result[0].stateList;
                }
              }, function (err) {
                _this27.auth.hideLoader();

                _this27.showErrorMessage('error', '', err);
              });
            }
          }, {
            key: "resetStateCityArea",
            value: function resetStateCityArea() {
              this.stateList = [];
              this.cityList = [];
              this.areaList = [];
            ...
            value: function getCityList() {
              ...
              if (this.newEnqData.state_id != '') {
                var url = "/api/v1/country/city?state_ids=".concat(this.newEnqData.state_id);
                this.auth.showLoader();
                this.httpService.getData(url).subscribe(function (res) {
                  _this28.auth.hideLoader();

                  if (res.result.length > 0) {
                    _this28.cityList = res.result[0].cityList;
                  }
                }, function (err) {
                  _this28.auth.hideLoader();

                  _this28.showErrorMessage('error', '', err);
                });
              }
            }
          }, {
            ...
            value: function getAreaList() {
              ...
              if (this.newEnqData.city_id != "" && this.newEnqData.city_id != "-1") {
                var url = "/api/v1/cityArea/area/".concat(this.createSource.inst_id, "?city_ids=").concat(this.newEnqData.city_id);
                this.auth.showLoader();
                this.httpService.getData(url).subscribe(function (res) {
                  _this29.auth.hideLoader();

                  if (res.result && res.result.length > 0) {
                    _this29.areaList = res.result[0].areaList;
                  }
                }, function (err) {
                  _this29.auth.hideLoader();

                  _this29.showErrorMessage('error', '', err);
                });
              }
            }
          }, {
            ...
            value: function onChangeObj(event) {
              ...
              this.countryDetails.forEach(function (element) {
                if (element.id == event) {
                  _this30.instituteCountryDetObj = element;
                  _this30.newEnqData.country_id = element.id;
                  _this30.maxlength = _this30.instituteCountryDetObj.country_phone_number_length;
                  _this30.country_id = element.id;
                }
              });
            ...
            value: function toggleForm(event) {
              var eleid = event.srcElement.id; //console.log(eleid);
            ...
            key: "toggleObjectClass",
            value: function toggleObjectClass(addActive, removeActive) {
            ...
            key: "fetchEnquiryPrefilledData",
            value: function fetchEnquiryPrefilledData() {
              var _this31 = this;

              this.prefill.getEnqStatus().subscribe(function (data) {
                _this31.enqstatus = data;
              }, function (err) {//  console.log(err);
              });
              this.prefill.getEnqPriority().subscribe(function (data) {
                _this31.enqPriority = data;
              }, function (err) {//  console.log(err);
              });
              this.prefill.getFollowupType().subscribe(function (data) {
                _this31.enqFollowType = data;
              }, function (err) {});
              this.prefill.getAssignTo().subscribe(function (data) {
                _this31.enqAssignTo = data;
              }, function (err) {//   console.log(err);
              });
              this.prefill.getEnqStardards().subscribe(function (data) {
                _this31.enqStd = data;
              }, function (err) {});
              this.prefill.getSchoolDetails().subscribe(function (data) {
                _this31.school = data;
                _this31.instituteList = _this31.school;

                _this31.instituteList.forEach(function (el) {
                  el.edit = false;
                });
              }, function (err) {//  console.log(err);
              });
              this.prefill.getLeadSource().subscribe(function (data) {
                _this31.sourceLead = data;
                _this31.sourceList = _this31.sourceLead;

                _this31.sourceList.forEach(function (el) {
                  el.edit = false;
                });
              }, function (err) {//   console.log(err);
              });
              this.fetchReferInfo();
              this.prefill.getOccupation().subscribe(function (data) {
                _this31.occupation = data;
              }, function (err) {//   console.log(err);
              });
              this.prefill.fetchLastDetail().subscribe(function (data) {
                _this31.lastDetail = data;
              }, function (err) {// console.log(err);
              });
            ...
            key: "getCityAreaList",
            value: function getCityAreaList() {
              var _this32 = this;

              this.prefill.getCityList().subscribe(function (data) {
                _this32.cityListDataSource = data;
              }, function (err) {});
            }
          }, {
            key: "fetchMasterCourseDetails",
            value: function fetchMasterCourseDetails() {
              var _this33 = this;

              this.prefill.getMasterCourseData().subscribe(function (res) {
                _this33.masterCourseData = res;
              });
            }
          }, {
            key: "fetchCustomComponentData",
            value: function fetchCustomComponentData() {
              var _this34 = this;

              this.customComponents = [];
              this.prefill.fetchCustomComponentEmpty().subscribe(function (data) {
                if (data != null) {
                  data.forEach(function (el) {
                    ...
                    var obj = {
                      ...
                      label: el.label,
                      prefilled_data: _this34.createPrefilledData(el.prefilled_data.split(',')),
                      selected: [],
                      selectedString: '',
                      type: el.type,
                    ...
                    if (el.type == 4) {
                      obj = {
                        ...
                        is_searchable: el.is_searchable,
                        label: el.label,
                        prefilled_data: _this34.createPrefilledDataType4(el.prefilled_data.split(','), el.enq_custom_value.split(','), el.defaultValue.split(',')),
                        selected: el.enq_custom_value.trim().split(',').length == 1 && el.enq_custom_value.trim().split(',')[0] == "" ? _this34.getDefaultArr(el.defaultValue) : el.enq_custom_value.split(','),
                    ...
                    _this34.customComponents.push(obj);
                  });
                }
              });
            }
            ...
            key: "getDefaultArr",
            value: function getDefaultArr(d) {
              var a = [];
              a.push(d);
              return a;
            }
          }, {
            key: "createPrefilledDataType4",
            value: function createPrefilledDataType4(dataArr, selected, def) {
              var customPrefilled = [];
            ...
            key: "createPrefilledData",
            value: function createPrefilledData(dataArr) {
              var customPrefilled = [];
              dataArr.forEach(function (el) {
                var obj = {
                  data: el.toString(),
            ...
            key: "multiselectVisible",
            value: function multiselectVisible(elid) {
            ...
            value: function updateMultiSelect(data, id) {
            ...
            key: "showAdditionDetails",
            value: function showAdditionDetails() {
              this.additionDetails = !this.additionDetails;
            }
            /* On Phone Number input by user update model and fetch lead records if any */

          }, {
            key: "updatePhoneFetchRecords",
            value: function updatePhoneFetchRecords() {
              var _this35 = this;

              this.prefill.fetchLeadDetails(this.newEnqData.phone).subscribe(function (data) {
                _this35.updateForm(data);
              }, function (err) {});
            }
            ...
            key: "getLeadDetails",
            value: function getLeadDetails() {
              var _this36 = this;

              //console.log(this.newEnqData.phone);
              if (this.validatePhone(this.newEnqData.phone)) {
                this.prefill.fetchLeadDetails(this.newEnqData.phone).subscribe(function (data) {
                  _this36.updateForm(data);
                }, function (err) {
                  _this36.showErrorMessage('error', "Unable to fetch lead", err.error.message);
                });
              }
            }
            ...
            key: "validatePhone",
            value: function validatePhone(num) {
              //console.log(num);
              if (num != null) {
            ...
            key: "fetchSubject",
            value: function fetchSubject(value) {
              var _this37 = this;
              ...
              if (value != null && value != '' && value != '-1') {
                ...
                this.prefill.getEnqSubjects(this.newEnqData.standard_id).subscribe(function (data) {
                  _this37.enqSub = data;
                });
              } else {
                this.newEnqData.subject_id = '-1';
            ...
            value: function clearFormData() {
              ...
              this.isEnquirySubmit = true;
              this.fetchCustomComponentData(); // this.fetchDataForCountryDetails();
            }
          }, {
            key: "updateCustomComponent",
            value: function updateCustomComponent(v, comp) {
              if (v) {
            ...
            key: "getCustomComponents",
            value: function getCustomComponents() {
              var tempArr = [];
              this.customComponents.forEach(function (e) {
                if (e.type == 5) {
                  if (e.hasOwnProperty('value')) {
                    var dd = moment__WEBPACK_IMPORTED_MODULE_2__(e.value).format("YYYY-MM-DD");
                  ...
                  if (e.hasOwnProperty('value')) {
                    if (typeof e.value == 'string') {
                      if (e.value.trim() != '') {
                        var _obj = {};
                        _obj.component_id = e.id;
                        _obj.enq_custom_id = 0;
                        _obj.enq_custom_value = e.value;
                        tempArr.push(_obj);
                      }
                    } else if (typeof e.value == 'boolean') {
                      if (e.value) {
                        var _obj2 = {};
                        _obj2.component_id = e.id;
                        _obj2.enq_custom_id = 0;
                        _obj2.enq_custom_value = "Y";
                        tempArr.push(_obj2);
                      } else {
                        var _obj3 = {};
                        _obj3.component_id = e.id;
                        _obj3.enq_custom_id = 0;
                        _obj3.enq_custom_value = "N";
                        tempArr.push(_obj3);
                      }
                    }
                  }
            ...
            value: function submitRegisterForm(form) {
            ...
            value: function submitForm(form) {
              ...
              console.log("Form", form); //Validates if the custom component required fields are selected or not

              var customComponentValidator = this.customComponents.every(function (el) {
                return _this38.getCustomValid(el);
              });
              /* Validate the predefine required fields of the form */

              this.isFormValid = this.ValidateFormDataBeforeSubmit(); // Validate If Area And City Settings is enable
              ...
              if (this.isFormValid && customComponentValidator) {
                if (this.validateTime()) {
                  ...
                  if (!this.isProfessional && this.isEnquirySubmit) {
                    ...
                    console.log(obj);
                    this.auth.showLoader();
                    this.poster.postNewEnquiry(obj).subscribe(function (data) {
                      _this38.auth.hideLoader();

                      _this38.enquiryConfirm = data;
                      var instituteEnqId = data.generated_id;

                      _this38.prefill.fetchLastDetail().subscribe(function (data) {
                        _this38.lastDetail = data;

                        if (_this38.isRegisterStudent) {
                          _this38.convertTOStudent(instituteEnqId);
                        } else {
                          if (_this38.addNextCheck) {
                            //form.reset();
                            _this38.showErrorMessage('success', "", "Enquiry added successfully");

                            _this38.clearFormData();
                          } else {
                            _this38.openConfirmationPopup();
                      ...
                      _this38.isEnquirySubmit = true;

                      _this38.showErrorMessage('error', '', err.error.message);
                    });
                  } else {
                    this.auth.showLoader();
                    ...
                    if (this.isEnquirySubmit) {
                      this.isEnquirySubmit = false;
                      this.poster.postNewEnquiry(this.newEnqData).subscribe(function (data) {
                        _this38.auth.hideLoader();
            ...
            key: "convertTOStudent",
            value: function convertTOStudent(instituteEnqId) {
              var obj = {
                name: this.newEnqData.name,
                phone: this.newEnqData.phone,
              ...
              obj.birth_place = this.newEnqData.birth_place, obj.blood_group = this.newEnqData.blood_group, obj.category = this.newEnqData.category, obj.nationality = this.newEnqData.nationality, obj.student_adhar_no = this.newEnqData.student_adhar_no, obj.parent_adhar_no = this.newEnqData.parent_adhar_no, obj.parent_profession = this.newEnqData.parent_profession, obj.mother_tounge = this.newEnqData.mother_tounge, obj.extra_curricular_activities = this.newEnqData.extra_curricular_activities, obj.educational_group = this.newEnqData.educational_group, obj.pin_code = this.newEnqData.pin_code, obj.student_perm_addr = this.newEnqData.address, obj.guardian_name = this.newEnqData.guardian_name, obj.guardian_email = this.newEnqData.guardian_email, obj.guardian_phone = this.newEnqData.guardian_phone, obj.religion = this.newEnqData.religion;
            ...
            key: "getFollowupTime",
            value: function getFollowupTime() {
              var hour = parseInt(moment__WEBPACK_IMPORTED_MODULE_2__(new Date()).format('hh'));
              var min = moment__WEBPACK_IMPORTED_MODULE_2__(new Date()).format('mm');
              var mer = moment__WEBPACK_IMPORTED_MODULE_2__(new Date()).format('A');
              ...
              if (parseInt(min) % 5 != 0) {
                ...
                if (min >= 60) {
                  ...
                  if (hour == 12) {
                    ...
                    hour += 1; // let formattedNumber = (hour).slice(-2);
            ...
            key: "validateAreaAndCityFields",
            value: function validateAreaAndCityFields() {
            ...
            key: "notifyMeCheckBoxChangesDetect",
            value: function notifyMeCheckBoxChangesDetect() {
              if (this.newEnqData.followUpDate != "" && this.newEnqData.followUpDate != null) {
                if (this.hour != "" && this.meridian != "" && this.minute != "") {// Do nothing
                } else {
            ...
            key: "getCustomValid",
            value: function getCustomValid(element) {
            ...
            key: "ValidateFormDataBeforeSubmit",
            value: function ValidateFormDataBeforeSubmit() {
              var msg = 'Enter '.concat(this.maxlength).concat(' Digit Contact Number');
              var phoneFlag = this.commonServiceFactory.phonenumberCheck(this.newEnqData.phone, this.maxlength, this.country_id);
            ...
            value: function showErrorMessage(objType, massage, body) {
              this.commonServiceFactory.showErrorMessage(objType, massage, body);
              return false;
            }
          }, {
            key: "validateEnquiryDate",
            value: function validateEnquiryDate() {
              var a = moment__WEBPACK_IMPORTED_MODULE_2__();
              var b = moment__WEBPACK_IMPORTED_MODULE_2__(this.newEnqData.enquiry_date);
              var d = a.diff(b);
            ...
            key: "updateLastUpdatedDetails",
            value: function updateLastUpdatedDetails() {
              var _this39 = this;

              this.prefill.fetchLastDetail().subscribe(function (data) {
                _this39.lastDetail = data;
              }, function (err) {//  console.log(err);
              });
            }
            ...
            key: "openConfirmationPopup",
            value: function openConfirmationPopup() {
            ...
            key: "openUpdatePopup",
            value: function openUpdatePopup() {
              this.closePopUp();
              this.updatePop = true; // console.log("edit popup opened");
            }
            /* Function to close update popup */

          }, {
            key: "closeUpdatePopup",
            value: function closeUpdatePopup() {
              this.updatePop = false;
            }
            /* function to open popup to add source */

          }, {
            key: "showAddSourcePops",
            value: function showAddSourcePops() {
              //console.log('clicked');
            ...
            key: "hideAddSourcePops",
            value: function hideAddSourcePops() {
              this.isSourcePop = false;
            }
            /* function to show popup for adding reference */

          }, {
            key: "showAddReferPops",
            value: function showAddReferPops() {
              this.isReferPop = true;
            }
            /* function to hide popup for adding reference */

          }, {
            key: "hideAddReferPops",
            value: function hideAddReferPops() {
              this.isReferPop = false;
            }
            /* Reload the Enquiry Form and clear data */

          }, {
            key: "reloadEnquiryForm",
            value: function reloadEnquiryForm() {
              this.clearFormData();
              this.closePopUp();
            }
          }, {
            key: "customComponentUpdated",
            value: function customComponentUpdated(val, data) {
              this.componentListObject[data.component_id].enq_custom_value = val; // console.log(this.componentListObject);
            }
          }, {
            key: "navigateToEdit",
            value: function navigateToEdit() {
              ...
              var val;
              this.prefill.fetchLastDetail().subscribe(function (el) {
                _this40.router.navigate(['/view/leads/enquiry/edit/' + el.institute_enquiry_id]);
              });
            }
            /* --------------------------------------------------------------------------------------------------------- */
            ...
            key: "openAddInstitute",
            value: function openAddInstitute() {
              this.isInstitutePop = true;
            }
            /* function to hide popup to add institute */

          }, {
            key: "closeInstituteAdder",
            value: function closeInstituteAdder() {
              this.isInstitutePop = false;
            ...
            key: "toggleInstituteActive",
            value: function toggleInstituteActive(event) {
              if (event) {
            ...
            key: "addInstituteData",
            value: function addInstituteData() {
              var _this41 = this;

              this.prefill.createNewInstitute(this.createInstitute).subscribe(function (el) {
                if (el.message === "OK") {
                  _this41.prefill.getSchoolDetails().subscribe(function (data) {
                    _this41.school = data;
                    _this41.instituteList = _this41.school;

                    _this41.instituteList.forEach(function (el) {
                      el.edit = false;
                    });

                    _this41.closeAddInstitute();
                  }, function (err) {
                    _this41.showErrorMessage('error', '', err.error.message);
                  }); // console.log("institute Added");

                } else {// console.log("Institute Name already exist!");
                  }
              }, function (err) {
                //console.log(err);
                _this41.showErrorMessage('error', '', err.error.message);
            ...
            key: "toggleInstituteAdd",
            value: function toggleInstituteAdd() {
              var icon = document.getElementById('add-institute-icon').innerHTML;
            ...
            key: "closeAddInstitute",
            value: function closeAddInstitute() {
              this.isNewInstitute = false;
              document.getElementById('add-institute-icon').innerHTML = '+';
              this.createInstitute.instituteName = '';
            }
          }, {
            key: "fetchInstituteInfo",
            value: function fetchInstituteInfo() {
              var _this42 = this;

              this.prefill.getSchoolDetails().subscribe(function (data) {
                _this42.school = data;
                _this42.instituteList = _this42.school;

                _this42.instituteList.forEach(function (el) {
                  el.edit = false;
                });
              });
            }
            ...
            key: "editInstitute",
            value: function editInstitute(id) {
              this.instituteList.forEach(function (el) {
                if (el.school_id == id) {
                  el.edit = true;
                }
              });
            ...
            key: "cancelEditInstitute",
            value: function cancelEditInstitute(id) {
              this.fetchInstituteInfo();
            }
          }, {
            key: "updateInstitute",
            value: function updateInstitute(id) {
              ...
              this.instituteList.forEach(function (el) {
                if (el.school_id == id) {
                  _this43.poster.updateInstituteDetails(id, el).subscribe(function (res) {
                    _this43.showErrorMessage('success', '', 'Institute name updated');

                    _this43.fetchInstituteInfo();
                  }, function (err) {
                    _this43.showErrorMessage('error', 'We couldn\'t process your request', err.error.message);
            ...
            value: function deleteInstitute(id) {
              ...
              this.poster.deleteInstitute(id).subscribe(function (res) {
                _this44.showErrorMessage('success', '', " Institute record deleted successfully");

                _this44.fetchInstituteInfo();
              }, function (err) {
                _this44.showErrorMessage('error', 'Your request has been denied', err.error.message);
            ...
            key: "closeReferAdder",
            value: function closeReferAdder() {
              this.isReferPop = false;
            ...
            value: function addReferData() {
              ...
              if (this.createReferer.name.trim() != '') {
                if (this.referList.filter(function (x) {
                  return x.name == _this45.createReferer.name.trim();
                }).length == 0) {
                  this.prefill.createReferer(this.createReferer).subscribe(function (el) {
                    _this45.closeAddRefer();

                    _this45.fetchReferInfo();
                  }, function (err) {
                    _this45.showErrorMessage('error', '', err.error.message);
                  });
                } else {
            ...
            value: function fetchReferInfo() {
              ...
              this.prefill.getLeadReffered().subscribe(function (data) {
                _this46.referList = data;

                _this46.referList.forEach(function (el) {
                  el.edit = false;
                });
              }, function (err) {
                _this46.referList = [];
            ...
            key: "editRefer",
            value: function editRefer(id) {
              this.referList.forEach(function (el) {
                if (el.id == id) {
                  el.edit = true;
            ...
            key: "cancelEditRefer",
            value: function cancelEditRefer(id) {
              var temp = this.referList.filter(function (el) {
                return el.id == id;
              });
            ...
            value: function updateRefer(id) {
              ...
              this.referList.forEach(function (el) {
                if (el.id == id) {
                  ...
                  _this47.auth.showLoader();

                  _this47.poster.updateReferDetails(data).subscribe(function (res) {
                    _this47.auth.hideLoader();

                    _this47.showErrorMessage('success', '', 'Reference updated Successfully');

                    _this47.fetchReferInfo();
                  }, function (err) {
                    _this47.auth.hideLoader();

                    _this47.showErrorMessage('error', '', err.error.message);
                  });
                }
              });
            }
            ...
            key: "deleteRefer",
            value: function deleteRefer(id, name) {
              var _this48 = this;
              ...
              this.auth.showLoader();
              this.poster.deleteRefer(data).subscribe(function (res) {
                _this48.auth.hideLoader();

                _this48.showErrorMessage('success', '', 'Reference deleted Successfully');

                _this48.referList.filter(function (x) {
                  return x.id == id;
                }).splice(0, 1);

                _this48.fetchReferInfo();
              }, function (err) {
                _this48.auth.hideLoader();
                ...
                if (err.status == 500) {
                  ...
                  _this48.showErrorMessage('error', '', msg.message);
                } else {
                  _this48.showErrorMessage('error', '', err.error.message);
                }
              });
            }
            /* --------------------------------------------------------------------------------------------------------- */
            ...
            key: "openAddSource",
            value: function openAddSource() {
              this.isSourcePop = true;
            }
            /* function to hide popup to add Source */

          }, {
            key: "closeSourceAdder",
            value: function closeSourceAdder() {
              this.isSourcePop = false;
            ...
            value: function addSourceData() {
              ...
              if (this.createSource.name.trim() != '') {
                if (this.sourceList.filter(function (x) {
                  return x.name == _this49.createSource.name.trim();
                }).length == 0) {
                  this.auth.showLoader();
                  this.prefill.createSource(this.createSource).subscribe(function (el) {
                    _this49.auth.hideLoader();

                    _this49.fetchSourceInfo();

                    _this49.closeAddSource();
                  }, function (err) {
                    _this49.auth.hideLoader();

                    _this49.showErrorMessage('error', '', err.error.message);
                  });
                } else {
            ...
            key: "toggleSourceAdd",
            value: function toggleSourceAdd() {
              var icon = document.getElementById('add-source-icon').innerHTML;
            ...
            key: "fetchSourceInfo",
            value: function fetchSourceInfo() {
              var _this50 = this;

              this.prefill.getLeadSource().subscribe(function (data) {
                _this50.sourceLead = data;
                _this50.sourceList = _this50.sourceLead;

                _this50.sourceList.forEach(function (el) {
                  el.edit = false;
                });
              }, function (err) {
                _this50.sourceList = [];
            ...
            key: "editSource",
            value: function editSource(id) {
              this.sourceList.forEach(function (el) {
                if (el.id == id) {
                  el.edit = true;
            ...
            key: "cancelEditSource",
            value: function cancelEditSource(id) {
              // this.fetchSourceInfo();
              var temp = this.sourceList.filter(function (el) {
                return el.id == id;
              });
            ...
            key: "updateSource",
            value: function updateSource(id) {
              var _this51 = this;
              ...
              this.sourceList.forEach(function (el) {
                if (el.id == id) {
                  ...
                  _this51.auth.showLoader();

                  _this51.poster.updateSourceDetails(data).subscribe(function (res) {
                    _this51.auth.hideLoader();

                    _this51.showErrorMessage('success', '', 'Source updated successfully');

                    _this51.fetchSourceInfo();
                  }, function (err) {
                    _this51.auth.hideLoader();

                    _this51.showErrorMessage('error', '', err.error.message);
                  });
                }
              });
            }
            ...
            key: "timeChanges",
            value: function timeChanges(ev, id) {
              if (ev.split(' ')[0] != '') {
            ...
            value: function deleteSource(id) {
              ...
              this.sourceList.forEach(function (el) {
                if (el.id == id) {
                  ...
                  _this52.poster.deleteSource(data).subscribe(function (res) {
                    _this52.auth.hideLoader();

                    _this52.showErrorMessage('success', '', 'Source deleted successfully');

                    _this52.fetchSourceInfo();
                  }, function (err) {
                    _this52.auth.hideLoader();

                    _this52.showErrorMessage('error', '', err.error.message);
                  });
                }
              });
            }
          }, {
            key: "isEnquiryAdministrator",
            value: function isEnquiryAdministrator() {
            ...
            key: "clearAddEnquiryDate",
            value: function clearAddEnquiryDate() {
              this.newEnqData.enquiry_date = "";
            }
          }, {
            key: "clearAddFollowUpDate",
            value: function clearAddFollowUpDate() {
            ...
            key: "multiBranchInstituteFound",
            value: function multiBranchInstituteFound(id) {
              var _this53 = this;

              this.prefill.getAllSubBranches(id).subscribe(function (res) {
                _this53.branchesList = res;
              }, function (err) {
                console.log(err);
              });
            }
            ...
            key: "branchUpdated",
            value: function branchUpdated(e) {
              var _this54 = this;
              ...
              this.prefill.fetchAssignedToData(e).subscribe(function (res) {
                ...
                _this54.enqAssignTo = res;
                _this54.newEnqData.assigned_to = "-1";
              }, function (err) {
                _this54.auth.hideLoader();
              });
            }
          }, {
            key: "courseMasterChange",
            value: function courseMasterChange(e) {
              var _this55 = this;
                ...
                this.masterCourseData.map(function (el) {
                  if (el.master_course == e) {
                    if (el.coursesList == null || el.coursesList.length == 0) {
                      _this55.course_course = [];
                    } else {
                      _this55.course_course = el.coursesList;
                    }
                  }
                });
              } else {
        ...
        EnquiryAddComponent.ctorParameters = function () {
          return [{
        ...
        EnquiryAddComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          selector: 'app-enquiry-add',
          template: __importDefault(__webpack_require__(
          /*! raw-loader!./enquiry-add.component.html */
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/leads/enquiry-add/enquiry-add.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./enquiry-add.component.scss */
          "./src/app/components/leads/enquiry-add/enquiry-add.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [_services_fetchprefilldata_service__WEBPACK_IMPORTED_MODULE_8__["FetchprefilldataService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _services_enquiry_services_post_enquiry_data_service__WEBPACK_IMPORTED_MODULE_7__["PostEnquiryDataService"], _services_login_services_login_service__WEBPACK_IMPORTED_MODULE_10__["LoginService"], _services_authenticator_service__WEBPACK_IMPORTED_MODULE_5__["AuthenticatorService"], _services_multiBranchdata_service__WEBPACK_IMPORTED_MODULE_11__["MultiBranchDataService"], _services_common_service__WEBPACK_IMPORTED_MODULE_6__["CommonServiceFactory"], _services_http_service__WEBPACK_IMPORTED_MODULE_9__["HttpService"], _services_common_api_call_service__WEBPACK_IMPORTED_MODULE_12__["CommonApiCallService"]])], EnquiryAddComponent);
        return EnquiryAddComponent;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsLeadsEnquiryEnquiryCustomUserEnquiryComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsLeadsEnquiryEnquiryCustomUserEnquiryComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "UserEnquiryComponent", function () {
      ...
      var UserEnquiryComponent =
      /** @class */
      function () {
        var UserEnquiryComponent = /*#__PURE__*/function () {
          function UserEnquiryComponent() {
            _classCallCheck(this, UserEnquiryComponent);
          }

          _createClass(UserEnquiryComponent, [{
            key: "ngOnInit",
            value: function ngOnInit() {}
          }]);
        ...
        UserEnquiryComponent.ctorParameters = function () {
          return [];
        };

        UserEnquiryComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          selector: 'custom-enquiry',
          template: __importDefault(__webpack_require__(
          /*! raw-loader!./user-enquiry.component.html */
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/leads/enquiry/enquiry-custom/user-enquiry.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./user-enquiry.component.scss */
          "./src/app/components/leads/enquiry/enquiry-custom/user-enquiry.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [])], UserEnquiryComponent);
        return UserEnquiryComponent;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsLeadsLeadsHomeLeadsHomeComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsLeadsLeadsHomeLeadsHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "LeadsHomeComponent", function () {
      ...
      var _services_enquiry_services_fetchenquiry_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../../../services/enquiry-services/fetchenquiry.service */
      "./src/app/services/enquiry-services/fetchenquiry.service.ts");
      /* harmony import */


      var _services_fetchprefilldata_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../../../services/fetchprefilldata.service */
      "./src/app/services/fetchprefilldata.service.ts");
      ...
      var LeadsHomeComponent =
      /** @class */
      function () {
        var LeadsHomeComponent = /*#__PURE__*/function () {
          function LeadsHomeComponent(router, cd, auth, enquire, prefill) {
            _classCallCheck(this, LeadsHomeComponent);
          ...
          _createClass(LeadsHomeComponent, [{
            key: "ngOnInit",
            value: function ngOnInit() {
              var _this56 = this;
              ...
              this.auth.institute_type.subscribe(function (res) {
                if (res == 'LANG') {
                  _this56.jsonFlag.isProfessional = true;
                } else {
                  _this56.jsonFlag.isProfessional = false;
                }
              });
            ...
            key: "checkpermissinDetails",
            value: function checkpermissinDetails() {
              var _this57 = this;

              var userType = sessionStorage.getItem('userType');
              var username = sessionStorage.getItem('username');
              var array = Object.keys(this.jsonRolesFlags);

              if (sessionStorage.getItem('permissions') == '' && userType == '0' && username == 'admin') {
                // user role is admin
                array.forEach(function (flag) {
                  _this57.jsonRolesFlags[flag] = true;
                });
              } else {
                array.forEach(function (flag) {
                  _this57.jsonRolesFlags[flag] = false;
                }); // quick enquiry  --110
                ...
                if (this.role_feature.REPORTS_ENQUIRY_REFFER_BY || this.role_feature.REPORTS_ENQUIRY_SOURCE || this.role_feature.REPORT_ENQUIRY_COUNSELLOR) {
            ...
            value: function fetchenquiry() {
              ...
              this.auth.showLoader();
              this.enquire.fetchEnquiryWidgetView(obj).subscribe(function (res) {
                var result;
                result = res;
                _this58.enquiryStatus = result.statusMap;
                _this58.totalEnquiryCount = result.totalcount;
                console.log(res);
            ...
            key: "getEnqStartDate",
            value: function getEnqStartDate() {
              this.cd.markForCheck();
              var date = moment__WEBPACK_IMPORTED_MODULE_2__().date(1).format("YYYY-MM-DD");
              return this.enquiryDate[0];
            }
          }, {
            key: "getEnqEndDate",
            value: function getEnqEndDate() {
              this.cd.markForCheck();
              return this.enquiryDate[1];
            }
          }, {
            key: "updateEnqChartByDate",
            value: function updateEnqChartByDate(e) {
              var _this59 = this;
              ...
              this.enquire.fetchEnquiryWidgetView(obj).subscribe(function (res) {
                ...
                _this59.cd.markForCheck();

                var result;
                result = res;
                _this59.enquiryStatus = result.statusMap;
                _this59.totalEnquiryCount = result.totalcount;
              });
            }
          }, {
            key: "openCalendar",
        ...
        LeadsHomeComponent.ctorParameters = function () {
          return [{
            type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]
          }, {
        ...
        LeadsHomeComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          selector: 'app-leads-home',
          template: __importDefault(__webpack_require__(
          /*! raw-loader!./leads-home.component.html */
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/leads/leads-home/leads-home.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./leads-home.component.scss */
          "./src/app/components/leads/leads-home/leads-home.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"], _services_authenticator_service__WEBPACK_IMPORTED_MODULE_4__["AuthenticatorService"], _services_enquiry_services_fetchenquiry_service__WEBPACK_IMPORTED_MODULE_5__["FetchenquiryService"], _services_fetchprefilldata_service__WEBPACK_IMPORTED_MODULE_6__["FetchprefilldataService"]])], LeadsHomeComponent);
        return LeadsHomeComponent;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsLeadsLeadsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _leads_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./leads.component */
      "./src/app/components/leads/leads.component.ts");
      /* harmony import */


      var _leads_home_leads_home_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./leads-home/leads-home.component */
      "./src/app/components/leads/leads-home/leads-home.component.ts");
      /* harmony import */


      var _enquiry_add_enquiry_add_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./enquiry-add/enquiry-add.component */
      "./src/app/components/leads/enquiry-add/enquiry-add.component.ts");
      /* harmony import */


      var _data_setup_data_setup_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./data-setup/data-setup.component */
      "./src/app/components/leads/data-setup/data-setup.component.ts");
      /* harmony import */


      var _manage_campaign_manage_campaign_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./manage-campaign/manage-campaign.component */
      ...
      function () {
        ...
        LeadsRoutingModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
          imports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild([{
            ...
            children: [{
              ...
              loadChildren: function loadChildren() {
                ...
                /*! import() | app-components-leads-campaign-campaign-module */
                "app-components-leads-campaign-campaign-module").then(__webpack_require__.bind(null,
                /*! app/components/leads/campaign/campaign.module */
                "./src/app/components/leads/campaign/campaign.module.ts")).then(function (m) {
              ...
              loadChildren: function loadChildren() {
                return __webpack_require__.e(
                /*! import() | app-components-leads-enquiry-enquiry-module */
                "app-components-leads-enquiry-enquiry-module").then(__webpack_require__.bind(null,
                /*! app/components/leads/enquiry/enquiry.module */
                "./src/app/components/leads/enquiry/enquiry.module.ts")).then(function (m) {
                  return m.EnquiryModule;
                });
              },
              ...
              loadChildren: function loadChildren() {
                return __webpack_require__.e(
                /*! import() | app-components-leads-enquiry-report-enquiry-report-module */
                "app-components-leads-enquiry-report-enquiry-report-module").then(__webpack_require__.bind(null,
                /*! app/components/leads/enquiry-report/enquiry-report.module */
                "./src/app/components/leads/enquiry-report/enquiry-report.module.ts")).then(function (m) {
                  return m.EnquiryReportModule;
                });
              },
              ...
              loadChildren: function loadChildren() {
                return Promise.all(
                /*! import() | app-components-leads-campaign-reports-campaign-reports-module */
                [__webpack_require__.e("common"), __webpack_require__.e("app-components-leads-campaign-reports-campaign-reports-module")]).then(__webpack_require__.bind(null,
                /*! app/components/leads/campaign-reports/campaign-reports.module */
                "./src/app/components/leads/campaign-reports/campaign-reports.module.ts")).then(function (m) {
                  return m.CampaignReportsModule;
                });
              },
    ...
    /***/
    function srcAppComponentsLeadsLeadsComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsLeadsLeadsComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      function () {
        var LeadsComponent = /*#__PURE__*/function () {
          ...
          _createClass(LeadsComponent, [{
            ...
            key: "checkDownloadPermissionAccess",
            value: function checkDownloadPermissionAccess() {
        ...
        LeadsComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          selector: 'app-leads',
          template: __importDefault(__webpack_require__(
          /*! raw-loader!./leads.component.html */
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/leads/leads.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./leads.component.scss */
          "./src/app/components/leads/leads.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [])], LeadsComponent);
        return LeadsComponent;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsLeadsLeadsModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var ngx_bootstrap_timepicker__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ngx-bootstrap/timepicker */
      "./node_modules/ngx-bootstrap/timepicker/fesm2015/ngx-bootstrap-timepicker.js");
      /* harmony import */


      var primeng_primeng__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! primeng/primeng */
      "./node_modules/primeng/primeng.js");
      /* harmony import */


      var primeng_primeng__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(primeng_primeng__WEBPACK_IMPORTED_MODULE_4__);
      /* harmony import */


      var _services_enquiry_services_popup_handler_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../../services/enquiry-services/popup-handler.service */
      ...
      var _master_master_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      ...
      var _data_setup_data_setup_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./data-setup/data-setup.component */
      "./src/app/components/leads/data-setup/data-setup.component.ts");
      /* harmony import */


      var _enquiry_add_enquiry_add_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ./enquiry-add/enquiry-add.component */
      "./src/app/components/leads/enquiry-add/enquiry-add.component.ts");
      /* harmony import */


      var _enquiry_enquiry_custom_user_enquiry_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ./enquiry/enquiry-custom/user-enquiry.component */
      "./src/app/components/leads/enquiry/enquiry-custom/user-enquiry.component.ts");
      /* harmony import */


      var _leads_home_leads_home_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ./leads-home/leads-home.component */
      "./src/app/components/leads/leads-home/leads-home.component.ts");
      /* harmony import */


      var _leads_routing_module__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! ./leads-routing.module */
      "./src/app/components/leads/leads-routing.module.ts");
      /* harmony import */


      var _leads_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      /*! ./leads.component */
      "./src/app/components/leads/leads.component.ts");
      /* harmony import */


      var _manage_campaign_manage_campaign_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      /*! ./manage-campaign/manage-campaign.component */
      "./src/app/components/leads/manage-campaign/manage-campaign.component.ts");
      /* harmony import */


      var _services_campaign_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      /*! ./services/campaign.service */
      "./src/app/components/leads/services/campaign.service.ts");
      /* harmony import */


      var _services_closing_reason_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
      /*! ./services/closing-reason.service */
      "./src/app/components/leads/services/closing-reason.service.ts");
      /* harmony import */
      ...
      var _custom_common_check_box_converter_pipe__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
      /*! ../custom-common/check-box-converter.pipe */
      "./src/app/components/custom-common/check-box-converter.pipe.ts");
      /* harmony import */


      var _services_institute_setting_service_institute_setting_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
      /*! ../../services/institute-setting-service/institute-setting.service */
      "./src/app/services/institute-setting-service/institute-setting.service.ts");
      ...
      function () {
        ...
        LeadsModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
          imports: [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], // BsDatepickerModule,
          ngx_bootstrap_timepicker__WEBPACK_IMPORTED_MODULE_3__["TimepickerModule"], primeng_primeng__WEBPACK_IMPORTED_MODULE_4__["FileUploadModule"], primeng_primeng__WEBPACK_IMPORTED_MODULE_4__["SplitButtonModule"], primeng_primeng__WEBPACK_IMPORTED_MODULE_4__["MenuModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_9__["SharedModule"], _leads_routing_module__WEBPACK_IMPORTED_MODULE_14__["LeadsRoutingModule"], _master_master_module__WEBPACK_IMPORTED_MODULE_8__["ManageExamModule"], _tinymce_tinymce_angular__WEBPACK_IMPORTED_MODULE_19__["EditorModule"]],
          declarations: [_leads_component__WEBPACK_IMPORTED_MODULE_15__["LeadsComponent"], _leads_home_leads_home_component__WEBPACK_IMPORTED_MODULE_13__["LeadsHomeComponent"], _enquiry_add_enquiry_add_component__WEBPACK_IMPORTED_MODULE_11__["EnquiryAddComponent"], _data_setup_data_setup_component__WEBPACK_IMPORTED_MODULE_10__["DataSetupComponent"], _enquiry_enquiry_custom_user_enquiry_component__WEBPACK_IMPORTED_MODULE_12__["UserEnquiryComponent"], _manage_campaign_manage_campaign_component__WEBPACK_IMPORTED_MODULE_16__["ManageCampaignComponent"], _custom_common_check_box_converter_pipe__WEBPACK_IMPORTED_MODULE_20__["CheckBoxConverterPipe"] // EnquiryReportComponent
          ],
          entryComponents: [_leads_component__WEBPACK_IMPORTED_MODULE_15__["LeadsComponent"], _enquiry_enquiry_custom_user_enquiry_component__WEBPACK_IMPORTED_MODULE_12__["UserEnquiryComponent"]],
          providers: [_services_campaign_service__WEBPACK_IMPORTED_MODULE_17__["CampaignService"], _services_enquiry_services_popup_handler_service__WEBPACK_IMPORTED_MODULE_5__["PopupHandlerService"], _services_closing_reason_service__WEBPACK_IMPORTED_MODULE_18__["ClosingReasonService"], _services_export_to_pdf_service__WEBPACK_IMPORTED_MODULE_6__["ExportToPdfService"], _services_http_service__WEBPACK_IMPORTED_MODULE_7__["HttpService"], _services_institute_setting_service_institute_setting_service__WEBPACK_IMPORTED_MODULE_21__["InstituteSettingService"]],
          exports: [_enquiry_enquiry_custom_user_enquiry_component__WEBPACK_IMPORTED_MODULE_12__["UserEnquiryComponent"]]
        })], LeadsModule);
        return LeadsModule;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsLeadsManageCampaignManageCampaignComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsLeadsManageCampaignManageCampaignComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ManageCampaignComponent", function () {
      ...
      var _services_campaign_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ../services/campaign.service */
      "./src/app/components/leads/services/campaign.service.ts");
      /* harmony import */
      ...
      var ManageCampaignComponent =
      /** @class */
      function () {
        var ManageCampaignComponent = /*#__PURE__*/function () {
          function ManageCampaignComponent(campaignService, msgService, auth, _pdfService, commonServiceFactory) {
            _classCallCheck(this, ManageCampaignComponent);

            this.campaignService = campaignService;
            this.msgService = msgService;
            this.auth = auth;
            this._pdfService = _pdfService;
            this.commonServiceFactory = commonServiceFactory; // global variables
            ...
            this.checkedIds = [];
            this.selectedSMSList = []; // leads variables
            //Add lead
            ...
            this.checkAll = false;
            this.downloadEnquiryReportAccess = false; // FOR PAGINATION
          ...
          _createClass(ManageCampaignComponent, [{
            key: "ngOnInit",
            value: function ngOnInit() {
              this.fetchPreFillData();
            ...
            key: "checkRoleAccess",
            value: function checkRoleAccess() {
            ...
            value: function onChangeObj(event) {
              ...
              this.countryDetails.forEach(function (element) {
                if (element.id == event) {
                  _this60.editLead.country_id = element.id;
                  _this60.maxlength = element.country_phone_number_length;
                  _this60.country_id = element.id;
                }
              });
            }
          }, {
            ...
            value: function fetchPreFillData() {
              ...
              this.auth.showLoader(); // get all source list

              this.campaignService.getAllSources().subscribe(function (res) {
                _this61.sourceList = res;
              }, function (err) {
                _this61.msgService.showErrorMessage(_this61.msgService.toastTypes.error, '', 'Please check your internet connection or contact at support@proctur.com if the issue persist');

                _this61.auth.hideLoader();
              }); // get all assigned list

              this.campaignService.getAssignedList().subscribe(function (res) {
                _this61.assignedToList = res;
              }, function (err) {
                _this61.msgService.showErrorMessage(_this61.msgService.toastTypes.error, '', err.error.message);

                _this61.auth.hideLoader();
              }); // get all referred by list

              this.campaignService.getReferredByList().subscribe(function (res) {
                _this61.referredByList = res;
              }, function (err) {
                _this61.msgService.showErrorMessage(_this61.msgService.toastTypes.error, '', err.error.message);
              ...
              this.campaignService.getCampaignList().subscribe(function (res) {
                _this61.campaignList = res;
              }, function (err) {
                _this61.msgService.showErrorMessage(_this61.msgService.toastTypes.error, '', err.error.message);
            ...
            key: "searchCampaign",
            value: function searchCampaign(index) {
              var _this62 = this;
              ...
              this.campaignService.searchLeads(obj).subscribe(function (res) {
                var result;
                result = res;

                _this62.auth.hideLoader();

                _this62.leadsList = res;
                _this62.tempLeadlist = res;
                _this62.totalCount = 0;

                if (result.length > 0) {
                  for (var i = 0; i < _this62.leadsList.length; i++) {
                    if (_this62.leadsList[i].converted == 0) {
                      _this62.leadsList[i].select = false;
                    }
                  }

                  _this62.totalCount = _this62.leadsList[0].totalCount;
                }
              }, function (err) {
                _this62.msgService.showErrorMessage(_this62.msgService.toastTypes.error, '', err.error.message);
            ...
            value: function searchDatabase() {
              ...
              if (this.leadSearchInput == undefined || this.leadSearchInput == null) {
                ...
                var searchData = this.tempLeadlist.filter(function (item) {
                  return Object.keys(item).some(function (k) {
                    return item[k] != null && item[k].toString().toLowerCase().includes(_this63.leadSearchInput.toLowerCase());
                  });
                });
            ...
            value: function downloadPdf() {
              ...
              for (var i = 0; i < this.tempLeadlist.length; i++) {
              ...
              this.tempLeadlist.map(function (ele) {
                var json = [ele.mobile, ele.name, ele.email, ele.address, ele.city, ele.gender, ele.referred_name, ele.source_name, ele.converted_status];
                arr.push(json);
              });
              var rows = [];
            ...
            key: "rowCheckBoxClick",
            value: function rowCheckBoxClick(row) {
            ...
            key: "checkAllLead",
            value: function checkAllLead(event) {
              this.checkedIds = [];
              var event_flag = event.target.checked;
            ...
            value: function showPromoSMS() {
              ...
              if (this.checkedIds.length == 0) {
                ...
                this.auth.showLoader();
                $('#SMS').modal('show');
                this.campaignService.getPromoSMS(obj).subscribe(function (res) {
                  _this64.promoSMSList = res;

                  _this64.auth.hideLoader();
                }, function (err) {
                  _this64.msgService.showErrorMessage(_this64.msgService.toastTypes.error, '', err.error.message);
            ...
            value: function selectMsg(msg) {
              ...
              for (var i = 0; i < this.selectedSMSList.length; i++) {
            ...
            value: function sendSMS() {
              ...
              if (this.selectedSMSList.length == 0) {
                ...
                this.auth.showLoader();
                this.campaignService.sendPromoSMS(obj).subscribe(function (res) {
                  _this65.msgService.showErrorMessage(_this65.msgService.toastTypes.success, '', 'Message has been sent successfully.');

                  _this65.auth.hideLoader();

                  _this65.selectedSMSList = [];
                  $('#SMS').modal('hide');
                  _this65.checkedIds = [];

                  _this65.searchCampaign(_this65.startindex);
                }, function (err) {
                  _this65.msgService.showErrorMessage(_this65.msgService.toastTypes.error, '', err.error.message);
            ...
            value: function convertToEnq() {
              ...
              if (this.checkedIds.length == 0) {
                ...
                this.auth.showLoader();
                this.campaignService.convertToEnq(obj).subscribe(function (res) {
                  _this66.auth.hideLoader();

                  _this66.checkedIds = [];

                  _this66.searchCampaign(_this66.startindex);
                }, function (err) {
                  _this66.msgService.showErrorMessage(_this66.msgService.toastTypes.error, '', err.error.message);
            ...
            key: "deleteMultipleLeads",
            value: function deleteMultipleLeads() {
              var _this67 = this;
              ...
              if (this.checkedIds.length == 0) {
                ...
                this.auth.showLoader();
                this.campaignService.deleteMultiLeads(obj).subscribe(function (res) {
                  _this67.msgService.showErrorMessage(_this67.msgService.toastTypes.success, '', 'Lead(s) deleted successfully!');

                  _this67.auth.hideLoader();

                  _this67.checkedIds = [];

                  _this67.searchCampaign(_this67.startindex);
                }, function (err) {
                  _this67.msgService.showErrorMessage(_this67.msgService.toastTypes.error, '', err.error.message);
            ...
            key: "validateNum",
            value: function validateNum(phone) {
              var msg = 'Enter '.concat(this.maxlength).concat(' Digit Contact Number');
              var phoneFlag = this.commonServiceFactory.phonenumberCheck(phone, this.maxlength, this.country_id);
            ...
            value: function addNewLead() {
              ...
              this.auth.showLoader();
              this.campaignService.createLead(obj).subscribe(function (res) {
                _this68.msgService.showErrorMessage(_this68.msgService.toastTypes.success, '', 'Lead added successfully');

                _this68.auth.hideLoader();

                $('#addLead').modal('hide');

                _this68.clearLeadForm();

                _this68.searchCampaign(_this68.startindex);
              }, function (err) {
                _this68.msgService.showErrorMessage(_this68.msgService.toastTypes.error, '', err.error.message);
            ...
            key: "editLeadRow",
            value: function editLeadRow(row) {
            ...
            value: function modifyLead() {
              ...
              this.auth.showLoader();
              this.campaignService.updateLead(obj, this.editLead.list_id, this.editLead.base_id).subscribe(function (res) {
                _this69.msgService.showErrorMessage(_this69.msgService.toastTypes.success, '', 'Lead updated successfully');

                _this69.auth.hideLoader();

                $('#editLead').modal('hide');

                _this69.clearEditLeadForm();

                _this69.searchCampaign(_this69.startindex);
              }, function (err) {
                _this69.msgService.showErrorMessage(_this69.msgService.toastTypes.error, '', err.error.message);
            ...
            value: function deleteLead(row) {
              ...
              if (confirm('Are you sure you want to delete lead?')) {
                this.auth.showLoader();
                this.campaignService.deleteLead(row.list_id, row.base_id).subscribe(function (res) {
                  _this70.msgService.showErrorMessage(_this70.msgService.toastTypes.success, '', 'Lead deleted successfully');

                  _this70.auth.hideLoader();

                  _this70.searchCampaign(_this70.startindex);
                }, function (err) {
                  _this70.msgService.showErrorMessage(_this70.msgService.toastTypes.error, '', err.error.message);
            ...
            key: "clearEditLeadForm",
            value: function clearEditLeadForm() {
              this.editLead.name = "";
              this.editLead.phone = "";
        ...
        ManageCampaignComponent.ctorParameters = function () {
          return [{
        ...
        ManageCampaignComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          selector: 'app-manage-campaign',
          template: __importDefault(__webpack_require__(
          /*! raw-loader!./manage-campaign.component.html */
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/leads/manage-campaign/manage-campaign.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./manage-campaign.component.scss */
          "./src/app/components/leads/manage-campaign/manage-campaign.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [_services_campaign_service__WEBPACK_IMPORTED_MODULE_2__["CampaignService"], _services_message_show_service__WEBPACK_IMPORTED_MODULE_1__["MessageShowService"], _services_authenticator_service__WEBPACK_IMPORTED_MODULE_4__["AuthenticatorService"], _services_export_to_pdf_service__WEBPACK_IMPORTED_MODULE_3__["ExportToPdfService"], _services_common_service__WEBPACK_IMPORTED_MODULE_6__["CommonServiceFactory"]])], ManageCampaignComponent);
        return ManageCampaignComponent;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsLeadsServicesCampaignServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      function () {
        var CampaignService = /*#__PURE__*/function () {
          ...
          function CampaignService(http, auth) {
            ...
            this.auth.currentAuthKey.subscribe(function (key) {
              _this71.Authorization = key;
              _this71.headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "Content-Type": "application/json",
                "Authorization": _this71.Authorization
              });
            });
            this.auth.currentInstituteId.subscribe(function (id) {
              _this71.institute_id = id;
            });
          ...
          _createClass(CampaignService, [{
            ...
            value: function fetchDownloadTemplate() {
              if (this.baseUrl == 'http://test999.proctur.com/StdMgmtWebAPI') {
                ...
                return this.http.get(this.urlDownloadTemplate).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (data) {
                  return data;
                }, function (err) {
                  return err;
                }));
            ...
            key: "uploadFileStep2",
            value: function uploadFileStep2(response) {
              var data = response;
              this.urlDownloadAllEnquiry = this.baseUrl + "/api/v1/campaign/list/" + this.institute_id + "/upload";
              return this.http.post(this.urlDownloadAllEnquiry, data, {
            ...
            key: "verifyUploadFileName",
            value: function verifyUploadFileName(name) {
              var data = {
                campaign_list_name: name
              };
            ...
            key: "campaignUploadList",
            value: function campaignUploadList(values) {
            ...
            key: "campaignMessageList",
            value: function campaignMessageList(data) {
            ...
            key: "saveSMSservice",
            value: function saveSMSservice(data) {
            ...
            key: "campaignSMSTestService",
            value: function campaignSMSTestService(data) {
            ...
            key: "downloadFailureListFile",
            value: function downloadFailureListFile(campaign_id) {
            ...
            value: function deleteMessage(id) {
              var url = this.baseUrl + "/api/v1/campaign/message/" + this.institute_id + "/" + id;
              var obj = {
                status: 400
              };
            ...
            key: "updateMessage",
            value: function updateMessage(obj, id) {
              var url = this.baseUrl + "/api/v1/campaign/message/" + this.institute_id + "/" + id;
              return this.http.put(url, obj, {
                headers: this.headers
              }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (data) {
            ...
            key: "addNewMessage",
            value: function addNewMessage(obj) {
              var url = this.baseUrl + "/api/v1/campaign/message/" + this.institute_id;
            ...
            key: "approveMessage",
            value: function approveMessage(id) {
              var url = this.baseUrl + "/api/v1/campaign/message/" + this.institute_id + "/" + id;
              var obj = {
                status: 1
              };
            ...
            key: "getAssignedList",
            value: function getAssignedList() {
              var obj = {
                "user_Type": 0
              };
            ...
            key: "getReferredByList",
            value: function getReferredByList() {
            ...
            key: "searchLeads",
            value: function searchLeads(obj) {
            ...
            key: "convertToEnq",
            value: function convertToEnq(obj) {
            ...
            key: "getPromoSMS",
            value: function getPromoSMS(obj) {
            ...
            key: "sendPromoSMS",
            value: function sendPromoSMS(obj) {
            ...
            key: "updateLead",
            value: function updateLead(obj, list_id, base_id) {
            ...
            key: "deleteLead",
            value: function deleteLead(list_id, base_id) {
            ...
            key: "deleteMultiLeads",
            value: function deleteMultiLeads(obj) {
        ...
        CampaignService = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])(), __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], _services_authenticator_service__WEBPACK_IMPORTED_MODULE_4__["AuthenticatorService"]])], CampaignService);
        return CampaignService;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsLeadsServicesClosingReasonServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ClosingReasonService", function () {
      ...
      var ClosingReasonService =
      /** @class */
      function () {
        var ClosingReasonService = /*#__PURE__*/function () {
          function ClosingReasonService(http, auth) {
            var _this72 = this;

            _classCallCheck(this, ClosingReasonService);

            this.http = http;
            this.auth = auth;
            this.baseUrl = '';
            this.auth.currentAuthKey.subscribe(function (key) {
              _this72.Authorization = key;
              _this72.headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
                "Content-Type": "application/json",
                "Authorization": _this72.Authorization
              });
            });
            this.auth.currentInstituteId.subscribe(function (id) {
              _this72.institute_id = id;
            });
            this.baseUrl = this.auth.getBaseUrl();
          }

          _createClass(ClosingReasonService, [{
            key: "getAllReasons",
            value: function getAllReasons() {
              var url = this.baseUrl + "/api/v2/enquiry_manager/fetchEnquiryClosingReason/" + this.institute_id;
            ...
            key: "createReason",
            value: function createReason(obj) {
              var url = this.baseUrl + "/api/v2/enquiry_manager/enquiryClosingReason";
              return this.http.post(url, obj, {
                headers: this.headers
              }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (data) {
                return data;
            ...
            key: "updateClosingReason",
            value: function updateClosingReason(obj, id) {
              var url = this.baseUrl + "/api/v2/enquiry_manager/updateEnquiryClosingReason/" + id;
              return this.http.put(url, obj, {
                headers: this.headers
              }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (data) {
                return data;
        ...
        ClosingReasonService.ctorParameters = function () {
          return [{
        ...
        ClosingReasonService = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(), __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"], _services_authenticator_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticatorService"]])], ClosingReasonService);
        return ClosingReasonService;
      }();
      /***/
    ...
    /***/
    function srcAppServicesEnquiryServicesPopupHandlerServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PopupHandlerService", function () {
      ...
      var PopupHandlerService =
      /** @class */
      function () {
        var PopupHandlerService = /*#__PURE__*/function () {
          function PopupHandlerService() {
            _classCallCheck(this, PopupHandlerService);
          ...
          _createClass(PopupHandlerService, [{
            key: "changeMessage",
            ...
            key: "changeRowData",
            value: function changeRowData(data) {
              this.rowDataSource.next(data);
            }
            /* Function to update disable and enable action button */

          }, {
            key: "changeActionStatus",
            value: function changeActionStatus(data) {
              this.actionButtonSource.next(data);
            }
          }, {
            key: "changeSmsMessage",
            value: function changeSmsMessage(sms) {
        ...
        PopupHandlerService.ctorParameters = function () {
          return [];
        };

        PopupHandlerService = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(), __metadata("design:paramtypes", [])], PopupHandlerService);
        return PopupHandlerService;
      }();
      /***/
...
//# sourceMappingURL=app-components-leads-leads-module-es5.js.map