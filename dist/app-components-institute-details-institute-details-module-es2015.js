...
/* harmony import */ var _services_institute_details_institute_details_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/institute-details/institute-details.service */ "./src/app/services/institute-details/institute-details.service.ts");
...
let InstituteDetailsComponent = /** @class */ (() => {
    let InstituteDetailsComponent = class InstituteDetailsComponent {
        constructor(apiService, commonService, auth, httpService) {
        ...
        getInstituteDetails() {
            this.apiService.getInstituDetailsAll().subscribe(res => {
        ...
        getInstituteKYCDetails() {
            this.apiService.getKycTypeDetails().subscribe(res => {
                this.auth.hideLoader();
                this.kycType = res;
            }, err => {
                this.auth.hideLoader();
        ...
        getOptionDetailsFromServer() {
            this.apiService.getOptionDetails().subscribe(res => {
                this.auth.hideLoader();
        ...
        getPlanDetailsFromServer() {
            this.apiService.getPlanDetails().subscribe(res => {
                this.auth.hideLoader();
        ...
        updateAllDetails() {
            ...
            if (dataToSend) {
                ...
                this.apiService.updateDetailsToServer(dataToSend).subscribe(res => {
                    this.auth.hideLoader();
                    this.getInstituteDetails();
        ...
        getPaymentDeatils() {
            this.paymentTable = [];
            this.auth.showLoader();
            this.apiService.getPayementInfoFromServer().subscribe(res => {
                this.auth.hideLoader();
        ...
        smsAllocationHistoryDeatils() {
            this.smsAllocation = [];
            this.auth.showLoader();
            this.apiService.getSmsInfoFromServer().subscribe(res => {
                this.auth.hideLoader();
        ...
        downLoadLimitAllocationHistory() {
            this.limitTable = [];
            this.auth.showLoader();
            this.apiService.getDownloadLimitFromServer().subscribe(res => {
                this.auth.hideLoader();
                this.limitTable = res;
                this.showAllocationPopup = true;
        ...
        getStorageInformation() {
            this.apiService.getStorageLimitFromServer().subscribe(res => {
    ...
    InstituteDetailsComponent.ctorParameters = () => [
    ...
    InstituteDetailsComponent.propDecorators = {
        uploadDoc: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"], args: ['idUploadDoc', { static: false },] }]
    };
    InstituteDetailsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-institute-details',
            template: __importDefault(__webpack_require__(/*! raw-loader!./institute-details.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/institute-details/institute-details.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./institute-details.component.scss */ "./src/app/components/institute-details/institute-details.component.scss")).default]
        }),
        __metadata("design:paramtypes", [_services_institute_details_institute_details_service__WEBPACK_IMPORTED_MODULE_3__["InstituteDetailService"],
...
/* harmony import */ var _institute_details_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./institute-details.component */ "./src/app/components/institute-details/institute-details.component.ts");
/* harmony import */ var _services_institute_details_institute_details_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../services/institute-details/institute-details.service */ "./src/app/services/institute-details/institute-details.service.ts");
...
let InstituteDetailsModule = /** @class */ (() => {
    let InstituteDetailsModule = class InstituteDetailsModule {
    };
    InstituteDetailsModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                _institute_details_component__WEBPACK_IMPORTED_MODULE_4__["InstituteDetailsComponent"]
            ],
            providers: [
                _services_institute_details_institute_details_service__WEBPACK_IMPORTED_MODULE_5__["InstituteDetailService"]
            ]
        })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "InstituteDetailService", function() { return InstituteDetailService; });
...
let InstituteDetailService = /** @class */ (() => {
    let InstituteDetailService = class InstituteDetailService {
    ...
    InstituteDetailService.ctorParameters = () => [
...
//# sourceMappingURL=app-components-institute-details-institute-details-module-es2015.js.map