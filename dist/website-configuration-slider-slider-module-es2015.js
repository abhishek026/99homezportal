...
let AddEditComponent = /** @class */ (() => {
    ...
    AddEditComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __importDefault(__webpack_require__(/*! raw-loader!./add-edit.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/website-configuration/slider/add-edit/add-edit.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./add-edit.component.scss */ "./src/app/components/website-configuration/slider/add-edit/add-edit.component.scss")).default]
        }),
...
let ListComponent = /** @class */ (() => {
    let ListComponent = class ListComponent {
        constructor(httpService, auth, router, msgService, sanitizer) {
        ...
        getStaticPageData() {
            this.auth.showLoader();
            this.httpService.getMethod('/api/v2/website/slider/institute/' + sessionStorage.getItem('institute_id'), null).subscribe((res) => {
                this.auth.hideLoader();
        ...
        deleteRow(obj) {
            this.auth.showLoader();
            this.httpService.deleteFile('/prod/api/v2/website/slider/' + obj.data.id).subscribe((res) => {
                this.auth.hideLoader();
    ...
    ListComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-list',
            template: __importDefault(__webpack_require__(/*! raw-loader!./list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/website-configuration/slider/list/list.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./list.component.scss */ "./src/app/components/website-configuration/slider/list/list.component.scss")).default]
        }),
        __metadata("design:paramtypes", [_services_products_service__WEBPACK_IMPORTED_MODULE_2__["ProductService"],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _list_list_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./list/list.component */ "./src/app/components/website-configuration/slider/list/list.component.ts");
/* harmony import */ var _add_edit_add_edit_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./add-edit/add-edit.component */ "./src/app/components/website-configuration/slider/add-edit/add-edit.component.ts");
/* harmony import */ var _slider_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./slider.component */ "./src/app/components/website-configuration/slider/slider.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let SliderRoutingModule = /** @class */ (() => {
    let SliderRoutingModule = class SliderRoutingModule {
    };
    SliderRoutingModule = __decorate([
...
let SliderComponent = /** @class */ (() => {
    let SliderComponent = class SliderComponent {
        ...
        deleteRow(obj) {
            ...
            this.auth.showLoader();
            this.httpService.deleteFile('/prod/api/v2/website/slider/' + obj.id).subscribe((res) => {
                this.auth.hideLoader();
                this.msgService.showErrorMessage('success', '', 'Slider Deleted Successfully');
                this.getStaticPageData();
            }, err => {
    ...
    SliderComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-slider',
            template: __importDefault(__webpack_require__(/*! raw-loader!./slider.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/website-configuration/slider/slider.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./slider.component.scss */ "./src/app/components/website-configuration/slider/slider.component.scss")).default]
        }),
        __metadata("design:paramtypes", [_services_products_service__WEBPACK_IMPORTED_MODULE_2__["ProductService"],
            _services_authenticator_service__WEBPACK_IMPORTED_MODULE_1__["AuthenticatorService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"],
...
/* harmony import */ var _slider_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./slider-routing.module */ "./src/app/components/website-configuration/slider/slider-routing.module.ts");
...
/* harmony import */ var _list_list_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./list/list.component */ "./src/app/components/website-configuration/slider/list/list.component.ts");
/* harmony import */ var _add_edit_add_edit_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./add-edit/add-edit.component */ "./src/app/components/website-configuration/slider/add-edit/add-edit.component.ts");
/* harmony import */ var _slider_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./slider.component */ "./src/app/components/website-configuration/slider/slider.component.ts");
    ...
    SliderModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            imports: [
                ...
                _slider_routing_module__WEBPACK_IMPORTED_MODULE_2__["SliderRoutingModule"],
...
//# sourceMappingURL=website-configuration-slider-slider-module-es2015.js.map