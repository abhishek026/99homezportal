...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DriveHomeComponent", function() { return DriveHomeComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var primeng_tree__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! primeng/tree */ "./node_modules/primeng/tree.js");
/* harmony import */ var primeng_tree__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(primeng_tree__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _file_manager_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../file-manager.service */ "./src/app/components/course-module/file-manager/file-manager.service.ts");
...
let DriveHomeComponent = /** @class */ (() => {
    let DriveHomeComponent = class DriveHomeComponent {
        constructor(zone, fileService, auth, msgService, sanitizer, http, activatedRoute, productService) {
            this.zone = zone;
        ...
        fetchPrefillFolderAndFiles(path, backLoad) {
            let institute_id = sessionStorage.getItem("institute_id");
            let obj = { keyName: path, institute_id: institute_id };
            this.SelectedFilesArray = [];
            this.auth.showLoader();
            this.fileService.getAllFolderFiles(obj).subscribe((res) => {
        ...
        fetchUsedSpace() {
            this.fileService.getUsedSpace().subscribe((res) => {
        ...
        getFilesDeleted(data) {
            ...
            if (confirm('Are you sure, you want to delete the file?')) {
                this.fileService.deleteFiles(getDeletedFiles).subscribe((data) => {
        ...
        createFolder() {
            if (this.duplicateFolderCheck(this.createFetchFolder.folderName) == false) {
                ...
                this.auth.showLoader();
                this.fileService.craeteFolder(this.createFetchFolder).subscribe((data) => {
                    this.auth.hideLoader();
                    this.createFolderControl = false;
        ...
        generateTreeNodes(res, path, backLoad) {
            if (backLoad == true) {
                this.isFirstTimeLoad = false;
            }
            else {
        ...
        getCategories() {
            ...
            this.fileService.getCategories().subscribe((data) => {
        ...
        deleteFile() {
            ...
            this.auth.showLoader();
            this.http.postData('/api/v1/instFileSystem/files/delete', obj).subscribe((res) => {
                this.auth.hideLoader();
                if (this.deleteConfirmation) {
        ...
        getVimeoDownloadData(obj) {
            this.auth.showLoader();
            this.productService.getMethod('vimeo/download-links/' + obj.res.video_id, null).subscribe((res) => {
                this.auth.hideLoader();
    ...
    DriveHomeComponent.ctorParameters = () => [
    ...
    DriveHomeComponent.propDecorators = {
        dragBox: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"], args: ['DragContainer', { static: false },] }],
        dropZone: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"], args: ['dropZone', { static: false },] }],
        uploaders: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"], args: ['uploaders', { static: false },] }],
        expandingTree: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"], args: ['expandingTree', { static: false },] }]
    };
    DriveHomeComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-drive-home',
            template: __importDefault(__webpack_require__(/*! raw-loader!./drive-home.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/course-module/file-manager/drive-home/drive-home.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./drive-home.component.scss */ "./src/app/components/course-module/file-manager/drive-home/drive-home.component.scss")).default]
        }),
        __metadata("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgZone"],
            _file_manager_service__WEBPACK_IMPORTED_MODULE_4__["FileManagerService"],
...
/* harmony import */ var _file_manager_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../file-manager.service */ "./src/app/components/course-module/file-manager/file-manager.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let FileCardComponent = /** @class */ (() => {
    let FileCardComponent = class FileCardComponent {
        constructor(cd, fileService, appC, _http, sanitizer) {
            this.cd = cd;
            this.fileService = fileService;
            this.appC = appC;
            this._http = _http;
        ...
        getFileDownloaded(fileObj) {
            if (fileObj.res.category_id != this.vimeo_category_id) {
                ...
                this._http.downloadItem(url, file_type).subscribe((response) => {
                    if (response) {
    ...
    FileCardComponent.ctorParameters = () => [
    ...
    FileCardComponent.propDecorators = {
        ...
        draggedover: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] }],
        draggedleave: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] }],
        fileid: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] }],
        fileHeader: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"], args: ["fileHeader", { static: true },] }],
        fileImage: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"], args: ["fileHeader", { static: true },] }],
        status: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] }],
        filePath: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] }],
        fileDisplayArr: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
        selectedFolder: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
        getPopupValue: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] }],
        fileArr: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] }],
        shareOptions: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] }],
        playYoutubeVideo: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] }],
        editYoutubeVideo: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] }],
        ShowDeleteFileButton: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] }],
        playVimeoVideo: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] }],
        vimeo_video_downlodable: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
        getVimeoDownloadData: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] }],
        downloadStatus: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] }]
    };
    FileCardComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'file-card',
            template: __importDefault(__webpack_require__(/*! raw-loader!./file-card.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/course-module/file-manager/file-card/file-card.component.html")).default,
            changeDetection: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectionStrategy"].OnPush,
            styles: [__importDefault(__webpack_require__(/*! ./file-card.component.scss */ "./src/app/components/course-module/file-manager/file-card/file-card.component.scss")).default]
        }),
        __metadata("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"],
            _file_manager_service__WEBPACK_IMPORTED_MODULE_5__["FileManagerService"],
...
/* harmony import */ var _file_manager_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./file-manager.component */ "./src/app/components/course-module/file-manager/file-manager.component.ts");
/* harmony import */ var _drive_home_drive_home_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./drive-home/drive-home.component */ "./src/app/components/course-module/file-manager/drive-home/drive-home.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let FileManagerRoutingModule = /** @class */ (() => {
    let FileManagerRoutingModule = class FileManagerRoutingModule {
    };
...
let FileManagerComponent = /** @class */ (() => {
    let FileManagerComponent = class FileManagerComponent {
    };
    FileManagerComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'file-manager',
            template: __importDefault(__webpack_require__(/*! raw-loader!./file-manager.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/course-module/file-manager/file-manager.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./file-manager.component.scss */ "./src/app/components/course-module/file-manager/file-manager.component.scss")).default]
        })
...
/* harmony import */ var _file_manager_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./file-manager.component */ "./src/app/components/course-module/file-manager/file-manager.component.ts");
/* harmony import */ var _file_manager_routing_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./file-manager-routing.module */ "./src/app/components/course-module/file-manager/file-manager-routing.module.ts");
/* harmony import */ var _drive_home_drive_home_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./drive-home/drive-home.component */ "./src/app/components/course-module/file-manager/drive-home/drive-home.component.ts");
/* harmony import */ var _file_card_file_card_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./file-card/file-card.component */ "./src/app/components/course-module/file-manager/file-card/file-card.component.ts");
/* harmony import */ var _file_manager_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./file-manager.service */ "./src/app/components/course-module/file-manager/file-manager.service.ts");
/* harmony import */ var _upload_popup_upload_popup_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./upload-popup/upload-popup.component */ "./src/app/components/course-module/file-manager/upload-popup/upload-popup.component.ts");
/* harmony import */ var _share_file_share_file_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./share-file/share-file.component */ "./src/app/components/course-module/file-manager/share-file/share-file.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    FileManagerModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _file_manager_routing_module__WEBPACK_IMPORTED_MODULE_9__["FileManagerRoutingModule"],
                primeng_tree__WEBPACK_IMPORTED_MODULE_7__["TreeModule"],
                primeng_fileupload__WEBPACK_IMPORTED_MODULE_2__["FileUploadModule"]
            ],
            declarations: [
                _file_manager_component__WEBPACK_IMPORTED_MODULE_8__["FileManagerComponent"],
                _drive_home_drive_home_component__WEBPACK_IMPORTED_MODULE_10__["DriveHomeComponent"],
                _file_card_file_card_component__WEBPACK_IMPORTED_MODULE_11__["FileCardComponent"],
                _upload_popup_upload_popup_component__WEBPACK_IMPORTED_MODULE_13__["UploadPopupComponent"],
                _share_file_share_file_component__WEBPACK_IMPORTED_MODULE_14__["ShareFileComponent"]
            ],
            entryComponents: [
                _file_card_file_card_component__WEBPACK_IMPORTED_MODULE_11__["FileCardComponent"]
            ],
            providers: [
                _file_manager_service__WEBPACK_IMPORTED_MODULE_12__["FileManagerService"]
            ]
        })
    ], FileManagerModule);
...
let FileManagerService = /** @class */ (() => {
    let FileManagerService = class FileManagerService {
        ...
        downloadFromAWS(url, file_id) {
            ...
            return this.http.get(ur, { headers: this.headers, responseType: 'text' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(res => { return res; }, err => { return err; }));
        }
        getAllStandards() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShareFileComponent", function() { return ShareFileComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _file_manager_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../file-manager.service */ "./src/app/components/course-module/file-manager/file-manager.service.ts");
...
let ShareFileComponent = /** @class */ (() => {
    let ShareFileComponent = class ShareFileComponent {
        constructor(fileService, appC, auth, services) {
            this.fileService = fileService;
            this.appC = appC;
            this.auth = auth;
        ...
        editFileFetch(share_type) {
            ...
            this.fileService.editFileShare(Obj).subscribe((data) => {
                if (share_type == '2') {
                    if (this.categoryId != '62') {
        ...
        getAllStandards() {
            this.fileService.getAllStandards().subscribe((data) => {
        ...
        getAllSubjects(i) {
            this.fileService.getSubjects(i).subscribe((data) => {
        ...
        getBatches(update) {
            ...
            this.fileService.shareFileWithBatches(this.fetchBatchesData).subscribe((data) => {
        ...
        multiCourseMapping() {
            this.fileService.courseMapping().subscribe((data) => {
        ...
        fetchCoursesData(subject_id, event, update) {
            ...
            if (event == 0) {
                ...
                this.fileService.shareFileWithStudents(this.fetchBatchesData).subscribe((data) => {
                    this.dataStatus = false;
                    this.getStudentsData = data;
                    this.getStudentsData.map((data) => {
                        if (data.file_access_end_time == "") {
                            data.file_access_end_time = moment__WEBPACK_IMPORTED_MODULE_3__().format('YYYY-MM-DD');
                        }
                        if (data.file_access_start_time == "") {
        ...
        fetchApiStudentsAndBatches() {
            ...
            this.fileService.shareFile(this.fetchShareOption).subscribe((data) => {
                let msg = {
                    type: "success",
        ...
        validationsOfTime() {
            ...
            if (this.batchesId) {
                ...
                for (let i = 0; i < this.getStudentsData.length; i++) {
                    if (moment__WEBPACK_IMPORTED_MODULE_3__(this.getStudentsData[i].file_access_start_time) > moment__WEBPACK_IMPORTED_MODULE_3__(this.getStudentsData[i].file_access_end_time)) {
                        this.services.showErrorMessage("error", "Incorrect Details", "Access start Date Cannot be more than access end date");
                        return false;
                    }
                }
        ...
        shareFile(unshare) {
            ...
            if (this.tabChoice == "student") {
                ...
                if (unshare == '1') {
                    ...
                    this.fileService.shareFile(Obj).subscribe((data) => {
                        let msg = {
                            type: "success",
                    ...
                    if (this.categoryId != '62') {
                        if (this.fileSharePublic.standard_id == "" || this.fileSharePublic.subject_id == "") {
                            ...
                            this.fileService.shareFile(this.fileSharePublic).subscribe((data) => {
                                let msg = {
                                    type: "success",
                                    body: "File Shared Successfully"
                                };
                        ...
                        this.fileService.shareFile(this.publicObj).subscribe((data) => {
                            let msg = {
                                type: "success",
                                body: "File Shared Successfully"
                            };
                ...
                this.fileService.shareFile(this.instituteObj).subscribe((data) => {
                    let msg = {
                        type: "success",
    ...
    ShareFileComponent.ctorParameters = () => [
    ...
    ShareFileComponent.propDecorators = {
        ...
        fileIdGet: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
        fileName: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
        shareOptions: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
        treeUpdater: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] }]
    };
    ShareFileComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'share-file',
            template: __importDefault(__webpack_require__(/*! raw-loader!./share-file.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/course-module/file-manager/share-file/share-file.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./share-file.component.scss */ "./src/app/components/course-module/file-manager/share-file/share-file.component.scss")).default]
        }),
        __metadata("design:paramtypes", [_file_manager_service__WEBPACK_IMPORTED_MODULE_1__["FileManagerService"], _app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"], _services_authenticator_service__WEBPACK_IMPORTED_MODULE_4__["AuthenticatorService"], _services_message_show_service__WEBPACK_IMPORTED_MODULE_5__["MessageShowService"]])
    ], ShareFileComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UploadPopupComponent", function() { return UploadPopupComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _app_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../app.component */ "./src/app/app.component.ts");
/* harmony import */ var _services_authenticator_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../services/authenticator.service */ "./src/app/services/authenticator.service.ts");
/* harmony import */ var _file_manager_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../file-manager.service */ "./src/app/components/course-module/file-manager/file-manager.service.ts");
/* harmony import */ var _services_http_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../services/http.service */ "./src/app/services/http.service.ts");
...
let UploadPopupComponent = /** @class */ (() => {
    let UploadPopupComponent = class UploadPopupComponent {
        constructor(cd, fileService, appC, auth, httpService, msgService) {
            this.cd = cd;
            this.fileService = fileService;
            this.appC = appC;
            this.auth = auth;
        ...
        updateVimeoStatus(videoId) {
            ...
            this.httpService.postData('/api/v1/instFileSystem/updateVideoStatus', obj).subscribe((res) => {
        ...
        updateYoutubeURL() {
            ...
            this.auth.showLoader();
            this.httpService.putData('/api/v1/instFileSystem/update/' + this.editView.res.file_id, obj).subscribe((res) => {
                this.auth.hideLoader();
                this.manualUpload = false;
                let data = {
                    type: 'success',
    ...
    UploadPopupComponent.ctorParameters = () => [
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"] },
    ...
    UploadPopupComponent.propDecorators = {
        icon: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"], args: ['icon', { static: false },] }],
        closePopupValue: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] }],
        selectedFiles: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
        currentFolder: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
        fetchPrefillFolderAndFiles: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
        manualUpload: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
        pathArray: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
        currentFilesArray: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
        editView: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
        getFilesAndFolder: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] }],
        filesAndFolder: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] }],
        filePath: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] }],
        uploadStatus: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] }],
        form: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"], args: ['form',] }]
    };
    UploadPopupComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-upload-popup',
            template: __importDefault(__webpack_require__(/*! raw-loader!./upload-popup.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/course-module/file-manager/upload-popup/upload-popup.component.html")).default,
            changeDetection: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectionStrategy"].OnPush,
            styles: [__importDefault(__webpack_require__(/*! ./upload-popup.component.scss */ "./src/app/components/course-module/file-manager/upload-popup/upload-popup.component.scss")).default]
        }),
        __metadata("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"],
            _file_manager_service__WEBPACK_IMPORTED_MODULE_3__["FileManagerService"],
            _app_component__WEBPACK_IMPORTED_MODULE_1__["AppComponent"],
            _services_authenticator_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticatorService"],
            _services_http_service__WEBPACK_IMPORTED_MODULE_4__["HttpService"],
            ___WEBPACK_IMPORTED_MODULE_5__["MessageShowService"]])
...
//# sourceMappingURL=components-course-module-file-manager-file-manager-module-es2015.js.map