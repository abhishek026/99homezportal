(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app-components-users-management-role-management-role-management-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsUsersManagementRoleManagementAddEditRoleAddEditRoleComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsUsersManagementRoleManagementRoleManagementComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsUsersManagementRoleManagementAddEditRoleAddEditRoleComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsUsersManagementRoleManagementAddEditRoleAddEditRoleComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AddEditRoleComponent", function () {
      ...
      var _services_user_management_role_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var AddEditRoleComponent =
      /** @class */
      function () {
        var AddEditRoleComponent = /*#__PURE__*/function () {
          function AddEditRoleComponent(activatedRoute, route, apiService, toastCtrl, auth) {
            _classCallCheck(this, AddEditRoleComponent);
          ...
          _createClass(AddEditRoleComponent, [{
            key: "ngOnInit",
            value: function ngOnInit() {
              ...
              this.activatedRoute.params.subscribe(function (res) {
                _this.getAllRolesList(); // this.getAllExistingRoles();
            ...
            key: "getAllExistingRoles",
            value: function getAllExistingRoles() {
              var _this2 = this;

              this.apiService.getRoles().subscribe(function (data) {
                _this2.existingRolesData = data;
              });
            }
          }, {
            key: "getAllRolesList",
            value: function getAllRolesList() {
              var _this3 = this;
              ...
              this.apiService.getAllFeature().subscribe(function (res) {
                ...
                _this3.featuresArray = res; // Changes by Nalini - libarary role will be visible only if enabled from super admin and study material role will be visible for all users

                _this3.cloneFeatureArray = _this3.keepCloning(res);

                for (var i = 0; i < _this3.cloneFeatureArray.length; i++) {
                  if (_this3.cloneFeatureArray[i].product_name == 'Examdesk') {
                    _this3.examDeskRoles = _this3.cloneFeatureArray[i].category_list;
                  } else if (_this3.cloneFeatureArray[i].product_name == 'Proctur') {
                    _this3.procturRoles = _this3.cloneFeatureArray[i].category_list;
                  }
                } // hide super admin feature condition based -- Nalini


                if (sessionStorage.getItem('enable_library_feature') != '1') {
                  _this3.checkSuperAdminSettings(5031);
                }

                if (sessionStorage.getItem('isShowLiveclass') != 'true') {
                  _this3.checkSuperAdminSettings(5022);
                }

                if (!_this3.isShoweOnlineExam) {
                  _this3.checkSuperAdminSettings(5033);
                }

                if (sessionStorage.getItem('enable_eLearn_feature') != '1') {
                  _this3.checkSuperAdminSettings(5027);
                }

                if (sessionStorage.getItem('enable_client_website') != 'true') {
                  _this3.checkSuperAdminSettings(5122);
                }

                if (sessionStorage.getItem('enable_online_assignment_feature') != '1') {
                  _this3.checkSuperAdminSettings(5116);
                }

                if (sessionStorage.getItem('isShowExpense') != 'true') {
                  _this3.checkSuperAdminSettings(5084);

                  _this3.checkSuperAdminSettingsSubRole(5034, 5117);
                } // if(sessionStorage.getItem('enable_chat_with_parent') != '1') {
                //   this.checkSuperAdminSettingsSubRole(9999, 5066); 
                // }


                if (_this3.schoolModel) {
                  _this3.checkSuperAdminSettings(5027);

                  _this3.checkSuperAdminSettingsSubRole(5019, 5109);

                  _this3.checkSuperAdminSettingsSubRole(5020, 5047);

                  _this3.checkSuperAdminSettingsSubRole(5034, 5048);

                  _this3.checkSuperAdminSettingsSubRole(5034, 5049);
                } // Manage branch menu hide -- Nalini


                _this3.checkSuperAdminSettings(5052);

                if (_this3.roleId != "-1") {
                  _this3.getRolesOfUser(_this3.roleId);
                }
              }, function (err) {
                _this3.auth.hideLoader();
            ...
            key: "checkSuperAdminSettings",
            value: function checkSuperAdminSettings(category_id) {
              for (var t = 0; t < this.procturRoles.length; t++) {
            ...
            key: "checkSuperAdminSettingsSubRole",
            value: function checkSuperAdminSettingsSubRole(category_id, feature_id) {
              for (var t = 0; t < this.procturRoles.length; t++) {
                if (this.procturRoles[t].category_id == category_id) {
                  for (var feature = 0; feature < this.procturRoles[t].feature_list.length; feature++) {
            ...
            key: "getRolesOfUser",
            value: function getRolesOfUser(id) {
              var _this4 = this;
              ...
              this.apiService.getPerticularRoles(id).subscribe(function (res) {
                ...
                var role = _this4.keepCloning(res); // for (let t = 0; t < this.cloneFeatureArray.length; t++) {
                ...
                _this4.makeTargetArray(role.feautreList);
              }, function (err) {
                _this4.auth.hideLoader();
            ...
            key: "makeTargetArray",
            value: function makeTargetArray(arr) {
              this.auth.showLoader();
              this.targetFeatures = [];
              this.selectedRoleLength = 0;
              ...
              if (arr.length > 0) {
                for (var i = 0; i < arr.length; i++) {
                  for (var t = 0; t < this.cloneFeatureArray.length; t++) {
                    for (var j = 0; j < this.cloneFeatureArray[t].category_list.length; j++) {
                      ...
                      for (var feature = 0; feature < this.cloneFeatureArray[t].category_list[j].feature_list.length; feature++) {
            ...
            value: function createNewRole() {
              ...
              if (data.role_name == "" || data.role_name == null) {
                ...
                this.apiService.createRole(data).subscribe(function (res) {
                  _this5.messageNotifier('success', '', 'Role Added Successfully');

                  _this5.route.navigateByUrl('/view/manage/role');
                }, function (err) {
            ...
            value: function updateRole() {
              ...
              if (data.feautreList.length == 0) {
                ...
                this.apiService.updateRole(data, this.userData.role_id).subscribe(function (res) {
                  _this6.messageNotifier('success', '', 'Role Updated Successfully');

                  _this6.route.navigateByUrl('/view/manage/role');
                }, function (err) {
                  console.log(err);
            ...
            key: "checkLengthofRole",
            value: function checkLengthofRole(event) {
              event ? this.selectedRoleLength++ : this.selectedRoleLength--;
            }
          }, {
            key: "sliderChanges",
            value: function sliderChanges(obj) {
              if (!obj.isToggleChecked) {
                this.selectedRoleLength--;

                for (var i = 0; i < obj.feature_list.length; i++) {
        ...
        AddEditRoleComponent.ctorParameters = function () {
          return [{
        ...
        AddEditRoleComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          selector: 'app-add-edit-role',
          template: __importDefault(__webpack_require__(
          /*! raw-loader!./add-edit-role.component.html */
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/users-management/role-management/add-edit-role/add-edit-role.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./add-edit-role.component.scss */
          "./src/app/components/users-management/role-management/add-edit-role/add-edit-role.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _services_user_management_role_service__WEBPACK_IMPORTED_MODULE_2__["RoleService"], _app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _services_authenticator_service__WEBPACK_IMPORTED_MODULE_5__["AuthenticatorService"]])], AddEditRoleComponent);
        return AddEditRoleComponent;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsUsersManagementRoleManagementRoleManagementComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsUsersManagementRoleManagementRoleManagementComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _services_user_management_role_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../../../services/user-management/role.service */
      "./src/app/services/user-management/role.service.ts");
      ...
      function () {
        var RoleManagementComponent = /*#__PURE__*/function () {
          function RoleManagementComponent(apiService, toastCtrl, router) {
          ...
          _createClass(RoleManagementComponent, [{
            ...
            value: function getRolesList() {
              ...
              this.apiService.getRoles().subscribe(function (res) {
                _this7.rolesListDataSource = res;
                _this7.totalRow = res.length;
            ...
            value: function deleteRole(data) {
              ...
              if (confirm('Are you sure, you want to delete the role?')) {
                this.apiService.deleteRole(data.role_id).subscribe(function (res) {
                  _this8.messageNotifier('success', '', 'Role deleted successfully');
            ...
            key: "showAssignedUserList",
            value: function showAssignedUserList(data) {
              var _this9 = this;

              if (data.total_user_count > 0) {
                this.apiService.getAssignedUserList(data.role_id).subscribe(function (res) {
                  _this9.showUserListPopUp = true;
                  $('#myModal').modal('show');
                  _this9.userList = res;
                }, function (err) {
                  //console.log(err);
                  _this9.messageNotifier('error', '', err.error.message);
                });
              } else {
        ...
        RoleManagementComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          selector: 'app-role-management',
          template: __importDefault(__webpack_require__(
          /*! raw-loader!./role-management.component.html */
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/users-management/role-management/role-management.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./role-management.component.scss */
          "./src/app/components/users-management/role-management/role-management.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [_services_user_management_role_service__WEBPACK_IMPORTED_MODULE_3__["RoleService"], _app_component__WEBPACK_IMPORTED_MODULE_1__["AppComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])], RoleManagementComponent);
        return RoleManagementComponent;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsUsersManagementRoleManagementRoleManagementModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _role_management_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./role-management.component */
      "./src/app/components/users-management/role-management/role-management.component.ts");
      /* harmony import */


      var _role_management_routing__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      ...
      var _add_edit_role_add_edit_role_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./add-edit-role/add-edit-role.component */
      "./src/app/components/users-management/role-management/add-edit-role/add-edit-role.component.ts");
      /* harmony import */


      var primeng_primeng__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! primeng/primeng */
      "./node_modules/primeng/primeng.js");
      /* harmony import */


      var primeng_primeng__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(primeng_primeng__WEBPACK_IMPORTED_MODULE_8__);
      /* harmony import */


      var _services_authenticator_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ../../../services/authenticator.service */
      "./src/app/services/authenticator.service.ts");
      ...
      function () {
        ...
        RoleManagementModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
          declarations: [_role_management_component__WEBPACK_IMPORTED_MODULE_4__["RoleManagementComponent"], _add_edit_role_add_edit_role_component__WEBPACK_IMPORTED_MODULE_7__["AddEditRoleComponent"]],
          exports: [],
          ...
          _shared_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"], _role_management_routing__WEBPACK_IMPORTED_MODULE_5__["RoleManagementRouting"], primeng_primeng__WEBPACK_IMPORTED_MODULE_8__["PickListModule"]],
          providers: [_services_user_management_role_service__WEBPACK_IMPORTED_MODULE_6__["RoleService"], _services_authenticator_service__WEBPACK_IMPORTED_MODULE_9__["AuthenticatorService"]]
    ...
    /***/
    function srcAppComponentsUsersManagementRoleManagementRoleManagementRoutingTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RoleManagementRouting", function () {
      ...
      var _add_edit_role_add_edit_role_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./add-edit-role/add-edit-role.component */
      "./src/app/components/users-management/role-management/add-edit-role/add-edit-role.component.ts");
      ...
      var RoleManagementRouting =
      /** @class */
      function () {
        var RoleManagementRouting = function RoleManagementRouting() {
          _classCallCheck(this, RoleManagementRouting);
        };

        RoleManagementRouting = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
...
//# sourceMappingURL=app-components-users-management-role-management-role-management-module-es5.js.map