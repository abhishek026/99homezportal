...
let AddClassComponent = /** @class */ (() => {
    let AddClassComponent = class AddClassComponent {
        constructor(auth, router, appC, product_service, http_service, msgService) {
            this.auth = auth;
            this.router = router;
            this.appC = appC;
        ...
        checkIsEnableElearnFeature() {
            ...
            if (data == '1') {
                ...
                this.product_service.getMethod('product/get-product-list?slug=Online_Class', null).subscribe((data) => {
        ...
        onChangeProduct(event) {
            ...
            this.auth.showLoader();
            this.http_service.getData(url).subscribe((data) => {
                this.auth.hideLoader();
                this.userData = data;
            }, (error) => {
                this.auth.hideLoader();
        ...
        getEvent(event) {
            let proctur_live_expiry_date = sessionStorage.getItem('proctur_live_expiry_date');
            ...
            if (proctur_live_expiry_date < event && proctur_live_expiry_date != event) {
                const tempMsg = 'Your live class subscription will get expired on '.concat(moment__WEBPACK_IMPORTED_MODULE_2__(proctur_live_expiry_date).format('DD-MM-YYYY')).concat(' hence you will not be able create live class. Renew your subscription to conduct live classes again!');
        ...
        getEventHourTo() {
            let fromTime = moment__WEBPACK_IMPORTED_MODULE_2__(this.scheduledateFrom).format('YYYY-MM-DD') + " " + this.hoursFrom.split(' ')[0] + ":" + this.minuteFrom + " " + this.hoursFrom.split(' ')[1];
            let toTime = moment__WEBPACK_IMPORTED_MODULE_2__(this.scheduledateFrom).format('YYYY-MM-DD') + " " + this.hoursTo.split(' ')[0] + ":" + this.minuteTo + " " + this.hoursTo.split(' ')[1];
            let fromTimeT = moment__WEBPACK_IMPORTED_MODULE_2__(fromTime).format('YYYY-MM-DD hh:mm a');
            let toTimeT = moment__WEBPACK_IMPORTED_MODULE_2__(toTime).format('YYYY-MM-DD hh:mm a');
        ...
        scheduleClass() {
            ...
            if (validationFlag) {
                ...
                if (userType == "3") {
                    let tempFaculty = sessionStorage.getItem('teacherIDs');
                    this.facultyId.push(tempFaculty);
                }
                else {
                    this.selectedFacultyList.map((ele) => {
                ...
                this.http_service.putData(url, this.addOnlineClass).subscribe((data) => {
                    this.auth.hideLoader();
        ...
        updateSubjectList(event) {
            ...
            if (event && event.length) {
                ...
                this.auth.showLoader();
                this.http_service.getData(url).subscribe((res) => {
                    this.auth.hideLoader();
        ...
        fetchStudentsApi(courseArray) {
            ...
            this.auth.showLoader();
            this.http_service.postData(url, this.getPayloadBatch).subscribe((data) => {
    ...
    AddClassComponent.ctorParameters = () => [
    ...
    AddClassComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __importDefault(__webpack_require__(/*! raw-loader!./add-class.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/live-classes-module/add-class/add-class.component.html")).default,
            encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewEncapsulation"].None,
            styles: [__importDefault(__webpack_require__(/*! ./add-class.component.scss */ "./src/app/components/live-classes-module/add-class/add-class.component.scss")).default]
        }),
        __metadata("design:paramtypes", [_services_authenticator_service__WEBPACK_IMPORTED_MODULE_5__["AuthenticatorService"],
            ...
            _services_products_service__WEBPACK_IMPORTED_MODULE_7__["ProductService"],
            _services_http_service__WEBPACK_IMPORTED_MODULE_6__["HttpService"],
            ___WEBPACK_IMPORTED_MODULE_3__["MessageShowService"]])
    ], AddClassComponent);
...
let AttendanceReportComponent = /** @class */ (() => {
    let AttendanceReportComponent = class AttendanceReportComponent {
        constructor(auth, router, appC, route, http_service, msgService, excelService) {
            this.auth = auth;
            this.router = router;
            this.appC = appC;
            this.route = route;
        ...
        getLiveClassAttendanceReport() {
            ...
            this.http_service.postData(url, obj).subscribe((data) => {
        ...
        searchDatabase() {
            ...
            if (this.searchInput == undefined || this.searchInput == null) {
                ...
                let searchData = this.temp_attendance_list.filter(item => Object.keys(item).some(k => item[k] != null && item[k].toString().toLowerCase().includes(this.searchInput.toLowerCase())));
                this.attendance_list = searchData;
            }
        }
        ExportAsExcel() {
            let arr = [];
            this.attendance_list.map((ele) => {
                let json = {};
    ...
    AttendanceReportComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __importDefault(__webpack_require__(/*! raw-loader!./attendance-report.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/live-classes-module/attendance-report/attendance-report.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./attendance-report.component.scss */ "./src/app/components/live-classes-module/attendance-report/attendance-report.component.scss")).default]
        }),
...
let EditClassComponent = /** @class */ (() => {
    let EditClassComponent = class EditClassComponent {
        constructor(auth, router, appC, route, product_service, http_service, msgService) {
            this.auth = auth;
            this.router = router;
            this.appC = appC;
            this.route = route;
            ...
            this.http_service.getData(url).subscribe((data) => {
                ...
                setTimeout(() => {
                    ...
                    if (this.repeat_session == 0) {
                        this.scheduledateFrom = moment__WEBPACK_IMPORTED_MODULE_2__(this.editData.start_datetime).format('YYYY-MM-DD');
                        let startTime = moment__WEBPACK_IMPORTED_MODULE_2__(this.editData.start_datetime).format('hh:mm A');
                        let endTime = moment__WEBPACK_IMPORTED_MODULE_2__(this.editData.end_datetime).format('hh:mm A');
        ...
        scheduleClass() {
            ...
            if (validationFlag) {
                ...
                if (this.repeat_session == 0) {
                    ...
                    this.http_service.postData(url, this.updateOnlineClass).subscribe((data) => {
                        let session = (this.live_class_for == "1") ? 'Live class session ' : 'Zoom class session ';
                ...
                if (this.repeat_session == 1) {
                    ...
                    this.auth.showLoader();
                    const url = '/api/v1/meeting_manager/createV2';
                    this.http_service.putData(url, this.updateOnlineClass).subscribe((data) => {
    ...
    EditClassComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __importDefault(__webpack_require__(/*! raw-loader!./edit-class.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/live-classes-module/edit-class/edit-class.component.html")).default,
            encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewEncapsulation"].None,
            styles: [__importDefault(__webpack_require__(/*! ./edit-class.component.scss */ "./src/app/components/live-classes-module/edit-class/edit-class.component.scss")).default]
        }),
        __metadata("design:paramtypes", [_services_authenticator_service__WEBPACK_IMPORTED_MODULE_5__["AuthenticatorService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"],
            _app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LiveClassSettingComponent", function() { return LiveClassSettingComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
let LiveClassSettingComponent = /** @class */ (() => {
    let LiveClassSettingComponent = class LiveClassSettingComponent {
        ...
        constructJsonToSend() {
            let obj = Object.assign({}, this.liveClassSettings);
            ...
            obj.live_class_attendance_absent_notification = this.getSumOfTableField(this.liveClassSettings.live_class_attendance_absent_notification);
            obj.vdocipher_watch_multiplier = Number(this.liveClassSettings.vdocipher_watch_multiplier ? this.liveClassSettings.vdocipher_watch_multiplier : 0);
            //obj.vdocipher_update_video_watch_time_mode = this.liveClassSettings.vdocipher_update_video_watch_time_mode;
        ...
        getZoomDetails() {
            this.auth.showLoader();
            this.httpService.getData('/api/v1/meeting_manager/getAllZoomAccount/' + sessionStorage.getItem('institute_id')).subscribe((res) => {
                this.auth.hideLoader();
        ...
        deleteZoom(id) {
            if (confirm('Do you really want to delete?')) {
                this.auth.showLoader();
                this.httpService.deleteData('/api/v1/meeting_manager/deleteZoomAccount/' + id, '').subscribe((res) => {
                    this.auth.hideLoader();
        ...
        updateZoom(obj) {
            if (this.validateZoomDetails(obj)) {
                this.auth.showLoader();
                this.httpService.putData('/api/v1/meeting_manager/updateZoomAccount', obj).subscribe((res) => {
                    this.auth.hideLoader();
        ...
        saveZoomDetails() {
            if (this.validateZoomDetails(this.zoomOBJ)) {
                this.auth.showLoader();
                this.httpService.postData('/api/v1/meeting_manager/createZoomAccount', this.zoomOBJ).subscribe((res) => {
                    this.auth.hideLoader();
        ...
        fillJSONData(data) {
            ...
            //this.liveClassSettings.vdocipher_update_video_watch_time_mode = data.vdocipher_update_video_watch_time_mode;
            this.vdocipher_live_class_watch_multiplier = data.vdocipher_live_class_watch_multiplier;
            //  this.liveClassSettings.vdocipher_live_class_watch_multiplier = data.vdocipher_live_class_watch_multiplier;
    ...
    LiveClassSettingComponent.ctorParameters = () => [
    ...
    LiveClassSettingComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-live-class-setting',
            template: __importDefault(__webpack_require__(/*! raw-loader!./live-class-setting.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/live-classes-module/live-class-setting/live-class-setting.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./live-class-setting.component.scss */ "./src/app/components/live-classes-module/live-class-setting/live-class-setting.component.scss")).default]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LiveClassesRoutingModule", function() { return LiveClassesRoutingModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _live_classes_live_classes_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./live-classes/live-classes.component */ "./src/app/components/live-classes-module/live-classes/live-classes.component.ts");
/* harmony import */ var _edit_class_edit_class_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./edit-class/edit-class.component */ "./src/app/components/live-classes-module/edit-class/edit-class.component.ts");
/* harmony import */ var _add_class_add_class_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./add-class/add-class.component */ "./src/app/components/live-classes-module/add-class/add-class.component.ts");
/* harmony import */ var _attendance_report_attendance_report_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./attendance-report/attendance-report.component */ "./src/app/components/live-classes-module/attendance-report/attendance-report.component.ts");
/* harmony import */ var _live_class_setting_live_class_setting_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./live-class-setting/live-class-setting.component */ "./src/app/components/live-classes-module/live-class-setting/live-class-setting.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let LiveClassesRoutingModule = /** @class */ (() => {
    let LiveClassesRoutingModule = class LiveClassesRoutingModule {
    };
...
/* harmony import */ var _live_classes_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./live-classes-routing.module */ "./src/app/components/live-classes-module/live-classes-routing.module.ts");
/* harmony import */ var _add_class_add_class_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./add-class/add-class.component */ "./src/app/components/live-classes-module/add-class/add-class.component.ts");
/* harmony import */ var _edit_class_edit_class_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit-class/edit-class.component */ "./src/app/components/live-classes-module/edit-class/edit-class.component.ts");
...
/* harmony import */ var _live_classes_live_classes_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./live-classes/live-classes.component */ "./src/app/components/live-classes-module/live-classes/live-classes.component.ts");
/* harmony import */ var ngx_bootstrap_timepicker__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ngx-bootstrap/timepicker */ "./node_modules/ngx-bootstrap/timepicker/fesm2015/ngx-bootstrap-timepicker.js");
...
/* harmony import */ var _attendance_report_attendance_report_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./attendance-report/attendance-report.component */ "./src/app/components/live-classes-module/attendance-report/attendance-report.component.ts");
...
/* harmony import */ var _live_class_setting_live_class_setting_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./live-class-setting/live-class-setting.component */ "./src/app/components/live-classes-module/live-class-setting/live-class-setting.component.ts");
/* harmony import */ var _services_institute_setting_service_institute_setting_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../services/institute-setting-service/institute-setting.service */ "./src/app/services/institute-setting-service/institute-setting.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    LiveClassesModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _live_classes_routing_module__WEBPACK_IMPORTED_MODULE_2__["LiveClassesRoutingModule"],
                _shared_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"],
                _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"],
                _shared_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"],
                // BsDatepickerModule,
                ngx_bootstrap_timepicker__WEBPACK_IMPORTED_MODULE_9__["TimepickerModule"],
                ng_multiselect_dropdown__WEBPACK_IMPORTED_MODULE_7__["NgMultiSelectDropDownModule"].forRoot()
            ],
            declarations: [
                _live_classes_live_classes_component__WEBPACK_IMPORTED_MODULE_8__["LiveClassesComponent"],
                _add_class_add_class_component__WEBPACK_IMPORTED_MODULE_3__["AddClassComponent"],
                _edit_class_edit_class_component__WEBPACK_IMPORTED_MODULE_4__["EditClassComponent"],
                _attendance_report_attendance_report_component__WEBPACK_IMPORTED_MODULE_11__["AttendanceReportComponent"],
                _live_class_setting_live_class_setting_component__WEBPACK_IMPORTED_MODULE_13__["LiveClassSettingComponent"]
            ],
            providers: [
                _services_products_service__WEBPACK_IMPORTED_MODULE_10__["ProductService"],
                _services_excel_service__WEBPACK_IMPORTED_MODULE_12__["ExcelService"],
                _services_institute_setting_service_institute_setting_service__WEBPACK_IMPORTED_MODULE_14__["InstituteSettingService"]
            ]
        })
    ], LiveClassesModule);
...
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../.. */ "./src/app/index.ts");
/* harmony import */ var _node_modules_angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../../node_modules/@angular/platform-browser */ "./node_modules/@angular/platform-browser/__ivy_ngcc__/fesm2015/platform-browser.js");
...
let LiveClassesComponent = /** @class */ (() => {
    let LiveClassesComponent = class LiveClassesComponent {
        constructor(auth, appC, router, _http, msgService, sanitizer, productService) {
            this.auth = auth;
            this.appC = appC;
            this.router = router;
            this._http = _http;
        ...
        ngOnInit() {
            ...
            let begin = moment__WEBPACK_IMPORTED_MODULE_2__(today.startOf('isoWeek')).format('DD-MM-YYYY');
            let end = moment__WEBPACK_IMPORTED_MODULE_2__(today.endOf('isoWeek')).format('DD-MM-YYYY');
            this.liveClassSearchFilter = {
        ...
        getClassesList() {
            ...
            this._http.postData(url, this.obj).subscribe((data) => {
                this.auth.hideLoader();
        ...
        diffDataBasedOnDate() {
            ...
            for (let i = 0; i < this.getClasses.length; i++) {
                let currDataDate = this.getClasses[i].start_datetime = moment__WEBPACK_IMPORTED_MODULE_2__(this.getClasses[i].start_datetime).format('YYYY-MM-DD');
        ...
        searchByDate(dateSearch) {
            let event = moment__WEBPACK_IMPORTED_MODULE_2__(dateSearch).format("YYYY-MM-DD");
            this.getClasses = [];
            if (dateSearch == null) {
                this.getClassesFor();
            }
            if (!this.liveClassFor) {
                for (let i = 0; i < this.futureLiveClasses.length; i++) {
                    let tempStartDate = moment__WEBPACK_IMPORTED_MODULE_2__(this.futureLiveClasses[i].start_datetime).format("YYYY-MM-DD");
                ...
                for (let i = 0; i < this.previosLiveClasses.length; i++) {
                    let tempStartDate = moment__WEBPACK_IMPORTED_MODULE_2__(this.previosLiveClasses[i].start_datetime).format("YYYY-MM-DD");
                    if (event === tempStartDate) {
        ...
        dateRangeChanges(obj) {
            ...
            if (obj == 'this_week') {
                ...
                let end = '';
                if (this.liveClassFor) {
                    begin = moment__WEBPACK_IMPORTED_MODULE_2__().subtract(1, 'weeks').startOf('isoWeek');
                    end = moment__WEBPACK_IMPORTED_MODULE_2__().subtract(1, 'weeks').endOf('isoWeek');
                }
                else {
                    begin = moment__WEBPACK_IMPORTED_MODULE_2__().add(1, 'weeks').startOf('isoWeek');
                    end = moment__WEBPACK_IMPORTED_MODULE_2__().add(1, 'weeks').endOf('isoWeek');
                }
                this.liveClassSearchFilter = {
                    to_date: moment__WEBPACK_IMPORTED_MODULE_2__(end).format('DD-MM-YYYY'),
                    from_date: moment__WEBPACK_IMPORTED_MODULE_2__(begin).format('DD-MM-YYYY')
                };
                this.showCustomFilter = false;
                this.getClassesList();
            }
                ...
                const today = moment__WEBPACK_IMPORTED_MODULE_2__();
                let begin = moment__WEBPACK_IMPORTED_MODULE_2__(today.startOf('month')).format('DD-MM-YYYY');
                let end = moment__WEBPACK_IMPORTED_MODULE_2__().format("YYYY-MM-") + moment__WEBPACK_IMPORTED_MODULE_2__().daysInMonth();
                this.liveClassSearchFilter = {
                    from_date: begin,
                    to_date: moment__WEBPACK_IMPORTED_MODULE_2__(end).format('DD-MM-YYYY')
                };
        ...
        searchInList() {
            ...
            if (this.searchText != "" && this.searchText != null) {
                let searchData = this.classListDataSource.filter(item => Object.keys(item).some(k => item[k] != null && item[k].toString().toLowerCase().includes(this.searchText.toLowerCase())));
        ...
        getDataFromDataSource(startindex) {
            ...
            let jobTime = moment__WEBPACK_IMPORTED_MODULE_2__(new Date().setHours(20, 0, 0, 0)).format('YYYY-MM-DD hh:mm a');
            let JobBufferTime = moment__WEBPACK_IMPORTED_MODULE_2__(new Date().setHours(0, 0, 0, (72000000 - buffer))).format('YYYY-MM-DD hh:mm a');
            let currentDate = moment__WEBPACK_IMPORTED_MODULE_2__(new Date()).format('YYYY-MM-DD hh:mm a');
            let temp = moment__WEBPACK_IMPORTED_MODULE_2__(new Date().setHours(0, 0, 0, (72000000 - buffer)));
            let ReportAllowDate = moment__WEBPACK_IMPORTED_MODULE_2__(new Date(2020, 6, 25, 0, 0, 0)).format('YYYY-MM-DD hh:mm a');
            temp = moment__WEBPACK_IMPORTED_MODULE_2__(temp).subtract(1, 'days');
            let yesterDayJobTime = moment__WEBPACK_IMPORTED_MODULE_2__(temp).format('YYYY-MM-DD hh:mm a');
        ...
        getTimeInfo() {
            let fromTime = moment__WEBPACK_IMPORTED_MODULE_2__(this.dateFrom).format('YYYY-MM-DD') + " " + this.hourFrom.split(' ')[0] + ":" + this.minuteFrom + " " + this.hourFrom.split(' ')[1];
            let fromDate = moment__WEBPACK_IMPORTED_MODULE_2__().format('YYYY-MM-DD');
            let toTime = moment__WEBPACK_IMPORTED_MODULE_2__(this.dateFrom).format('YYYY-MM-DD') + " " + this.hourTo.split(' ')[0] + ":" + this.minuteTo + " " + this.hourTo.split(' ')[1];
            let fromTimeT = moment__WEBPACK_IMPORTED_MODULE_2__(fromTime).format('YYYY-MM-DD hh:mm a');
            let toTimeT = moment__WEBPACK_IMPORTED_MODULE_2__(toTime).format('YYYY-MM-DD hh:mm a');
            if (moment__WEBPACK_IMPORTED_MODULE_2__(fromTimeT).diff(moment__WEBPACK_IMPORTED_MODULE_2__(toTimeT), 'minutes') > 0) {
                this.appC.popToast({ type: "error", body: "From time cannot be greater than to time" });
        ...
        smsNotification(id, meeting_wih) {
            ...
            this._http.postData(url, obj).subscribe((data) => {
        ...
        cancelSession() {
            ...
            this._http.deleteData(url, this.cancelSessionId).subscribe((data) => {
        ...
        getRescheduleTime() {
            let fromTime = moment__WEBPACK_IMPORTED_MODULE_2__(this.rescheduledateFrom).format('YYYY-MM-DD') + " " + this.hourFromReschedule.split(' ')[0] + ":" + this.minuteFromReschedule + " " + this.hourFromReschedule.split(' ')[1];
            let fromDate = moment__WEBPACK_IMPORTED_MODULE_2__().format('YYYY-MM-DD');
            let toTime = moment__WEBPACK_IMPORTED_MODULE_2__(this.rescheduledateFrom).format('YYYY-MM-DD') + " " + this.hourToReschedule.split(' ')[0] + ":" + this.minuteToReschedule + " " + this.hourToReschedule.split(' ')[1];
            let fromTimeT = moment__WEBPACK_IMPORTED_MODULE_2__(fromTime).format('YYYY-MM-DD hh:mm a');
            let toTimeT = moment__WEBPACK_IMPORTED_MODULE_2__(toTime).format('YYYY-MM-DD hh:mm a');
            if (moment__WEBPACK_IMPORTED_MODULE_2__(fromTimeT).diff(moment__WEBPACK_IMPORTED_MODULE_2__(toTimeT), 'minutes') > 0) {
                this.appC.popToast({ type: "error", body: "From time cannot be greater than to time" });
        ...
        isReschedule() {
            ...
            this._http.postData(url, this.rescheduleclass).subscribe((data) => {
                ...
                this.rescheduledateFrom = moment__WEBPACK_IMPORTED_MODULE_2__().format('YYYY-MM-DD');
                this.minuteFromReschedule = "";
                this.minuteToReschedule = "";
                this.hourFromReschedule = "";
                this.hourToReschedule = "";
        ...
        downloadFile(object) {
            ...
            this.auth.showLoader();
            this._http.downloadItem(url, 'video/mp4').subscribe((response) => {
                this.auth.hideLoader();
                if (response) {
        ...
        getVimeoDownloadData(obj) {
            this.auth.showLoader();
            this.productService.getMethod('vimeo/download-links/' + obj.vimeo_video_id, null).subscribe((res) => {
                this.auth.hideLoader();
        ...
        deleteRecording(session_id, isAbort) {
            ...
            this.auth.showLoader();
            this._http.deleteDataById(url).subscribe((res) => {
                this.auth.hideLoader();
        ...
        updateVimeoStatus(videoId) {
            ...
            this._http.postData('/api/v1/instFileSystem/updateVideoStatus', obj).subscribe((res) => {
                this.msgService.showErrorMessage('success', '', 'File(s) uploaded successfully');
                $('#uploadRec').modal('hide');
                this.fileUploadXHR = '';
                this.getClassesList();
        ...
        RefreshSession(obj) {
            console.log(obj);
            this.auth.showLoader();
            this._http.getData('/api/v1/meeting_manager/refresh/' + sessionStorage.getItem('institute_id') + '/' + obj.session_id).subscribe((res) => {
                this.auth.hideLoader();
                this.getClassesList();
            }, err => {
                this.auth.hideLoader();
    ...
    LiveClassesComponent.ctorParameters = () => [
    ...
    LiveClassesComponent.propDecorators = {
        onPopState: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["HostListener"], args: ['document:keydown', ['$event'],] }],
        onMouseOver: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["HostListener"], args: ["document:contextmenu", ['$event'],] }]
    };
    LiveClassesComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-live-classes',
            template: __importDefault(__webpack_require__(/*! raw-loader!./live-classes.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/live-classes-module/live-classes/live-classes.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./live-classes.component.scss */ "./src/app/components/live-classes-module/live-classes/live-classes.component.scss")).default]
        }),
        __metadata("design:paramtypes", [_services_authenticator_service__WEBPACK_IMPORTED_MODULE_6__["AuthenticatorService"],
            _app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"],
            _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"],
            ___WEBPACK_IMPORTED_MODULE_3__["HttpService"],
            ___WEBPACK_IMPORTED_MODULE_3__["MessageShowService"],
            _node_modules_angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__["DomSanitizer"],
            _services_products_service__WEBPACK_IMPORTED_MODULE_7__["ProductService"]])
...
//# sourceMappingURL=app-components-live-classes-module-live-classes-module-es2015.js.map