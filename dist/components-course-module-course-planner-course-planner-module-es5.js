(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-course-module-course-planner-course-planner-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsCourseModuleCoursePlannerClassClassComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsCourseModuleCoursePlannerCoursePlannerComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsCourseModuleCoursePlannerExamExamComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsCourseModuleCoursePlannerClassClassComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsCourseModuleCoursePlannerClassClassComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _services_course_services_class_schedule_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../../../../services/course-services/class-schedule.service */
      "./src/app/services/course-services/class-schedule.service.ts");
      /* harmony import */


      var _services_course_services_topic_listing_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../../../../services/course-services/topic-listing.service */
      "./src/app/services/course-services/topic-listing.service.ts");
      /* harmony import */


      var _services_message_show_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../../../../services/message-show.service */
      "./src/app/services/message-show.service.ts");
      /* harmony import */


      var _services_widget_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ../../../../services/widget.service */
      "./src/app/services/widget.service.ts");
      /* harmony import */


      var _course_planner_model__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ../course-planner.model */
      "./src/app/components/course-module/course-planner/course-planner.model.ts");
      /* harmony import */


      var _session_filter_model__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      ...
      function () {
        var ClassComponent = /*#__PURE__*/function () {
          function ClassComponent(router, auth, msgService, classService, widgetService, topicService, httpService) {
            ...
            this.httpService = httpService; // global variables
            ...
            this.coursePlannerFor = "class"; // apis variables to send
            ...
            this.userType = 0; // Array Elements
            ...
            this.courseList = [];
            this.subjectList = []; // batch model array
            ...
            this.filterDateRange = ""; // FOR PAGINATION
            ...
            this.remarksLimit = 50; // FOR CANCEL PopUP

            this.cancellationReason = '';
            this.is_notified = 'Y'; // for Edit
          ...
          _createClass(ClassComponent, [{
            ...
            value: function showHideColForModel() {
            ...
            key: "sessionFilters",
            value: function sessionFilters(filters) {
              var _this2 = this;
            ...
            value: function fetchPreFillData() {
              ...
              if (!this.jsonFlag.isProfessional) {
                ...
                if (this.schoolModel) {
                  ...
                  this.classService.getAllMasterCourse().subscribe(function (res) {
                    ...
                    if (_this3.sessionFiltersArr.masterCourse != "-1") {
                      //update course list if it was set in session
                      _this3.updateCoursesList();
                    }
                ...
                this.classService.getStandardSubjectList(this.inputElements.standard_id, this.inputElements.subject_id, this.inputElements.isAssigned).subscribe(function (res) {
                  _this3.masterCourseList = res.standardLi;
                  _this3.batchList = res.batchLi;

                  if (_this3.sessionFiltersArr.standardId != "-1") {
                    //update course list if it was set in session
                    _this3.updateCoursesList();
                  }
              ...
              this.classService.getAllTeachersListOld().subscribe(function (res) {
                _this3.facultyList = res;
              }, function (err) {
                _this3.msgService.showErrorMessage(_this3.msgService.toastTypes.error, '', 'Please check your internet connection or contact at support@proctur.com if the issue persist');
              });
            }
            ...
            value: function getStandard() {
              ...
              this.httpService.getData('/api/v1/courseMaster/standard-section-list/' + sessionStorage.getItem('institute_id')).subscribe(function (res) {
                ...
                _this4.masterCourseList = res.result;
              }, function (err) {
                _this4.auth.hideLoader();

                _this4.msgService.showErrorMessage(_this4.msgService.toastTypes.error, '', 'Please check your internet connection or contact at support@proctur.com if the issue persist');
              });
            }
          }, {
            key: "getCourseList",
            ...
            value: function updateCoursesList() {
              ...
              if (!this.jsonFlag.isProfessional) {
                ...
                if (this.sessionFiltersArr.courseId != "-1" && this.sessionFiltersArr.courseId != "") {
                  // if courseid is set in seesion then fetch data according to it
                  this.inputElements.course = this.sessionFiltersArr.courseId;
                } else {
                ...
                if (this.inputElements.masterCourse == "") {
                  ...
                  if (this.inputElements.standard_id == "-1") {
                    ...
                    this.classService.getStandardSubjectList(this.inputElements.standard_id, this.inputElements.subject_id, this.inputElements.isAssigned).subscribe(function (res) {
                      ...
                      _this5.courseList = res.subjectLi;
                      _this5.batchList = res.batchLi;

                      _this5.auth.hideLoader();

                      for (var i = 0; i < _this5.masterCourseList.length; i++) {
                        if (_this5.masterCourseList[i].standard_id == _this5.inputElements.standard_id) {
                          _this5.courseStartDate = _this5.masterCourseList[i].start_date;
                          _this5.courseEndDate = _this5.masterCourseList[i].end_date;

                          if (_this5.sessionFiltersArr.subjectId != "-1" && _this5.sessionFiltersArr.subjectId != "") {
                            // check subject id null to fetch course according to it.
                            _this5.inputElements.subject_id = _this5.sessionFiltersArr.subjectId;

                            _this5.updateSubjectsList();
                          }
              ...
              if (!this.jsonFlag.isProfessional) {
                ...
                if (this.inputElements.course == "" || this.inputElements.course == "-1") {
                  ...
                  this.classService.getStandardSubjectList(this.inputElements.standard_id, this.inputElements.subject_id, this.inputElements.isAssigned).subscribe(function (res) {
                    ...
                    _this6.msgService.showErrorMessage(_this6.msgService.toastTypes.error, '', err);
                  });
                }
            }
          }, {
            ...
            value: function getSchoolSubjects() {
              ...
              this.httpService.getData(url).subscribe(function (res) {
                _this7.auth.hideLoader(); //console.log('Subject', res);


                _this7.subjectList = res.batchesList;
              }, function (err) {
            ...
            value: function updateSubject() {
              ...
              if (!this.jsonFlag.isProfessional) {
                ...
                var temp = this.batchList.filter(function (x) {
                  return x.batch_id == _this8.inputElements.batch_id;
                });
            ...
            value: function updateFacultyInFilter() {
            ...
            value: function updateStatusFilter(e, statusFilter) {
              if (!e.currentTarget.checked) {
                // if checkbox is unchecked then set courseplanner payload
                ...
                // if checkbox is getting checked
                if (statusFilter == 'upcoming') {
            ...
            value: function getData() {
              ...
              this.auth.showLoader(); // Course/bacth model and master course is selected

              if (!this.jsonFlag.isProfessional && !this.schoolModel && this.coursePlannerFilters.master_course_name == "-1" || !this.jsonFlag.isProfessional && this.schoolModel && this.coursePlannerFilters.standard_id == "-1" || this.jsonFlag.isProfessional && this.coursePlannerFilters.standard_id == "-1") {
                var msg = this.schoolModel ? 'Please select standard' : 'Please select master course';
                this.msgService.showErrorMessage(this.msgService.toastTypes.error, '', msg);
                this.auth.hideLoader();
                return;
              } else {
                // Get Course Planner Data
                if (this.schoolModel) {
                ...
                this.classService.getCoursePlannerData(this.coursePlannerFilters, this.coursePlannerFor).subscribe(function (res) {
                  ...
                  if (_this9.allData.length == 0) {
                    _this9.msgService.showErrorMessage(_this9.msgService.toastTypes.info, 'Info', "No result found");
                  } else {
                    _this9.totalCount = _this9.allData.length;
                    _this9.pageIndex = 1;

                    _this9.fectchTableDataByPage(_this9.pageIndex);
                  }
                }, function (err) {
                  _this9.auth.hideLoader();

                  _this9.coursePlannerData = [];
                  _this9.totalCount = 0;
            ...
            value: function hideShowHideMenu() {
              this.jsonFlag.showHideColumn = false;
            }
            ...
            value: function initiateRescheduleClass(selected) {
              this.classMarkedForAction = selected;
              this.isReschedulePop = true;
            }
          }, {
            key: "initiateRemiderClass",
            value: function initiateRemiderClass(selected) {
              this.classMarkedForAction = selected;
              this.isReminderPop = true;
            }
          }, {
            key: "initiateCancelClass",
            value: function initiateCancelClass(selected) {
              this.classMarkedForAction = selected;
              this.isCancelPop = true;
            }
          }, {
            key: "initiateCourseCancelClass",
            value: function initiateCourseCancelClass(selected) {
              this.classMarkedForAction = selected;
            ...
            value: function getVisibility(c) {
              var d = moment__WEBPACK_IMPORTED_MODULE_2__(c.class_date).format("YYYY-MM-DD");
            ...
            value: function rescheduleClass() {
              ...
              if (this.reSheduleFormValid()) {
                ...
                this.widgetService.reScheduleClass(obj).subscribe(function (res) {
                  ...
                  _this10.msgService.showErrorMessage(_this10.msgService.toastTypes.success, '', 'The request has been processed');

                  _this10.closeRescheduleClass();
            ...
            value: function closeRemiderClass() {
              this.isReminderPop = false;
              this.reminderRemarks = "";
            ...
            value: function countRemarksLimit() {
            ...
            value: function sendReminder() {
              ...
              this.widgetService.notifyStudentSchedule(obj).subscribe(function (res) {
                ...
                _this11.msgService.showErrorMessage(_this11.msgService.toastTypes.success, 'Reminder Sent', 'Students have been notified');

                _this11.closeRemiderClass();
              }, function (err) {
                _this11.auth.hideLoader();
            ...
            value: function initiateCourseRemiderClass() {
              var _this12 = this;
              ...
              this.widgetService.remindCourseLevel(obj).subscribe(function (res) {
                ...
                _this12.msgService.showErrorMessage(_this12.msgService.toastTypes.success, 'Reminder Sent', 'The student have been notified');

                _this12.reminderRemarks = "";

                _this12.closeRemiderClass();
              }, function (err) {
                _this12.auth.hideLoader();

                _this12.msgService.showErrorMessage(_this12.msgService.toastTypes.error, 'Unable to Send Reminder', err.error.message);
              });
            } // Cancel class  For Course Model pop Section

          }, {
            key: "closeCancelClass",
            value: function closeCancelClass() {
            ...
            value: function cancelClass() {
              ...
              obj.cancelSchd.push(schd); // this.auth.showLoader();

              this.widgetService.cancelClassSchedule(obj).subscribe(function (res) {
                // this.auth.hideLoader();
                _this13.msgService.showErrorMessage(_this13.msgService.toastTypes.success, '', 'The requested scheduled has been cancelled');

                _this13.closeCancelClass();
            ...
            value: function cancelCourseClass() {
              var _this14 = this;
              ...
              this.widgetService.cancelCourseSchedule(obj).subscribe(function (res) {
                // this.auth.hideLoader();
                _this14.msgService.showErrorMessage(_this14.msgService.toastTypes.success, 'Course ', 'The requested scheduled has been cancelled');

                _this14.closeCourseCancelClass();
            ...
            value: function cancelBatchClass() {
              var _this15 = this;
              ...
              this.widgetService.cancelBatchSchedule(obj).subscribe(function (res) {
                ...
                _this15.msgService.showErrorMessage(_this15.msgService.toastTypes.success, 'Batch ', 'The requested scheduled has been cancelled');

                _this15.closeCourseCancelClass();

                _this15.getData();
              }, function (err) {
                _this15.auth.hideLoader();

                _this15.msgService.showErrorMessage(_this15.msgService.toastTypes.error, '', err.error.message);
              });
            }
          }, {
            key: "getCancelReason",
            value: function getCancelReason() {
              var temp = [];
              var obj = {
                cancel_note: this.cancellationReason,
                is_notified: this.is_notified,
            ...
            value: function notifyCancelClass(selected) {
              var _this16 = this;
              ...
              if (confirm('Are you sure you want to notify?')) {
                ...
                this.classService.notifyCancelClass(obj, 'class').subscribe(function (res) {
                  ...
                  _this16.msgService.showErrorMessage(_this16.msgService.toastTypes.success, 'Cancelled schedule notification', 'Notification has been sent successfully');
                }, function (err) {
                  _this16.auth.hideLoader();
            ...
            value: function initiateMarkAttendance(selected) {
              var obj = {
                batch_id: selected.batch_id,
            ...
            value: function redirect() {
              this.storeSession();
              var url = this.schoolModel ? '/view/course/create/routine/create' : '/view/course/create/class/add';
            ...
            key: "editCourseClass",
            value: function editCourseClass(course) {
            ...
            value: function fetchTopics() {
              ...
              this.topicService.getAllTopicsSubTopics(subject_id).subscribe(function (resp) {
                _this17.auth.hideLoader();

                _this17.topicsList = [];
                _this17.totalTopicsList = [];
                _this17.topicsList = resp;

                if (!!_this17.topicsList && _this17.topicsList.length > 0) {
                  $('#topicModel').modal('show');
                  $('#editClass').modal('hide');

                  _this17.topicsList.forEach(function (tpc) {
                    _this17.totalTopicsList.push(tpc);

                    tpc.checked = false;

                    if (tpc.subTopic.length) {
                      _this17.getAllTopics(tpc.subTopic);
                    }
                  });

                  var topicIds = _this17.editClass.topic_covered_ids.split('|');

                  topicIds.forEach(function (tpc) {
                    _this17.topicsList.forEach(function (tp) {
                      if (tp.topicId == tpc) {
                        tp.checked = true;
                      }
                    });
                  ...
                  _this17.msgService.showErrorMessage(_this17.msgService.toastTypes.info, 'Info', "No topics available to link");
                }
              }, function (err) {
                _this17.auth.hideLoader();
            ...
            value: function getAllTopics(topic) {
              ...
              topic.forEach(function (obj) {
                _this18.totalTopicsList.push(obj);

                obj.checked = false;

                if (obj.subTopic.length) {
                  _this18.getAllTopics(obj.subTopic);
                }
              });
            }
          }, {
            ...
            value: function checkAllSubTopics(topic, param) {
              ...
              topic.forEach(function (obj) {
                ...
                if (obj.subTopic.length) {
                  _this19.checkAllSubTopics(obj.subTopic, param);
                }
              });
            ...
            key: "showEditOption",
            value: function showEditOption() {
              $('#topicModel').modal('hide');
              $('#editClass').modal('show');
            }
          }, {
            key: "saveTopics",
            value: function saveTopics() {
              ...
              if (getSelectedTopics != undefined) {
                ...
                var getTopicNames = getSelectedTopics.map(function (obj) {
            ...
            value: function updateClass() {
              ...
              this.classService.changeClassTeacher(obj).subscribe(function (res) {
                ...
                if (result.statusCode == 200) {
                  _this20.msgService.showErrorMessage(_this20.msgService.toastTypes.success, '', 'Class updated successfully');

                  _this20.clearEditValues();
        ...
        ClassComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          selector: 'app-class',
          template: __importDefault(__webpack_require__(
          /*! raw-loader!./class.component.html */
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/course-module/course-planner/class/class.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./class.component.scss */
          "./src/app/components/course-module/course-planner/class/class.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _services_authenticator_service__WEBPACK_IMPORTED_MODULE_5__["AuthenticatorService"], _services_message_show_service__WEBPACK_IMPORTED_MODULE_8__["MessageShowService"], _services_course_services_class_schedule_service__WEBPACK_IMPORTED_MODULE_6__["ClassScheduleService"], _services_widget_service__WEBPACK_IMPORTED_MODULE_9__["WidgetService"], _services_course_services_topic_listing_service__WEBPACK_IMPORTED_MODULE_7__["TopicListingService"], _services_http_service__WEBPACK_IMPORTED_MODULE_4__["HttpService"]])], ClassComponent);
        return ClassComponent;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsCourseModuleCoursePlannerCoursePlannerRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CoursePlannerRoutingModule", function () {
      ...
      var _course_planner_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./course-planner.component */
      "./src/app/components/course-module/course-planner/course-planner.component.ts");
      /* harmony import */


      var _class_class_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./class/class.component */
      "./src/app/components/course-module/course-planner/class/class.component.ts");
      /* harmony import */


      var _exam_exam_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./exam/exam.component */
      ...
      var CoursePlannerRoutingModule =
      /** @class */
      function () {
        var CoursePlannerRoutingModule = function CoursePlannerRoutingModule() {
          _classCallCheck(this, CoursePlannerRoutingModule);
        };

        CoursePlannerRoutingModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
    ...
    /***/
    function srcAppComponentsCourseModuleCoursePlannerCoursePlannerComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsCourseModuleCoursePlannerCoursePlannerComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CoursePlannerComponent", function () {
      ...
      var CoursePlannerComponent =
      /** @class */
      function () {
        var CoursePlannerComponent = /*#__PURE__*/function () {
          function CoursePlannerComponent(auth, appC, router) {
            _classCallCheck(this, CoursePlannerComponent);
          ...
          _createClass(CoursePlannerComponent, [{
            key: "ngOnInit",
            value: function ngOnInit() {
              var _this21 = this;
              ...
              this.auth.institute_type.subscribe(function (res) {
                if (res == "LANG") {
                  _this21.isProfessional = true;
                } else {
                  _this21.isProfessional = false;
                }
              });
            ...
            value: function checkForSessionStorage() {
            ...
            key: "showMenuOf",
            value: function showMenuOf(activeModuleName) {
        ...
        CoursePlannerComponent.ctorParameters = function () {
          return [{
        ...
        CoursePlannerComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          selector: 'app-course-planner',
          template: __importDefault(__webpack_require__(
          /*! raw-loader!./course-planner.component.html */
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/course-module/course-planner/course-planner.component.html"))["default"],
          encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewEncapsulation"].Emulated,
          styles: [__importDefault(__webpack_require__(
          /*! ./course-planner.component.scss */
          "./src/app/components/course-module/course-planner/course-planner.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [_services_authenticator_service__WEBPACK_IMPORTED_MODULE_1__["AuthenticatorService"], _app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])], CoursePlannerComponent);
        return CoursePlannerComponent;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsCourseModuleCoursePlannerCoursePlannerModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CoursePlannerModule", function () {
      ...
      var _course_planner_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./course-planner-routing.module */
      "./src/app/components/course-module/course-planner/course-planner-routing.module.ts");
      /* harmony import */


      var _course_planner_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./course-planner.component */
      "./src/app/components/course-module/course-planner/course-planner.component.ts");
      /* harmony import */


      var _class_class_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./class/class.component */
      "./src/app/components/course-module/course-planner/class/class.component.ts");
      /* harmony import */


      var _exam_exam_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./exam/exam.component */
      "./src/app/components/course-module/course-planner/exam/exam.component.ts");
      /* harmony import */


      var _services_course_services_class_schedule_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ../../../services/course-services/class-schedule.service */
      "./src/app/services/course-services/class-schedule.service.ts");
      /* harmony import */


      var _services_widget_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ../../../services/widget.service */
      "./src/app/services/widget.service.ts");
      /* harmony import */


      var _services_course_services_topic_listing_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ../../../services/course-services/topic-listing.service */
      "./src/app/services/course-services/topic-listing.service.ts");
      /* harmony import */


      var _services_course_services_exam_schedule_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      ...
      /** @class */
      function () {
        var CoursePlannerModule = function CoursePlannerModule() {
          _classCallCheck(this, CoursePlannerModule);
        };

        CoursePlannerModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
          ...
          _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"], _course_planner_routing_module__WEBPACK_IMPORTED_MODULE_5__["CoursePlannerRoutingModule"]],
          declarations: [_course_planner_component__WEBPACK_IMPORTED_MODULE_6__["CoursePlannerComponent"], _class_class_component__WEBPACK_IMPORTED_MODULE_7__["ClassComponent"], _exam_exam_component__WEBPACK_IMPORTED_MODULE_8__["ExamComponent"]],
          entryComponents: [_course_planner_component__WEBPACK_IMPORTED_MODULE_6__["CoursePlannerComponent"]],
          exports: [],
          providers: [_services_course_services_class_schedule_service__WEBPACK_IMPORTED_MODULE_9__["ClassScheduleService"], _services_widget_service__WEBPACK_IMPORTED_MODULE_10__["WidgetService"], _services_course_services_topic_listing_service__WEBPACK_IMPORTED_MODULE_11__["TopicListingService"], _services_course_services_exam_schedule_service__WEBPACK_IMPORTED_MODULE_12__["ExamCourseService"], _services_http_service__WEBPACK_IMPORTED_MODULE_13__["HttpService"]]
        })], CoursePlannerModule);
        return CoursePlannerModule;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsCourseModuleCoursePlannerExamExamComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsCourseModuleCoursePlannerExamExamComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _course_planner_model__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ../course-planner.model */
      "./src/app/components/course-module/course-planner/course-planner.model.ts");
      /* harmony import */


      var _session_filter_model__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ../session-filter.model */
      "./src/app/components/course-module/course-planner/session-filter.model.ts");
      ...
      function () {
        var ExamComponent = /*#__PURE__*/function () {
          function ExamComponent(router, auth, msgService, classService, widgetService, topicService, examService, httpService) {
            ...
            this.coursePlannerFor = "exam"; // apis variables to send
            ...
            this.checkedColCounter = 1; // Array Elements
            ...
            this.displayBatchSize = 20;
            this.totalCount = 0;
            this.sizeArr = [20, 50, 100, 150, 200, 500]; // pop up section variables
            // Cancel Exam
            ...
            this.cancelExamPopUP = false; // for Edit
          ...
          _createClass(ExamComponent, [{
            ...
            value: function ngOnInit() {
              ...
              this.auth.schoolModel.subscribe(function (res) {
                _this22.schoolModel = false;

                if (res) {
                  _this22.schoolModel = true;
                }
              });
              this.showHideColForModel();
              this.jsonFlag.institute_id = sessionStorage.getItem('institute_id');
            ...
            value: function showHideColForModel() {
              if (this.jsonFlag.isProfessional) {
                ...
                this.showHideColumns.topic = false; // this.jsonFlag.setting = false;
              }
            }
          }, {
            key: "sessionFilters",
            ...
            value: function fetchPreFillData() {
              ...
              if (!this.jsonFlag.isProfessional) {
                this.auth.showLoader();
                this.classService.getAllMasterCourse().subscribe(function (res) {
                  _this24.masterCourseList = res;

                  if (_this24.sessionFiltersArr.masterCourse != "-1") {
                    _this24.updateCoursesList();
                  }
                  ...
                  _this24.msgService.showErrorMessage(_this24.msgService.toastTypes.error, '', 'Please check your internet connection or contact at support@proctur.com if the issue persist');
                });
              } else {
                // get master course - course - subject data  for Batch model
                this.auth.showLoader();
                this.classService.getStandardSubjectList(this.inputElements.standard_id, this.inputElements.subject_id, this.inputElements.isAssigned).subscribe(function (res) {
                  _this24.masterCourseList = res.standardLi;
                  _this24.batchList = res.batchLi;

                  if (_this24.sessionFiltersArr.standardId != "-1") {
                    _this24.updateCoursesList();
                  }
              ...
              if (!this.jsonFlag.isProfessional) {
                ...
                if (this.inputElements.standard_id == "-1") {
                  ...
                  this.classService.getStandardSubjectList(this.inputElements.standard_id, this.inputElements.subject_id, this.inputElements.isAssigned).subscribe(function (res) {
                    ...
                    _this25.courseList = res.subjectLi;
                    _this25.batchList = res.batchLi;

                    _this25.auth.hideLoader();

                    for (var i = 0; i < _this25.masterCourseList.length; i++) {
                      if (_this25.masterCourseList[i].standard_id == _this25.inputElements.standard_id) {
                        _this25.courseStartDate = _this25.masterCourseList[i].start_date;
                        _this25.courseEndDate = _this25.masterCourseList[i].end_date;

                        if (_this25.sessionFiltersArr.subjectId != "-1" && _this25.sessionFiltersArr.subjectId != "") {
                          // check subject id null to fetch course according to it.
                          _this25.inputElements.subject_id = _this25.sessionFiltersArr.subjectId;

                          _this25.updateSubjectsList();
                        }

                        _this25.clearFilters();
            ...
            value: function updateSubjectsList() {
              ...
              if (!this.jsonFlag.isProfessional) {
                ...
                this.classService.getStandardSubjectList(this.inputElements.standard_id, this.inputElements.subject_id, this.inputElements.isAssigned).subscribe(function (res) {
                  ...
                  _this26.batchList = res.batchLi;

                  _this26.clearFilters();
                }, function (err) {
                  _this26.auth.hideLoader();
            ...
            value: function updateSubject() {
              ...
              if (!this.jsonFlag.isProfessional) {
                ...
                this.coursePlannerFilters.batch_id = this.inputElements.batch_id;
                var temp = this.batchList.filter(function (x) {
                  return x.batch_id == _this27.inputElements.batch_id;
                });
                this.courseStartDate = '';
                this.courseEndDate = '';
            ...
            value: function getData() {
              ...
              this.filterShow = false;
              this.jsonFlag.showHideColumn = false;
              this.auth.showLoader(); // Course/bacth model and master course is selected check

              if (!this.jsonFlag.isProfessional && this.coursePlannerFilters.master_course_name == "-1" || this.jsonFlag.isProfessional && this.coursePlannerFilters.standard_id == "-1") {
                ...
                this.classService.getCoursePlannerData(this.coursePlannerFilters, this.coursePlannerFor).subscribe(function (res) {
                  ...
                  if (_this28.allData.length == 0) {
                    _this28.msgService.showErrorMessage(_this28.msgService.toastTypes.info, 'Info', "No result found");
                  } else {
                    _this28.totalCount = _this28.allData.length;
                    _this28.pageIndex = 1;

                    _this28.fectchTableDataByPage(_this28.pageIndex);
                  }
                }, function (err) {
                  _this28.auth.hideLoader();

                  _this28.coursePlannerData = [];
                  _this28.totalCount = 0;

                  _this28.msgService.showErrorMessage(_this28.msgService.toastTypes.error, '', err.error.message);
                });
              }
            }
          }, {
            ...
            value: function sendReminderForCourse(data) {
              var _this29 = this;
              ...
              if (confirm('Are you sure you want to notify?')) {
                ...
                this.widgetService.sendReminder(obj).subscribe(function (res) {
                  ...
                  _this29.msgService.showErrorMessage(_this29.msgService.toastTypes.success, 'Reminder Sent', 'Reminder Sent Successfull');
                }, function (err) {
                  _this29.auth.hideLoader();

                  console.log(err);

                  _this29.msgService.showErrorMessage(_this29.msgService.toastTypes.error, '', err.error.message);
                });
              }
            } // Batch Model
            ...
            value: function notifyExamSchedule(data) {
              ...
              if (confirm('Are you sure you want to send Exam Schedule SMS to the batch?')) {
                ...
                this.widgetService.notifyStudentExam(data.schedule_id).subscribe(function (res) {
                  ...
                  _this30.msgService.showErrorMessage(_this30.msgService.toastTypes.success, 'Notified', 'Notification Sent Successfully');
                }, function (err) {
                  _this30.auth.hideLoader(); //console.log(err);
            ...
            value: function onCancelExamClickCourse(data) {
              this.tempData = data;
            ...
            value: function cancelExamCall() {
              ...
              this.widgetService.cancelExamScheduleCourse(obj).subscribe(function (res) {
                // this.auth.hideLoader();
                _this31.msgService.showErrorMessage(_this31.msgService.toastTypes.success, 'Cancelled', 'Exam Cancelled Successfully');

                _this31.closePopUpCommon();
            ...
            value: function closePopUpCommon() {
              this.tempData = "";
              this.subjectList = [];
              this.courseCommonExamCancelPopUP = false;
              this.showReasonSection = "";
            ...
            value: function onCancelExamClick(data) {
              this.cancelExamPopUP = true;
              this.tempData = data;
            }
          }, {
            key: "closeExamPopup",
            value: function closeExamPopup() {
            ...
            value: function cancelExamClassSchedule() {
              ...
              this.widgetService.cancelExamSchedule(obj).subscribe(function (res) {
                // this.auth.hideLoader();
                _this32.msgService.showErrorMessage(_this32.msgService.toastTypes.success, 'Successfully Cancelled', 'Exam Schedule Cancelled Successfully');

                _this32.closeExamPopup();
            ...
            value: function notifyCancelClass(selected) {
              ...
              if (confirm('Are you sure you want to notify?')) {
                ...
                this.classService.notifyCancelClass(obj, 'exam').subscribe(function (res) {
                  ...
                  _this33.msgService.showErrorMessage(_this33.msgService.toastTypes.success, 'Cancelled schedule notification', 'Notification has been sent successfully');
                }, function (err) {
                  _this33.auth.hideLoader();
            ...
            key: "editCourseExam",
            value: function editCourseExam(course) {
              var _this34 = this;

              if (!this.jsonFlag.isProfessional) {
                var url = "/api/v1/courseExamSchedule/fetch-exam-details?course_exam_schedule_id=".concat(course.schedule_id, "&exam_date=").concat(course.date);
                this.auth.showLoader();
                this.httpService.getData(url).subscribe(function (res) {
                  ...
                  _this34.examList = result;
                  $('#editExamForCourse').modal('show');
                }, function (err) {
                  _this34.auth.hideLoader(); //console.log(err);
            ...
            value: function fetchTopics() {
              ...
              this.topicService.getAllTopicsSubTopics(subject_id).subscribe(function (resp) {
                ...
                _this35.topicsList = [];
                _this35.totalTopicsList = [];
                _this35.topicsList = resp;

                if (!!_this35.topicsList && _this35.topicsList.length > 0) {
                  $('#topicModel').modal('show');
                  $('#editExam').modal('hide');

                  _this35.topicsList.forEach(function (tpc) {
                    _this35.totalTopicsList.push(tpc);

                    tpc.checked = false;

                    if (tpc.subTopic.length) {
                      _this35.getAllTopics(tpc.subTopic);
                    }
                  });

                  var topicIds = _this35.editClass.topic_covered_ids.split('|');

                  topicIds.forEach(function (tpc) {
                    _this35.topicsList.forEach(function (tp) {
                      if (tp.topicId == tpc) {
                        tp.checked = true;
                      }
                    });
                  ...
                  _this35.msgService.showErrorMessage(_this35.msgService.toastTypes.info, 'Info', "No topics available to link");
                }
              }, function (err) {
                _this35.auth.hideLoader();
            ...
            key: "fetchTopicForSubject",
            value: function fetchTopicForSubject(exam) {
              var _this36 = this;

              this.currentEditExam = exam;
              this.topicService.getAllTopicsSubTopics(exam.subject_id).subscribe(function (resp) {
                _this36.auth.hideLoader();

                _this36.topicsList = [];
                _this36.totalTopicsList = [];
                _this36.topicsList = resp;

                if (!!_this36.topicsList && _this36.topicsList.length > 0) {
                  $('#topicModel').modal('show');
                  $('#editExamForCourse').modal('hide');

                  _this36.topicsList.forEach(function (tpc) {
                    _this36.totalTopicsList.push(tpc);

                    tpc.checked = false;

                    if (tpc.subTopic.length) {
                      _this36.getAllTopics(tpc.subTopic);
                    }
                  });

                  var topicIds = exam.topics_covered.split('|');
                  topicIds.forEach(function (tpc) {
                    _this36.topicsList.forEach(function (tp) {
                      if (tp.topicId == tpc) {
                        tp.checked = true;
                      }
                    });
                  ...
                  _this36.msgService.showErrorMessage(_this36.msgService.toastTypes.info, 'Info', "No topics available to link");
                }
              }, function (err) {
                _this36.auth.hideLoader();
            ...
            value: function getAllTopics(topic) {
              ...
              topic.forEach(function (obj) {
                _this37.totalTopicsList.push(obj);

                obj.checked = false;

                if (obj.subTopic.length) {
                  _this37.getAllTopics(obj.subTopic);
                }
              });
            }
          }, {
            ...
            value: function checkAllSubTopics(topic, param) {
              ...
              topic.forEach(function (obj) {
                ...
                if (obj.subTopic.length) {
                  _this38.checkAllSubTopics(obj.subTopic, param);
                }
              });
            } //uncheck parent if any of the child is deselected
            ...
            value: function saveTopics() {
              ...
              if (getSelectedTopics != undefined) {
                ...
                if (!this.jsonFlag.isProfessional) {
                  ...
                  for (var index = 0; index < this.examList.length; index++) {
            ...
            value: function updateExam() {
              ...
              if (!this.jsonFlag.isProfessional) {
                ...
                var obj = {
                  ...
                  "exam_detail_list": this.examList.map(function (exam) {
                    var subject = {
                ...
                this.examService.updateExamSubjectWise(obj).subscribe(function (res) {
                  ...
                  if (result.statusCode == 200) {
                    _this39.msgService.showErrorMessage(_this39.msgService.toastTypes.success, '', 'Exam updated successfully');
                  ...
                  _this39.msgService.showErrorMessage(_this39.msgService.toastTypes.error, '', err.error.message);
                });
              } else {
                var _obj = {
                  "batch_id": this.editClass.batch_id,
                ...
                this.classService.changeClassTeacher(_obj).subscribe( // update exam for batch model
        ...
        ExamComponent.ctorParameters = function () {
          return [{
            type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]
          }, {
        ...
        ExamComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          selector: 'app-exam',
          template: __importDefault(__webpack_require__(
          /*! raw-loader!./exam.component.html */
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/course-module/course-planner/exam/exam.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./exam.component.scss */
          "./src/app/components/course-module/course-planner/exam/exam.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _services_authenticator_service__WEBPACK_IMPORTED_MODULE_4__["AuthenticatorService"], _services_message_show_service__WEBPACK_IMPORTED_MODULE_9__["MessageShowService"], _services_course_services_class_schedule_service__WEBPACK_IMPORTED_MODULE_5__["ClassScheduleService"], _services_widget_service__WEBPACK_IMPORTED_MODULE_10__["WidgetService"], _services_course_services_topic_listing_service__WEBPACK_IMPORTED_MODULE_7__["TopicListingService"], _services_course_services_exam_schedule_service__WEBPACK_IMPORTED_MODULE_6__["ExamCourseService"], _services_http_service__WEBPACK_IMPORTED_MODULE_8__["HttpService"]])], ExamComponent);
        return ExamComponent;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsCourseModuleCoursePlannerSessionFilterModelTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SessionFilter", function () {
        return SessionFilter;
      });

      var SessionFilter = function SessionFilter() {
        ...
        var TopicListingService = /*#__PURE__*/function () {
          function TopicListingService(http, auth) {
            ...
            this.auth.currentAuthKey.subscribe(function (key) {
              _this40.Authorization = key;
              _this40.headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                "Content-Type": "application/json",
                "Authorization": _this40.Authorization
              });
            });
            this.auth.currentInstituteId.subscribe(function (id) {
              _this40.institute_id = id;
            });
...
//# sourceMappingURL=components-course-module-course-planner-course-planner-module-es5.js.map