(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app-components-course-module-create-course-course-exam-course-exam-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsCourseModuleCreateCourseCourseExamCourseExamComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsCourseModuleCreateCourseCourseExamCourseExamComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsCourseModuleCreateCourseCourseExamCourseExamComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CourseExamComponent", function () {
        return CourseExamComponent;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "DateMonthFormat", function () {
      ...
      var _services_course_services_exam_schedule_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../../../../services/course-services/exam-schedule.service */
      ...
      var _services_common_api_call_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../../../../services/common-api-call.service */
      "./src/app/services/common-api-call.service.ts");
      /* harmony import */


      var _services_message_show_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      ...
      var CourseExamComponent =
      /** @class */
      function () {
        var CourseExamComponent = /*#__PURE__*/function () {
          function CourseExamComponent(apiService, toastCtrl, auth, topicService, cd, _http, commonApiCall, msgSrvc) {
            _classCallCheck(this, CourseExamComponent);
            ...
            this.total_marks_to_show = 0; // Topic listing variables
          ...
          _createClass(CourseExamComponent, [{
            key: "ngOnInit",
            value: function ngOnInit() {
              ...
              this.checkForCoursePlannerRoute(); // changes by Nalini - to handle school model conditions
            ...
            key: "getMasterCourseBatchData",
            value: function getMasterCourseBatchData() {
              var _this2 = this;
              ...
              this.apiService.getCombinedList(this.batchData.standard_id, this.batchData.subject_id).subscribe(function (res) {
                ...
                if (_this2.masterCourseList.length == 0) {
                  _this2.masterCourseList = res.standardLi;
                }

                if (res.batchLi != null && res.batchLi.length > 0) {
                  _this2.batchesList = res.batchLi;
                  _this2.subjectsList = res.subjectLi;
                }

                if (res.subjectLi != null && res.subjectLi.length > 0) {
                  _this2.courseList = res.subjectLi;
                  _this2.subjectsList = res.subjectLi;
                }
              }, function (err) {
                console.log(err);
            ...
            key: "getMasterCourseBatchDataNew",
            value: function getMasterCourseBatchDataNew() {
              var _this3 = this;
              ...
              this._http.getData(url).subscribe(function (data) {
                ...
                _this3.masterCourseList = data.result;
              }, function (error) {
                _this3.auth.hideLoader();
            ...
            value: function getBatchList() {
              ...
              this.auth.showLoader();
              var url = '/api/v1/batches/batch-list/' + this.institute_id + '/' + this.batchData.subject_id + '?is_active_not_expire=A&sorted_by=batch_name';

              this._http.getData(url).subscribe(function (data) {
                _this4.auth.hideLoader();

                _this4.batchesList = data.result; // this.batchPro = data.batchLi;
              }, function (error) {
                _this4.auth.hideLoader();
            ...
            value: function fetchTopics() {
              ...
              this.topicService.getAllTopicsSubTopics(this.batchData.subject_id).subscribe(function (data) {
                _this5.topicsList = [];
                _this5.topicsList = data;

                if (_this5.topicsList.length && _this5.topicsList != null) {
                  _this5.showTopicsPopUp = true;

                  _this5.auth.hideLoader();

                  _this5.topicsList.forEach(function (tpc) {
                    _this5.totalTopicsList.push(tpc);

                    tpc.checked = false;

                    if (tpc.subTopic.length) {
                      _this5.getAllTopics(tpc.subTopic);
                    }
                  });
                } else {
                  _this5.auth.hideLoader();

                  _this5.messageNotifier('info', 'Info', 'No topics available to link !');
                }
              }, function (err) {
                _this5.auth.hideLoader();
            ...
            value: function fetchSelectedTopics() {
              ...
              this.selectedTopicsListObj.forEach(function (obj) {
                var getTopicObject = _this6.totalTopicsList.find(function (ele) {
            ...
            value: function getAllTopics(topic) {
              ...
              topic.forEach(function (obj) {
                _this7.totalTopicsList.push(obj);

                obj.checked = false;

                if (obj.subTopic.length) {
                  _this7.getAllTopics(obj.subTopic);
                }
              });
            }
          }, {
            ...
            key: "closeTopicModal",
            value: function closeTopicModal(topic) {
              this.showTopicsPopUp = false;
              this.showExamEditModal = false;
            }
          }, {
            ...
            value: function linkTopics() {
              ...
              if (getSelectedTopics != undefined) {
                ...
                this.examSchedule.find(function (ele) {
                  return ele.schd_id == _this8.getSubjectObject.schd_id;
            ...
            value: function checkAllSubTopics(topic, param) {
              ...
              topic.forEach(function (obj) {
                ...
                if (obj.subTopic.length) {
                  _this9.checkAllSubTopics(obj.subTopic, param);
                }
              });
            ...
            key: "checkParent",
            value: function checkParent(topic) {
              var checkAll = true;
            ...
            value: function editTopics(row) {
              ...
              this.topicService.getAllTopicsSubTopics(this.batchData.subject_id).subscribe(function (res) {
                _this10.topicsList = [];
                _this10.topicsList = res;

                if (_this10.topicsList != null && _this10.topicsList.length) {
                  _this10.showTopicsPopUp = true;
                  _this10.showExamEditModal = true;

                  _this10.auth.hideLoader();

                  _this10.topicsList.forEach(function (obj) {
                    list.push(obj);
                    ...
                    if (obj.subTopic.length) {
                      _this10.fetchAllTopics(obj.subTopic, list, selectedTopicIds);
                    }
                  });

                  _this10.totalTopicsList = [];
                  _this10.totalTopicsList = list;
                } else {
                  _this10.auth.hideLoader(); // this.msgService.showErrorMessage(this.msgService.toastTypes.error, 'Error', "No topics available to Link");


                  _this10.messageNotifier('info', 'Info', 'No topics available to link');
                }
              }, function (err) {
                _this10.auth.hideLoader(); // this.msgService.showErrorMessage(this.msgService.toastTypes.error, 'Error', err.error.message);
            ...
            value: function fetchAllTopics(topic, list, idList) {
              ...
              topic.forEach(function (key) {
                ...
                if (key.subTopic.length) {
                  _this11.fetchAllTopics(key.subTopic, list, idList);
                }
              });
            }
          }, {
            ...
            value: function onBatchMasterCourseSelection(event) {
              ...
              this.courseList = [];
              this.batchesList = []; // this.getMasterCourseBatchData();

              this.getCourse();
            }
          }, {
            key: "onBatchCourseSelection",
            value: function onBatchCourseSelection(event) {
              this.batchData.batch_id = -1;

              if (this.batchData.subject_id != -1) {
                this.batchesList = []; // this.getMasterCourseBatchData();

                this.getBatchList(); // this.getMasterCourseBatchDataNew();
              }
            ...
            key: "getCourseName",
            value: function getCourseName(eve) {
              this.selectedCourseName = '';
              this.selectedCourseName = this.subjectsList.find(function (ob) {
                return ob.subject_id == eve;
              }).subject_name;
            }
          }, {
            key: "batchModelGoClick",
            value: function batchModelGoClick() {
              var _this12 = this;
              ...
              if (this.batchData.batch_id != -1) {
                ...
                this.apiService.getExamSchedule(this.batchData.batch_id).subscribe(function (res) {
                  ...
                  _this12.showContentSection = true;
                  _this12.jsonVar.isSheduleBatch = true;
                  _this12.examScheduleData = res;
                  console.log("this.examScheduleData", _this12.examScheduleData);
                  _this12.batchStartDate = _this12.examScheduleData.batch_start_date;
                  _this12.batchEndDate = _this12.examScheduleData.batch_end_date;

                  if (moment__WEBPACK_IMPORTED_MODULE_1__(_this12.batchEndDate).format("YYYY-MM-DD") < moment__WEBPACK_IMPORTED_MODULE_1__().format("YYYY-MM-DD")) {
                    _this12.jsonVar.isSheduleBatch = false;
                  } else {
                    _this12.jsonVar.isSheduleBatch = true;
                  }
                  ...
                  if (res.otherSchd != "" && res.otherSchd != null) {
                    if (res.otherSchd.length > 0) {
                      _this12.examSchedule = res.otherSchd;
                    }
                  }

                  if (res.cancelSchd != "" && res.cancelSchd != null) {
                    if (res.cancelSchd.length > 0) {
                      _this12.cancelledSchedule = res.cancelSchd;
                    }
                  }
                }, function (err) {
                  ...
                  _this12.messageNotifier('error', '', err.error.message);
                });
              } else {
            ...
            key: "addNewExamSchedule",
            value: function addNewExamSchedule() {
              ...
              var start_time = moment__WEBPACK_IMPORTED_MODULE_1__(this.createTimeInFormat(this.batchAdderData.start_time.hour, this.batchAdderData.start_time.minute, 'comp'), 'h:mma');
              var end_time = moment__WEBPACK_IMPORTED_MODULE_1__(this.createTimeInFormat(this.batchAdderData.end_time.hour, this.batchAdderData.end_time.minute, 'comp'), 'h:mma');
            ...
            key: "addDataToExamSchedule",
            value: function addDataToExamSchedule() {
              var _this13 = this;
              ...
              if (!this.auth.isRippleLoad.getValue()) {
                ...
                this.apiService.serverRequestToSaveSchedule(dataToSend, type).subscribe(function (res) {
                  ...
                  _this13.messageNotifier('success', 'Successfully', 'Schedule Created Successfully');

                  _this13.batchModelGoClick();
                }, function (err) {
                  _this13.auth.hideLoader(); //console.log(err);


                  _this13.messageNotifier('error', '', err.error.message);
                });
              }
            ...
            key: "makeJsonToSendData",
            value: function makeJsonToSendData() {
              var obj = {};
              ...
              if (this.examSchedule.length > 0) {
                for (var i = 0; i < this.examSchedule.length; i++) {
                  var test = {};
                  test.exam_date = moment__WEBPACK_IMPORTED_MODULE_1__(this.examSchedule[i].exam_date).format('YYYY-MM-DD'), test.start_time = this.examSchedule[i].start_time;
            ...
            key: "editSubject",
            value: function editSubject(row_no, subject_data) {
              if (this.selectedRow !== "") {
            ...
            key: "updateSubject",
            value: function updateSubject(row_no, subject_data) {
              var _this14 = this;
              ...
              if (this.subjectListData.length > 0) {
                this.subjectListData[0].forEach(function (ele) {
                  if (_this14.edit_subject_id == ele.subject_id) {
            ...
            value: function deleteExamSchedule(data, index) {
              this.examSchedule.splice(index, 1);
            }
          }, {
            key: "notifyExamSchedule",
            value: function notifyExamSchedule(data) {
              var _this15 = this;
              ...
              if (confirm('Are you sure u want to send Exam Schedule SMS to the batch?')) {
                this.apiService.notifyStudentExam(data.schd_id).subscribe(function (res) {
                  _this15.messageNotifier('success', 'Notified', 'Notification Sent Successfully');
                }, function (err) {
                  //console.log(err);
                  _this15.messageNotifier('error', '', err.error.message);
                });
              }
            } //cancelExamSchedule
            ...
            value: function cancelExamSchedule(data) {
              this.cancelExamPopUp = true;
              this.cancelExamData = data;
            }
          }, {
            key: "closeCancelExamPopUp",
            value: function closeCancelExamPopUp() {
            ...
            value: function cancelExamClassSchedule() {
              var _this16 = this;
              ...
              if (!this.auth.isRippleLoad.getValue()) {
                ...
                this.apiService.cancelExamSchedule(obj).subscribe(function (res) {
                  _this16.messageNotifier('success', 'Successfully Cancelled', 'Scheduled exam cancelled successfully');

                  _this16.auth.hideLoader();

                  _this16.batchModelGoClick();

                  _this16.closeCancelExamPopUp();
                }, function (err) {
                  //console.log(err);
                  _this16.auth.hideLoader();

                  _this16.messageNotifier('error', '', err.error.message);
                });
              }
            } // Mark Attendance Popup

          }, {
            key: "markAttendanceSchedule",
            value: function markAttendanceSchedule(data) {
            ...
            value: function getStudentList() {
              ...
              this.apiService.fetchStudentList(obj).subscribe(function (res) {
                ...
                _this17.studentList = res;

                _this17.getTotalCountForCourse(res);

                if (res.length > 0) {
                  _this17.attendanceNote = res[0].dateLi[0].attendance_note;
                } else {
                  _this17.attendanceNote = "";
                }
              }, function (err) {
                //console.log(err);
                _this17.auth.hideLoader();

                _this17.messageNotifier('error', '', err.error.message);

                _this17.closeCourseLevelAttendance();
              });
            }
          }, {
            key: "getDisability",
            value: function getDisability(s) {
            ...
            key: "markAttendaceBtnClickCourse",
            value: function markAttendaceBtnClickCourse(event, rowData, index) {
            ...
            key: "getTotalCountForCourse",
            value: function getTotalCountForCourse(data) {
              this.absentCount = 0;
              this.presentCount = 0;
              this.leaveCount = 0;
            ...
            key: "getClassForLeave",
            value: function getClassForLeave(data) {
            ...
            key: "getClassForAbsent",
            value: function getClassForAbsent(data) {
            ...
            key: "getClassForPresent",
            value: function getClassForPresent(data) {
            ...
            key: "closeCourseLevelAttendance",
            value: function closeCourseLevelAttendance() {
              this.markAttendancePopUp = false;
              this.studentList = [];
              this.absentCount = 0;
              this.presentCount = 0;
            ...
            key: "markAllPresent",
            value: function markAllPresent(e) {
              if (e.target.checked) {
                this.studentList.forEach(function (e) {
                  if (e.dateLi[0].status == "L" && e.dateLi[0].isStatusModified == "N") {//Do Nothing
                  } else {
            ...
            value: function updateCourseAttendance() {
              var _this18 = this;
              ...
              this.apiService.markAttendance(dataToSend).subscribe(function (res) {
                ...
                _this18.messageNotifier('success', 'Attendance Marked', 'Attendance Marked Successfully');

                _this18.closeCourseLevelAttendance();
              }, function (err) {
                _this18.auth.hideLoader(); //console.log(err);


                _this18.messageNotifier('error', '', err.error.message);
              });
            }
          }, {
            key: "makeJsonForAttendceMark",
            value: function makeJsonForAttendceMark() {
              var notify = "";
            ...
            value: function notifyCancelClass(data) {
              var _this19 = this;
              ...
              if (confirm('Are you sure, You want to notify?')) {
                ...
                this.apiService.notifyCancelledClass(obj).subscribe(function (res) {
                  _this19.messageNotifier('success', 'Success', 'Notified Successfully');
                }, function (err) {
                  //console.log(err);
                  _this19.messageNotifier('error', '', err.error.message);
                });
              }
            }
          }, {
            key: "unCancelClass",
            value: function unCancelClass(data) {
              var _this20 = this;
              ...
              if (confirm("Are you sure, you want  to uncancel the exam schedule??")) {
                ...
                this.apiService.uncancelClassSchedule(obj).subscribe(function (res) {
                  _this20.messageNotifier('success', 'Uncancelled Succesfully', 'Exam Uncancelled Successfully');

                  _this20.batchModelGoClick();
                }, function (err) {
                  //console.log(err);
                  _this20.messageNotifier('error', '', err.error.message);
                });
              }
            } ////////// Course Model
            ...
            value: function getMasterCourse() {
              ...
              this._http.getData(url).subscribe(function (data) {
                ...
                _this22.fullResponse = data.result;
                keys = Object.keys(data.result);
                console.log("keys", keys);

                for (var i = 0; i < keys.length; i++) {
                  _this22.masterCourseList.push(keys[i]);
                }
              }, function (error) {
                _this22.auth.hideLoader();
            ...
            key: "getCourseList",
            value: function getCourseList(event) {
              this.courseList = [];
              var temp = this.fullResponse[this.courseData.master_course];
            ...
            key: "displayCourseDate",
            value: function displayCourseDate() {
            ...
            value: function validateDateRange() {
              ...
              if (this.courseList.length > 0) {
                selectedCourse = this.courseList.filter(function (el) {
                  return el.course_id == _this23.courseData.course_id;
                });
                var requested_date = this.courseData.requested_date;
            ...
            key: "getExamSchedule",
            value: function getExamSchedule() {
              var _this24 = this;
              ...
              if (this.courseData.master_course != "" && this.courseData.course_id != -1) {
                ...
                this.apiService.getSchedule(this.courseData).subscribe(function (res) {
                  ...
                  _this24.multiClickDisabled = false;
                  _this24.examScheduleData = res;

                  _this24.calculateDataAsPerSelection(res); // console.log(this.subjectListData);


                  _this24.showContentSection = true; //console.log(res);
                }, function (err) {
                  _this24.auth.hideLoader(); //console.log(err);


                  _this24.messageNotifier('error', '', err.error.message);
                });
              } else {
            ...
            key: "calculateDataAsPerSelection",
            value: function calculateDataAsPerSelection(result) {
              var _this25 = this;
                ...
                if (result.coursesList.length > 0) {
                  for (var i = 0; i < result.coursesList.length; i++) {
                    ...
                    if (this.courseData.course_id == result.coursesList[i].course_id) {
                      (function () {
                        _this25.subjectListData.push(result.coursesList[i].batchesList);
                        ...
                        if (result.coursesList[i].courseClassSchdList != null && result.coursesList[i].courseClassSchdList.length > 0) {
                          ...
                          obj.courseModelAdder.start_time = _this25.breakTimeFormat(result.coursesList[i].courseClassSchdList[0].start_time);
                          obj.courseModelAdder.end_time = _this25.breakTimeFormat(result.coursesList[i].courseClassSchdList[0].end_time);
            ...
            key: "checkNgetiveValue",
            value: function checkNgetiveValue($event) {
              // console.log($event);
              if ($event < 0) {
            ...
            key: "topicLinking",
            value: function topicLinking(subjectData, index) {
              var _this26 = this;
              ...
              if (subject_id == '' || subject_id == null || subject_id == '-1' || subject_id == undefined) {
                ...
                this.topicService.getAllTopicsSubTopics(subject_id).subscribe(function (res) {
                  _this26.topicLinkColor = true;
                  var temp;
                  temp = res;

                  if (temp != null && temp.length != 0) {
                    _this26.topicBox = false;

                    _this26.auth.hideLoader();

                    _this26.topicsData = res;
                    var subjectName = "";
                    subjectData.forEach(function (ele) {
                      if (ele.subject_id == _this26.subject_id) {
                        subjectName = ele.subject_name;
                      }
                    });
                    document.getElementById("topicSubName").innerHTML = subjectName;
                    document.getElementById("topicCount").innerHTML = _this26.topicsData.length;

                    _this26.children = function (dataItem) {
                      return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(dataItem.subTopic);
                    };

                    _this26.hasChildren = function (item) {
                      return item.subTopic && item.subTopic.length > 0;
                    };
                  } else {
                    _this26.auth.hideLoader();

                    _this26.messageNotifier('info', 'Info', 'No topics available to Link');
                  }
                }, function (err) {
                  _this26.auth.hideLoader();

                  _this26.messageNotifier('error', '', err.error.message);
                });
              }
            }
          }, {
            key: "topicLinkingForPreSelectedTopics",
            value: function topicLinkingForPreSelectedTopics(subjectData) {
              var _this27 = this;
              ...
              if (this.row_edit_subject_id == '' || this.row_edit_subject_id == null || this.row_edit_subject_id == '-1' || this.row_edit_subject_id == undefined) {
                ...
                this.topicService.getAllTopicsSubTopics(this.row_edit_subject_id).subscribe(function (res) {
                  ...
                  if (temp != null && temp.length != 0) {
                    ...
                    var data = _this27.row_edit_subject_topicId.toString();
                    ...
                    subjectData.forEach(function (ele) {
                      if (ele.subject_id == _this27.row_edit_subject_id) {
                        subjectName = ele.subject_name;
                      }
                    });
                    _this27.subject_name = subjectName;
                    ...
                    _this27.messageNotifier('info', 'Info', 'No topics available to Link');
                  }
                }, function (err) {
                  _this27.auth.hideLoader();

                  _this27.messageNotifier('error', '', err.error.message);
                });
              }
            }
          }, {
            ...
            value: function topicListing() {
              ...
              if (this.subject_id == '' || this.subject_id == null || this.subject_id == '-1' || this.subject_id == undefined) {
                ...
                this.topicService.getAllTopicsSubTopics(this.subject_id).subscribe(function (res) {
                  ...
                  if (temp != null && temp.length != 0) {
                    _this28.topicBox = false;

                    _this28.auth.hideLoader();

                    _this28.topicsData = res;
                    var subjectName = "";

                    _this28.subjectListData[0].forEach(function (ele) {
                      if (_this28.subject_id == ele.subject_id) {
                        _this28.subject_name = ele.subject_name;
                      }
                    });

                    _this28.children = function (dataItem) {
                      return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(dataItem.subTopic);
                    };

                    _this28.hasChildren = function (item) {
                      return item.subTopic && item.subTopic.length > 0;
                    };
                  } else {
                    _this28.auth.hideLoader();

                    _this28.messageNotifier('info', 'Info', 'No topics available to Link');
                  }
                }, function (err) {
                  _this28.auth.hideLoader();

                  _this28.messageNotifier('error', '', err.error.message);
                });
              }
            }
          }, {
            ...
            value: function removeNLevelTopic(subTopics) {
              ...
              if (subTopics.length == 0) {
                ...
                subTopics.forEach(function (object) {
                  var arrayIndex = _this29.checkedKeys.indexOf(object.topicId);

                  if (arrayIndex > -1) {
                    _this29.checkedKeys.splice(arrayIndex, 1);
                  }

                  if (object.subTopic.length) {
                    _this29.removeNLevelTopic(object.subTopic);
                  }
                });
              }
            ...
            value: function AddNLevelTopic(subTopics) {
              ...
              if (subTopics.length == 0) {
                ...
                subTopics.forEach(function (object) {
                  var arrayIndex = _this30.checkedKeys.indexOf(object.topicId);

                  if (arrayIndex == -1) {
                    _this30.checkedKeys.push(object.topicId);
                  }

                  if (object.subTopic.length) {
                    _this30.AddNLevelTopic(object.subTopic);
                  }
                });
              }
            }
          }, {
            key: "preSelectedTopicListing",
            value: function preSelectedTopicListing() {
              var _this31 = this;
              ...
              if (this.edit_subject_id == '' || this.edit_subject_id == null || this.edit_subject_id == '-1' || this.edit_subject_id == undefined) {
                ...
                this.topicService.getAllTopicsSubTopics(this.edit_subject_id).subscribe(function (res) {
                  ...
                  if (temp != null && temp.length != 0) {
                    _this31.topicBox = false;

                    _this31.auth.hideLoader();

                    _this31.topicsData = res;
                    _this31.checkedKeys = _this31.edit_subject_topicId;

                    _this31.subjectListDataSource.forEach(function (ele) {
                      if (ele.subject_id == _this31.subject_id) {
                        _this31.subject_name = ele.subject_name;
                      }
                    });

                    _this31.children = function (dataItem) {
                      return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(dataItem.subTopic);
                    };

                    _this31.hasChildren = function (item) {
                      return item.subTopic && item.subTopic.length > 0;
                    };
                  } else {
                    _this31.auth.hideLoader();

                    _this31.messageNotifier('info', 'Info', 'No topics available to Link');
                  }
                }, function (err) {
                  _this31.auth.hideLoader();

                  _this31.messageNotifier('error', '', err.error.message);
                });
              }
            }
          }, {
            ...
            value: function saveTopic() {
              ...
              this.checkedKeys.forEach(function (ele) {
                _this32.findNameInJSON(_this32.topicsData, ele);
              });
            ...
            key: "findNameInJSON",
            value: function findNameInJSON(arr, nameVal) {
            ...
            key: "addNewExamSubject",
            value: function addNewExamSubject() {
              var _this33 = this;
              ...
              if (this.newExamData.startTimeHrs == this.newExamData.endTimeHrs && this.newExamData.startTimeMins == this.newExamData.endTimeMins) {
              ...
              var subjectName = "";
              var is_optional_subject = false;
              this.subjectListData[0].forEach(function (ele) {
                if (_this33.subject_id == ele.subject_id) {
                  subjectName = ele.subject_name;
                  if (_this33.schoolModel) is_optional_subject = ele.is_optional_subject;
                }
              });
              var topic_names = this.topicsName.join(", ");
              var obj = {};
              ...
              if (this.schoolModel) {
                var examTypeArr = this.selectedExamTypeId.split(',');
            ...
            key: "addNewExamSubjectCourse",
            value: function addNewExamSubjectCourse(index) {
              if (this.schoolModel) {
            ...
            key: "getSubjectName",
            value: function getSubjectName(data, id) {
              for (var i = 0; i < data.length; i++) {
            ...
            key: "deleteSubject",
            value: function deleteSubject(subject_id) {
              for (var i = 0; i < this.newExamSubjectData.length; i++) {
            ...
            value: function deleteFromCourse(data, index, j) {
            ...
            key: "editFromCourse",
            value: function editFromCourse(data, index, j) {
              if (this.selectedRow !== "") {
            ...
            key: "updateEditedSubject",
            value: function updateEditedSubject(row, index, j) {
              var _this34 = this;
              ...
              this.viewList[j].subjectList.forEach(function (ele) {
                if (_this34.row_edit_subject_id == ele.subject_id) {
                  subjectName = ele.subject_name;
                }
              }); // let topic_names = this.topicsName.join(",");

              var topic_names = this.topicsName;
              var topics_covered_ids = this.row_edit_subject_topicId;
            ...
            key: "saveExamScheduleCourse",
            value: function saveExamScheduleCourse() {
              var _this35 = this;
                ...
                if (flag) {
                  this.apiService.updateExamSch(dataToSend).subscribe(function (res) {
                    ...
                    if (res.statusCode == 200) {
                      _this35.messageNotifier('success', 'Success', 'Exam scheduled successfully');

                      _this35.clearAllField();

                      _this35.getExamSchedule();
                    } else {
                      _this35.messageNotifier('error', '', res.message);
                    }
                  }, function (err) {
                    _this35.auth.hideLoader();
                    ...
                    _this35.messageNotifier('error', '', err.error.message);
                  });
                }
              } else {
                this.multiClickDisabled = false;
            ...
            key: "makeDataJsonToSendServer",
            value: function makeDataJsonToSendServer() {
              var _this36 = this;

              var coursesLists = []; /// This section makes json for perticular selected course
              ...
              data.coursesList = []; // FOR ALREADY PRESENT EXAM
              ...
              if (this.newExamSubjectData.length > 0) {
                ...
                var _test = {
                  course_id: '',
                  course_exam_schedule_id: '-1'
                };

                if (this.viewList.length > 0) {
                  _test.course_id = this.viewList[0].selectedCourseList.course_id;
                }

                var _check = this.validateTime2();

                if (_check == false) {
                  return;
                }

                var _startTime = this.createTimeInFormat(this.newExamData.startTimeHrs, this.newExamData.startTimeMins, '');

                var _endTime = this.createTimeInFormat(this.newExamData.endTimeHrs, this.newExamData.endTimeMins, '');

                _test.exam_start_time = _startTime;
                _test.exam_end_time = _endTime;
                _test.courseClassSchdList = [];

                if (this.newExamSubjectData.length > 0) {
                  for (var _j = 0; _j < this.newExamSubjectData.length; _j++) {
                    var _classLi = {};
                    var bactch_id = "";

                    for (var k = 0; k < this.subjectListData[0].length; k++) {
                      if (this.newExamSubjectData[_j].subject_id == this.subjectListData[0][k].subject_id) {
                        bactch_id = this.subjectListData[0][k].batch_id;
                      }
                    }

                    _classLi.batch_id = bactch_id.toString();
                    ;
                    _classLi.start_time = _startTime;
                    _classLi.end_time = _endTime;
                    _classLi.class_desc = this.newExamSubjectData[_j].exam_desc;
                    _classLi.duration = _check;
                    _classLi.topics_covered = this.newExamSubjectData[_j].topicsId.join("|");
                    _classLi.total_marks = this.newExamSubjectData[_j].exam_marks.toString();
                    _classLi.room_no = this.newExamSubjectData[_j].exam_room_no;
                    _classLi.class_schedule_id = "0";

                    if (this.schoolModel) {
                      _classLi.exam_type_id = this.newExamSubjectData[_j].exam_type_id;
                      _classLi.is_optional_subject = this.newExamSubjectData[_j].is_optional_subject;
                    }

                    total += Number(this.newExamSubjectData[_j].exam_marks.toString());

                    _test.courseClassSchdList.push(_classLi);
                  } // if (total != this.viewList[i].courseModelAdder.total_marks) {
                  //   this.messageNotifier('error', '', 'Please check total marks provided');
                  //   return false;
                  // }
                ...
                if (validation_flag) {
                  var _loop = function _loop(m) {
                    ...
                    _this36.examScheduleData.coursesList.forEach(function (object, index) {
              ...
              if (this.examScheduleData.coursesList.length > 0) {
                ...
                var _loop2 = function _loop2(_i) {
                  if (_this36.examScheduleData.coursesList[_i].course_id != _this36.courseData.course_id) {
                    var unselected = {};
                    var timeStart = null;
                    var timeEnd = null;
                    unselected.course_id = _this36.examScheduleData.coursesList[_i].course_id.toString();
                    unselected.courseClassSchdList = [];
                    unselected.course_exam_schedule_id = 0;

                    if (_this36.examScheduleData.coursesList[_i].courseClassSchdList != null) {
                      var courseSch = _this36.examScheduleData.coursesList[_i].courseClassSchdList;

                      if (courseSch.length > 0) {
                        for (var _j2 = 0; _j2 < courseSch.length; _j2++) {
                          var _classLi2 = {};
                          timeStart = courseSch[_j2].start_time;
                          timeEnd = courseSch[_j2].end_time;
                          _classLi2.batch_id = courseSch[_j2].batch_id.toString();
                          _classLi2.start_time = courseSch[_j2].start_time;
                          _classLi2.end_time = courseSch[_j2].end_time;
                          _classLi2.class_desc = courseSch[_j2].class_desc;
                          _classLi2.duration = courseSch[_j2].duration;
                          _classLi2.total_marks = courseSch[_j2].total_marks.toString();
                          _classLi2.room_no = courseSch[_j2].room_no;
                          _classLi2.class_schedule_id = courseSch[_j2].class_schedule_id.toString();
                          unselected.courseClassSchdList.push(_classLi2);
                        }

                        unselected.course_exam_schedule_id = _this36.examScheduleData.coursesList[_i].course_exam_schedule_id.toString();
                      }
                    }
                  ...
                  } else if (_this36.examScheduleData.coursesList[_i].course_id == _this36.courseData.course_id && _this36.examScheduleData.coursesList[_i] && _this36.examScheduleData.coursesList[_i].courseClassSchdList == null && _this36.examScheduleData.coursesList[_i].course_exam_schedule_id != 0) {
                    ...
                    if (data.coursesList[_i] && _this36.examScheduleData.coursesList[_i]) {
                      data.coursesList[startIndex].course_exam_schedule_id = _this36.examScheduleData.coursesList[_i].course_exam_schedule_id;
                      startIndex++;
                    } else if (_this36.examScheduleData.coursesList[_i]) {
                      var obj = {
                        "course_id": _this36.examScheduleData.coursesList[_i].course_id,
                        "courseClassSchdList": [],
                        "exam_start_time": null,
                        "exam_end_time": null,
                        "course_exam_schedule_id": _this36.examScheduleData.coursesList[_i].course_exam_schedule_id
                      };
                      data.coursesList.push(obj);
                    }
                  } else if (_this36.examScheduleData.coursesList[_i].course_id == _this36.courseData.course_id && _this36.examScheduleData.coursesList[_i] && _this36.examScheduleData.coursesList[_i].courseClassSchdList) {
                    var isNeedToAdd = true;
                    data.coursesList.forEach(function (obj) {
                      if (obj.course_exam_schedule_id == _this36.examScheduleData.coursesList[_i].course_exam_schedule_id) {
                        isNeedToAdd = false;
                      }
                    });
                    ...
                    if (isNeedToAdd) {
                      if (coursesLists[_i]) {
                        data.coursesList.push(coursesLists[_i]);
                      }
                    }
                  }
                };

                for (var _i = 0; _i < this.examScheduleData.coursesList.length; _i++) {
                  _loop2(_i);
                }
              }
            ...
            key: "cancelExamCourse",
            value: function cancelExamCourse(data, index, j) {
              this.cancelExamPopUp = true;
              this.cancelExamData = this.viewList[j].courseTableList[index];
            }
          }, {
            key: "cancelCourseExam",
            value: function cancelCourseExam() {
              var _this37 = this;
              ...
              if (!this.auth.isRippleLoad.getValue()) {
                ...
                this.apiService.cancelExamSchedule(obj).subscribe(function (res) {
                  ...
                  _this37.messageNotifier('success', 'Successfully Cancelled', 'Scheduled exam cancelled successfully');

                  _this37.closeCancelExamPopUp();

                  _this37.getExamSchedule();
                }, function (err) {
                  //console.log(err);
                  _this37.auth.hideLoader();

                  _this37.messageNotifier('error', '', err.error.message);
                });
              }
            } // cancel Button next to Send Reminder

          }, {
            key: "cancelExamForFullCourse",
            value: function cancelExamForFullCourse(data, index) {
              this.cancelExamPopUp = true;
              this.cancelExamData = data;
              this.jsonVar.cancelCourseLevel = true;
            }
          }, {
            key: "cancelCourseLevelExam",
            value: function cancelCourseLevelExam() {
              var _this38 = this;
              ...
              if (!this.auth.isRippleLoad.getValue()) {
                ...
                this.apiService.cancelExamScheduleCourse(obj).subscribe(function (res) {
                  ...
                  _this38.messageNotifier('success', 'Successfully Cancelled', 'Scheduled exam cancelled successfully');

                  _this38.closeCancelExamPopUp();

                  _this38.getExamSchedule();
                }, function (err) {
                  //console.log(err);
                  _this38.auth.hideLoader();

                  _this38.messageNotifier('error', '', err.error.message);
                });
              }
            } //Toggle Buttons////
            ...
            value: function sendReminderForCourse(data, index) {
              var _this39 = this;
              ...
              if (confirm('Are you sure, You want to notify?')) {
                ...
                this.apiService.sendReminder(obj).subscribe(function (res) {
                  _this39.messageNotifier('success', 'Reminder Sent', 'Notification sent successfully');
                }, function (err) {
                  //console.log(err);
                  _this39.messageNotifier('error', '', "SMS notification can't be sent due to any of the following reasons: SMS setting is not enabled for the institute. SMS quota is not sufficient for the institute. No student(s) assigned in the course to notify");
                });
              }
            }
          }, {
            key: "deleteWholeCourse",
            value: function deleteWholeCourse(data, index) {
              this.viewList.splice(index, 1);
            } // Helper Function

          }, {
            key: "validateTime",
            value: function validateTime(start, end) {
              var start_time = moment__WEBPACK_IMPORTED_MODULE_1__(this.createTimeInFormat(start.hour, start.minute, 'comp'), 'h:mma');
              var end_time = moment__WEBPACK_IMPORTED_MODULE_1__(this.createTimeInFormat(end.hour, end.minute, 'comp'), 'h:mma');
            ...
            key: "validateTime2",
            value: function validateTime2() {
              var start_time = moment__WEBPACK_IMPORTED_MODULE_1__(this.createTimeInFormat(this.newExamData.startTimeHrs, this.newExamData.startTimeMins, 'comp'), 'h:mma');
              var end_time = moment__WEBPACK_IMPORTED_MODULE_1__(this.createTimeInFormat(this.newExamData.endTimeHrs, this.newExamData.endTimeMins, 'comp'), 'h:mma');
            ...
            key: "breakTimeFormat",
            value: function breakTimeFormat(time) {
              var obj = {};
            ...
            value: function checkInstituteType() {
              ...
              this.auth.institute_type.subscribe(function (res) {
                if (res == "LANG") {
                  _this40.isLangInstitute = true;
                } else {
                  _this40.isLangInstitute = false;
                }
              });
            }
          }, {
            ...
            value: function fetchInstituteExamTypesv2() {
              ...
              this.commonApiCall.fetchInstituteExamTypes(sessionStorage.getItem("institute_id")).subscribe(function (data) {
                _this41.examTypeList = data.result;
              }, function (err) {
                _this41.msgSrvc.showErrorMessage(_this41.msgSrvc.toastTypes.error, '', err.error.message);
              });
            }
          }, {
        ...
        CourseExamComponent.ctorParameters = function () {
          return [{
        ...
        CourseExamComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          selector: 'app-course-exam',
          template: __importDefault(__webpack_require__(
          /*! raw-loader!./course-exam.component.html */
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/course-module/create-course/course-exam/course-exam.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./course-exam.component.scss */
          "./src/app/components/course-module/create-course/course-exam/course-exam.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [_services_course_services_exam_schedule_service__WEBPACK_IMPORTED_MODULE_5__["ExamCourseService"], _app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _services_authenticator_service__WEBPACK_IMPORTED_MODULE_4__["AuthenticatorService"], _services_course_services_topic_listing_service__WEBPACK_IMPORTED_MODULE_6__["TopicListingService"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"], _services_http_service__WEBPACK_IMPORTED_MODULE_7__["HttpService"], _services_common_api_call_service__WEBPACK_IMPORTED_MODULE_8__["CommonApiCallService"], _services_message_show_service__WEBPACK_IMPORTED_MODULE_9__["MessageShowService"]])], CourseExamComponent);
        return CourseExamComponent;
      }();
      ...
      /** @class */
      function () {
        var DateMonthFormat = /*#__PURE__*/function () {
          function DateMonthFormat() {
            _classCallCheck(this, DateMonthFormat);
          }

          _createClass(DateMonthFormat, [{
            key: "transform",
        ...
        DateMonthFormat = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"])({
          name: 'dateMonthYear'
        })], DateMonthFormat);
        return DateMonthFormat;
      }();
    ...
    /***/
    function srcAppComponentsCourseModuleCreateCourseCourseExamCourseExamModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CourseExamModule", function () {
      ...
      var _course_exam_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./course-exam.component */
      "./src/app/components/course-module/create-course/course-exam/course-exam.component.ts");
      /* harmony import */


      var _course_exam_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./course-exam.routing.module */
      "./src/app/components/course-module/create-course/course-exam/course-exam.routing.module.ts");
      /* harmony import */


      var _services_course_services_exam_schedule_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../../../../services/course-services/exam-schedule.service */
      "./src/app/services/course-services/exam-schedule.service.ts");
      /* harmony import */
      ...
      var _services_course_services_topic_listing_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../../../../services/course-services/topic-listing.service */
      "./src/app/services/course-services/topic-listing.service.ts");
      ...
      var CourseExamModule =
      /** @class */
      function () {
        var CourseExamModule = function CourseExamModule() {
          _classCallCheck(this, CourseExamModule);
        };

        CourseExamModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
          imports: [_progress_kendo_angular_treeview__WEBPACK_IMPORTED_MODULE_7__["TreeViewModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], // BsDatepickerModule,
          _shared_shared_module__WEBPACK_IMPORTED_MODULE_1__["SharedModule"], _course_exam_routing_module__WEBPACK_IMPORTED_MODULE_5__["CourseExamRouting"]],
          exports: [],
          declarations: [_course_exam_component__WEBPACK_IMPORTED_MODULE_4__["CourseExamComponent"], _course_exam_component__WEBPACK_IMPORTED_MODULE_4__["DateMonthFormat"]],
          providers: [_services_course_services_exam_schedule_service__WEBPACK_IMPORTED_MODULE_6__["ExamCourseService"], _services_course_services_topic_listing_service__WEBPACK_IMPORTED_MODULE_8__["TopicListingService"]]
        })], CourseExamModule);
        return CourseExamModule;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsCourseModuleCreateCourseCourseExamCourseExamRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CourseExamRouting", function () {
      ...
      var _course_exam_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./course-exam.component */
      "./src/app/components/course-module/create-course/course-exam/course-exam.component.ts");
      ...
      var CourseExamRouting =
      /** @class */
      function () {
        var CourseExamRouting = function CourseExamRouting() {
          _classCallCheck(this, CourseExamRouting);
        };

        CourseExamRouting = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
...
//# sourceMappingURL=app-components-course-module-create-course-course-exam-course-exam-module-es5.js.map