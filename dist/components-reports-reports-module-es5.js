(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-reports-reports-module"], {
    ...
    /***/
    function srcAppComponentsReportsReportsComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function srcAppComponentsReportsReportsComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _app_services_authenticator_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      var _services_enquiry_services_fetchenquiry_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      function () {
        var ReportsComponent = /*#__PURE__*/function () {
          function ReportsComponent(auth, enquire, messageService, _commService) {
            var _this = this;
          ...
          _createClass(ReportsComponent, [{
            ...
            value: function checkRoleAccess() {
              ...
              this.isShowCampaignReport = this.role_feature.REPORTS_ENQUIRY_CAMPAIGN; // Changes done by Nalini - To handle role based fee menu conditions
            ...
            key: "toggleDateSection",
            value: function toggleDateSection() {
            ...
            key: "getDateFormated",
            value: function getDateFormated(value, format) {
              if (value) {
            ...
            key: "performDownloadAction",
            value: function performDownloadAction(res) {
              ...
              var dwldLink = document.getElementById('downloadSummaryReport121');
            ...
            key: "downloadSummaryReportXl",
            value: function downloadSummaryReportXl() {
              var _this2 = this;

              var report = this.reportFor();
              ...
              switch (Number(this.downloadReportFor.downloadReportOption)) {
                ...
                case 2:
                  {
                    ...
                    this.enquire.getSummaryReportOfThisMonth(report).subscribe(function (res) {
                      _this2.auth.hideLoader();

                      _this2.performDownloadAction(res);
                    }, function (err) {
                      _this2.auth.hideLoader();
                    });
                  }
                ...
                case 3:
                  {
                    this.auth.showLoader();
                    this.enquire.getPreviousMSummary(report).subscribe(function (res) {
                      _this2.auth.hideLoader();
                ...
                case 4:
                  {
                    this.auth.showLoader();
                    this.enquire.getSummaryReportOfLastTwoMonth(report).subscribe(function (res) {
                      _this2.auth.hideLoader();
            ...
            key: "downloadSummaryReportXlDateWise",
            value: function downloadSummaryReportXlDateWise() {
              var _this3 = this;
              ...
              if (this.downloadReportFor.summaryReport.to_date != "" && this.downloadReportFor.summaryReport.from_date != "") {
                ...
                var report = this.reportFor();
                var obj = {
                  to_date: this.getDateFormated(this.downloadReportFor.summaryReport.to_date, 'YYYY-MM-DD'),
                  from_date: this.getDateFormated(this.downloadReportFor.summaryReport.from_date, 'YYYY-MM-DD')
                };
                this.enquire.getSummaryReportFromDates(obj, report).subscribe(function (res) {
                  _this3.auth.hideLoader();

                  _this3.performDownloadAction(res);
                }, function (err) {
                  _this3.auth.hideLoader();
                });
              } else {
        ...
        ReportsComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          ...
          "./src/app/components/reports/reports.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [_app_services_authenticator_service__WEBPACK_IMPORTED_MODULE_1__["AuthenticatorService"], _services_enquiry_services_fetchenquiry_service__WEBPACK_IMPORTED_MODULE_3__["FetchenquiryService"], _services_message_show_service__WEBPACK_IMPORTED_MODULE_4__["MessageShowService"], _services_common_service__WEBPACK_IMPORTED_MODULE_5__["CommonServiceFactory"]])], ReportsComponent);
        return ReportsComponent;
      }();
      /***/
    ...
    function srcAppComponentsReportsReportsModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      function () {
        ...
        ReportsModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
          declarations: [_reports_component__WEBPACK_IMPORTED_MODULE_3__["ReportsComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _reports_routing_module__WEBPACK_IMPORTED_MODULE_2__["ReportsRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], ngx_bootstrap_datepicker__WEBPACK_IMPORTED_MODULE_5__["BsDatepickerModule"]]
        })], ReportsModule);
        return ReportsModule;
      }();
      /***/
...
//# sourceMappingURL=components-reports-reports-module-es5.js.map