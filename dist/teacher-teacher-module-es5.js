(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["teacher-teacher-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsCourseModuleTeacherTeacherAddTeacherAddComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsCourseModuleTeacherTeacherEditTeacherEditComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsCourseModuleTeacherTeacherListTeacherListComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsCourseModuleTeacherTeacherViewTeacherViewComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsCourseModuleTeacherTeacherComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsCourseModuleTeacherTeacherAddTeacherAddComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsCourseModuleTeacherTeacherAddTeacherAddComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      function () {
        ...
        TeacherAddComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          ...
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/course-module/teacher/teacher-add/teacher-add.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./teacher-add.component.scss */
          "./src/app/components/course-module/teacher/teacher-add/teacher-add.component.scss"))["default"]]
    ...
    /***/
    function srcAppComponentsCourseModuleTeacherTeacherEditTeacherEditComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsCourseModuleTeacherTeacherEditTeacherEditComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _services_teacherService_teacherApi_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../../../../services/teacherService/teacherApi.service */
      "./src/app/services/teacherService/teacherApi.service.ts");
      /* harmony import */
      ...
      function () {
        var TeacherEditComponent = /*#__PURE__*/function () {
          function TeacherEditComponent(route, ApiService, fb, toastCtrl, routeParam, auth, commonService, httpService, productService) {
            var _this2 = this;
          ...
          _createClass(TeacherEditComponent, [{
            ...
            key: "fetchStandardAndSubjects",
            value: function fetchStandardAndSubjects() {
              var _this4 = this;
              ...
              this.httpService.getData('/api/v1/standards/standard-subject-list/' + sessionStorage.getItem('institute_id') + '?is_active=Y&is_subject_required=true').subscribe(function (res) {
                ...
                _this4.StandardData = res.result;

                if (_this4.selectedTeacherId) {
                  _this4.getTeacherInfo();

                  _this4.enableBiometric = sessionStorage.getItem('biometric_attendance_feature');
                }
              }, function (err) {
                _this4.auth.hideLoader();
            ...
            key: "getUploadedFileData",
            value: function getUploadedFileData() {
              var _this5 = this;

              this.auth.showLoader();
              var url = "/users-file/downloadFile?studentId=".concat(this.teacher_user_id);
              this.productService.getUploadFileData(url).subscribe(function (res) {
                _this5.uploadedFileData = res;
            ...
            value: function downloadFile(object) {
              var url = object.fileUrl;
              var hiddenDownload = document.getElementById('downloadFileClick');
              hiddenDownload.href = url;
              hiddenDownload.download = object.title; // hiddenDownload.download = this.getOriginalFileName(fileObj.res.file_name);

              hiddenDownload.click(); // this.updateDownloadCount(object);
            }
          }, {
            key: "deleteExistingUploadedfileAPI",
            value: function deleteExistingUploadedfileAPI(id) {
              var _this6 = this;

              if (confirm('Are you sure, you want to delete file?')) {
                this.auth.showLoader();
                var url = "/users-file/delete-file/?studentId=".concat(this.teacher_user_id, "&id=").concat(id);
                this.productService.deleteFile(url).subscribe(function (res) {
                  _this6.messageToast("success", '', "File deleted successfully");

                  if (res) {
                    _this6.getUploadedFileData();
                  }
            ...
            key: "getSubjects",
            value: function getSubjects(event) {
              var _this7 = this;
              ...
              if (event) {
                ...
                var object = event.filter(function (subject) {
                  var arr = _this7.StandardData.filter(function (obj) {
                    return subject.standard_id == obj.standard_id;
                  });

                  if (arr.length) {
                    arr[0].subject_list.forEach(function (ele) {
                      ele.standard_id = arr[0].standard_id;

                      _this7.subjectData.push(ele); // Added by - Nalini Walunj
                      ...
                      for (var i = 0; i < _this7.subjectData.length; i++) {
                        for (var j = 0; j < _this7.assigned_standard_subject_list.length; j++) {
                          if (_this7.subjectData[i].subject_id == _this7.assigned_standard_subject_list[j].subject_id) {
                            var x = {
                              subject_id: '',
                              subject_name: ''
                            };
                            x.subject_id = _this7.assigned_standard_subject_list[j].subject_id;
                            x.subject_name = _this7.assigned_standard_subject_list[j].subject_name;
                            temp.push(x);
                          }
                        }
                      }

                      _this7.editTeacherForm.patchValue({
            ...
            key: "isOnlineExamAllow",
            value: function isOnlineExamAllow(type) {
            ...
            value: function getTeacherInfo() {
              ...
              this.ApiService.getSelectedTeacherInfo(this.selectedTeacherId).subscribe(function (data) {
                ...
                _this8.selectedTeacherInfo = data;

                var setFormData = _this8.getFormFieldsdata(data);

                _this8.editTeacherForm.setValue(setFormData);

                _this8.studentImage = data.photo;

                _this8.setServerImg();

                _this8.hasIdCard = data.hasIDCard;
                _this8.teacher_user_id = data.user_id;

                _this8.getUploadedFileData();
              }, function (error) {
                _this8.auth.hideLoader();
            ...
            key: "setServerImg",
            value: function setServerImg() {
              if (this.studentImage === '' || this.studentImage === null) {} else {
                this.imgFile = "";
                var temp = [];
              ...
              if (this.editTeacherForm.value.title != '') {
                ...
                if (preview != null || preview != undefined) {
                  ...
                  myReader.onloadend = function () {
                    temp = {
                      "title": _this9.editTeacherForm.value.title,
                      "fileName": preview.name,
                      "encodedFile": myReader.result.split(',')[1]
                    };

                    _this9.selectedFiles.push(temp);

                    _this9.messageToast('success', '', "File uploaded successfully");

                    _this9.editTeacherForm.value.title = '';

                    _this9.editTeacherForm.patchValue({
                      title: ''
                    });
            ...
            key: "deletefile",
            value: function deletefile(obj, id) {
              if (confirm('Are you sure, you want to delete file?')) {
            ...
            value: function getFormFieldsdata(data) {
              ...
              dataToBind.country_id = data.country_id; // dataToBind.dob = '1998-2-2';
              ...
              if (data.assigned_standard_subject_list && data.assigned_standard_subject_list.length) {
                data.assigned_standard_subject_list.forEach(function (element) {
                  var x = {
                    standard_id: '',
                    standard_name: ''
                  };
            ...
            key: "getSelectedStandardAndSub",
            value: function getSelectedStandardAndSub(obj) {
              var _this10 = this;

              if (obj.selectedSubjectList && obj.selectedSubjectList.length) {
                obj.selectedSubjectList.forEach(function (element) {
                  _this10.subjectData.forEach(function (ele) {
              ...
              if (obj.selectedStandardList && obj.selectedStandardList.length) {
                obj.selectedStandardList.filter(function (temp) {
                  _this10.StandardData.forEach(function (ele) {
            ...
            value: function addNewTeacherInfo() {
              ...
              formData.date_of_joining = formData.date_of_joining != null && formData.date_of_joining != '' ? moment__WEBPACK_IMPORTED_MODULE_3__(formData.date_of_joining).format('YYYY-MM-DD') : ''; // formData.is_office_only_access = formData.is_office_only_access ? 'Y' : 'N';
              ...
              this.ApiService.addNewTeacherDetails(formData).subscribe(function (data) {
                ...
                _this11.messageToast('success', '', 'Teacher added successfully.');

                _this11.route.navigateByUrl('/view/course/teacher');
              }, function (err) {
                _this11.auth.hideLoader();

                _this11.messageToast('error', '', err.error.message);
              });
            }
          }, {
            key: "addOrEditFun",
            ...
            value: function saveTeacherInfo() {
              ...
              formData.allow_exam_desk_login = formData.allow_exam_desk_login == true ? "Y" : "N";
              formData.is_allow_teacher_to_only_mark_attendance = formData.is_allow_teacher_to_only_mark_attendance == true ? 'Y' : 'N';
              formData.is_office_only_access = formData.is_office_only_access ? 'Y' : 'N'; //this section is to handle id card
              ...
              this.ApiService.saveEditTeacherInformation(this.selectedTeacherInfo.teacher_id, formData).subscribe(function (data) {
                ...
                _this12.messageToast('success', '', 'Details updated successfully.');

                if (sessionStorage.getItem('userType') == '3') {
                  _this12.route.navigateByUrl('/view/dashboard/admin');
                } else {
                  _this12.route.navigateByUrl('/view/course/teacher');
                }
              }, function (err) {
                _this12.auth.hideLoader();

                _this12.messageToast('error', '', err.error.message);
              });
            }
          }, {
            ...
            value: function downloadIdCard() {
              ...
              this.ApiService.downloadDocument(this.selectedTeacherId).subscribe(function (res) {
                _this13.auth.hideLoader(); // this.idCardImg.nativeElement.src = 'data:image/png;base64,' + res.document;


                _this13.anchTag.nativeElement.href = 'data:image/png;base64,' + res.document;
                _this13.anchTag.nativeElement.download = res.docTitle;

                _this13.anchTag.nativeElement.click();
              }, function (err) {
                _this13.auth.hideLoader();

                _this13.messageToast('error', '', err.error.message);
              });
            }
          }, {
            key: "messageToast",
            ...
            value: function readFile(file) {
              ...
              if (file) {
                ...
                reader.onloadend = function () {
                  _this14.setImage(reader.result.split(',')[1]);
        ...
        TeacherEditComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          ...
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/course-module/teacher/teacher-edit/teacher-edit.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./teacher-edit.component.scss */
          "./src/app/components/course-module/teacher/teacher-edit/teacher-edit.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _services_teacherService_teacherApi_service__WEBPACK_IMPORTED_MODULE_7__["TeacherAPIService"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _app_component__WEBPACK_IMPORTED_MODULE_6__["AppComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], ___WEBPACK_IMPORTED_MODULE_5__["AuthenticatorService"], ___WEBPACK_IMPORTED_MODULE_5__["CommonServiceFactory"], _services_http_service__WEBPACK_IMPORTED_MODULE_4__["HttpService"], _services_products_service__WEBPACK_IMPORTED_MODULE_8__["ProductService"]])], TeacherEditComponent);
        return TeacherEditComponent;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsCourseModuleTeacherTeacherListTeacherListComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsCourseModuleTeacherTeacherListTeacherListComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _services_teacherService_teacherApi_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../../../../services/teacherService/teacherApi.service */
      "./src/app/services/teacherService/teacherApi.service.ts");
      ...
      function () {
          ...
          _createClass(TeacherListComponent, [{
            ...
            value: function getDataFromServer() {
              ...
              this.ApiService.getAllTeacherList().subscribe(function (data) {
                _this16.dataStatus = 2;

                _this16.auth.hideLoader();

                _this16.totalRow = data.length;
                _this16.teacherListDataSource = data;

                for (var i = 0; i < _this16.teacherListDataSource.length; i++) {
                  _this16.teacherListDataSource[i].teacher_user_id = i + 1;

                  if (_this16.teacherListDataSource[i].date_of_joining != "") {
                    _this16.teacherListDataSource[i].date_of_joining = moment__WEBPACK_IMPORTED_MODULE_2__(_this16.teacherListDataSource[i].date_of_joining).format('DD-MM-YYYY');
                  }
                }

                _this16.fetchTableDataByPage(_this16.PageIndex);
              }, function (error) {
                _this16.dataStatus = 2;
                ...
                _this16.toastCtrl.popToast(data);
              });
            }
          }, {
            ...
            value: function deleteTeacherDeatils(row) {
              ...
              if (confirm("Are you sure, you want to delete this teacher?")) {
                this.ApiService.deleteTeacher(row.teacher_id).subscribe(function (res) {
                  ...
                  _this17.toastCtrl.popToast(data);

                  _this17.getDataFromServer();
                }, function (err) {
                  //console.log(err);
                  var data = {
                    type: "error",
              ...
              if (this.searchValue != "" && this.searchValue != null) {
                var searchData = this.teacherListDataSource.filter(function (item) {
                  return Object.keys(item).some(function (k) {
                    return item[k] != null && item[k].toString().toLowerCase().includes(_this18.searchValue.toLowerCase());
                  });
                });
        ...
        TeacherListComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          ...
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/course-module/teacher/teacher-list/teacher-list.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./teacher-list.component.scss */
          "./src/app/components/course-module/teacher/teacher-list/teacher-list.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [_services_teacherService_teacherApi_service__WEBPACK_IMPORTED_MODULE_5__["TeacherAPIService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _services_authenticator_service__WEBPACK_IMPORTED_MODULE_4__["AuthenticatorService"]])], TeacherListComponent);
        return TeacherListComponent;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsCourseModuleTeacherTeacherRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsCourseModuleTeacherTeacherViewTeacherViewComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsCourseModuleTeacherTeacherViewTeacherViewComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      function () {
        var TeacherViewComponent = /*#__PURE__*/function () {
          function TeacherViewComponent(route, ApiService, toastCtrl, routeParam) {
            ...
            this.routeParam.params.subscribe(function (params) {
              _this19.selectedTeacherId = params['id']; // console.log(this.selectedTeacherId);
            });
          }
          ...
          _createClass(TeacherViewComponent, [{
            ...
            value: function getTeacherViewInfo() {
              ...
              this.ApiService.getViewInfoOfTeacher(this.selectedTeacherId).subscribe(function (data) {
                _this20.studentImage = data.photo;
                _this20.selectedTeacherInformation = data;
            ...
            value: function getInfoFromDashBoard(data) {
              ...
              this.ApiService.customizedTeacherSearchOnDashBoardView(data, this.selectedTeacherId).subscribe(function (data) {
                _this22.assignedBatchList = data;
                _this22.totalClassesTaken = _this22.getPerticularKeyValue(data, "total_teacher_classes", '');
                _this22.totalHourSpent = _this22.getPerticularKeyValue(data, 'total_hours', ' ');
              }, function (error) {//console.log(error)
              });
            }
          }, {
            ...
            value: function getInfoFromGuest(data) {
              ...
              this.ApiService.customizedTeacherSearchOnGuestBatchView(data, this.selectedTeacherId).subscribe(function (data) {
                _this23.visitingBatchList = data;
                _this23.visitingTotalClasses = _this23.getPerticularKeyValue(data, "total_teacher_classes", '');
                _this23.visitingTotalHour = _this23.getPerticularKeyValue(data, 'total_hours', ' ');
              }, function (error) {
                _this23.messageNotifier('error', '', error.error.message); //console.log(error)
            ...
            value: function getBatchDetailsInfo(row) {
              ...
              this.ApiService.viewBatchDetails(data, this.selectedTeacherId).subscribe(function (data) {
                _this24.teacherTakenClasses = data; //console.log(data);
              }, function (error) {//console.log(error);
              });
            }
          }, {
            ...
            value: function viewDetailOfVisitingBatch(row, i) {
              ...
              data.to_date = "";
              this.ApiService.viewBatchDetails(data, this.selectedTeacherId).subscribe(function (data) {
                _this25.guestBatchList = data; //console.log(data);
              }, function (error) {//console.log(error);
              });
            }
          }, {
        ...
        TeacherViewComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          ...
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/course-module/teacher/teacher-view/teacher-view.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./teacher-view.component.scss */
          "./src/app/components/course-module/teacher/teacher-view/teacher-view.component.scss"))["default"]]
    ...
    /***/
    function srcAppComponentsCourseModuleTeacherTeacherComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsCourseModuleTeacherTeacherComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      function () {
        ...
        TeacherComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          ...
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/course-module/teacher/teacher.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./teacher.component.scss */
          "./src/app/components/course-module/teacher/teacher.component.scss"))["default"]]
    ...
    /***/
    function srcAppComponentsCourseModuleTeacherTeacherModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      function () {
        ...
        TeacherModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
          ...
          _shared_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], _teacher_routing_module__WEBPACK_IMPORTED_MODULE_3__["TeacherRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], ng_multiselect_dropdown__WEBPACK_IMPORTED_MODULE_10__["NgMultiSelectDropDownModule"].forRoot()],
