...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AssetAssignmentComponent", function() { return AssetAssignmentComponent; });
...
/* harmony import */ var _services_user_management_role_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../services/user-management/role.service */ "./src/app/services/user-management/role.service.ts");
...
/* harmony import */ var _services_export_to_pdf_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../services/export-to-pdf.service */ "./src/app/services/export-to-pdf.service.ts");
...
let AssetAssignmentComponent = /** @class */ (() => {
    let AssetAssignmentComponent = class AssetAssignmentComponent {
        constructor(httpService, auth, router, msgService, temp, apiService, _pdfService, excelService) {
        ...
        getAssignDetails() {
            ...
            this.httpService.getMethod('api/v2/asset/assignment/all?pageOffset=' + this.pageIndex + '&pageSize=' + this.displayBatchSize + '&instituteId=' + this.model.institute_id, null).subscribe((res) => {
        ...
        deleteRow(obj) {
            ...
            this.auth.showLoader();
            this.httpService.deleteMethod('/api/v2/asset/assignment/delete/' + obj + '?instituteId=' + this.model.institute_id).then((res) => {
                this.auth.hideLoader();
        ...
        searchDatabase() {
            if (this.searchParams == undefined || this.searchParams == null) {
                ...
                this.auth.showLoader();
                this.httpService.getMethod('api/v2/asset/assignment/search?searchString=' + this.searchParams + '&instituteId=' + this.model.institute_id, null).subscribe((res) => {
                    this.assignedAssetAllData = res.result.response;
                    this.staticPageData = res.result.response;
                    this.tempLocationList = res.result.response;
                    this.totalRecords = res.result.total_elements;
        ...
        getCategoryDetails() {
            this.httpService.getMethod('api/v2/asset/category/all?all=1&instituteId=' + this.model.institute_id, null).subscribe((res) => {
        ...
        getassetsAndLocation(category_id) {
            if (this.model.category_id != '') {
                ...
                this.httpService.getMethod('api/v2/asset/getAssetsWithCategoryName?categoryIdList=' + category_id + '&instituteId=' + this.model.institute_id, null).subscribe((res) => {
        ...
        //
        getAssetDetails() {
            this.httpService.getMethod('api/v2/asset/all?all=1&instituteId=' + this.model.institute_id, null).subscribe((res) => {
            }, err => {
                this.auth.hideLoader();
            });
        }
        getCheckOutBy(obj) {
            ...
            if (this.role_id != undefined) {
                this.temp.getData('/api/v1/inventory/sale/' + this.model.institute_id + '/getUserByRole?roleIds=' + this.role_id).subscribe((res) => {
        ...
        getRolesList() {
            this.purchaseby = [];
            this.temp.getData('/api/v1/roleApi/allRoles/' + this.model.institute_id).subscribe((res) => {
        ...
        downloadPdf() {
            this.httpService.getMethod('api/v2/asset/assignment/all?all=1&instituteId=' + this.model.institute_id, null).subscribe((res) => {
    ...
    AssetAssignmentComponent.ctorParameters = () => [
    ...
    AssetAssignmentComponent.propDecorators = {
        assetAssignmentForm: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"], args: ['assetAssignmentForm', { static: false },] }]
    };
    AssetAssignmentComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-asset-assignment',
            template: __importDefault(__webpack_require__(/*! raw-loader!./asset-assignment.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/asset-management/asset-assignment/asset-assignment.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./asset-assignment.component.scss */ "./src/app/components/asset-management/asset-assignment/asset-assignment.component.scss")).default]
        }),
        __metadata("design:paramtypes", [_services_products_service__WEBPACK_IMPORTED_MODULE_3__["ProductService"],
            ...
            _services_user_management_role_service__WEBPACK_IMPORTED_MODULE_8__["RoleService"],
            _services_export_to_pdf_service__WEBPACK_IMPORTED_MODULE_10__["ExportToPdfService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AssetManagementRoutingModule", function() { return AssetManagementRoutingModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _asset_assignment_asset_assignment_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./asset-assignment/asset-assignment.component */ "./src/app/components/asset-management/asset-assignment/asset-assignment.component.ts");
/* harmony import */ var _asset_purchase_asset_purchase_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./asset-purchase/asset-purchase.component */ "./src/app/components/asset-management/asset-purchase/asset-purchase.component.ts");
/* harmony import */ var _category_category_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./category/category.component */ "./src/app/components/asset-management/category/category.component.ts");
/* harmony import */ var _location_location_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./location/location.component */ "./src/app/components/asset-management/location/location.component.ts");
/* harmony import */ var _supplier_master_supplier_master_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./supplier-master/supplier-master.component */ "./src/app/components/asset-management/supplier-master/supplier-master.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let AssetManagementRoutingModule = /** @class */ (() => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AssetManagementComponent", function() { return AssetManagementComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
let AssetManagementComponent = /** @class */ (() => {
    let AssetManagementComponent = class AssetManagementComponent {
        constructor() { }
        ngOnInit() {
        }
    };
    AssetManagementComponent.ctorParameters = () => [];
    AssetManagementComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-asset-management',
            template: __importDefault(__webpack_require__(/*! raw-loader!./asset-management.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/asset-management/asset-management.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./asset-management.component.scss */ "./src/app/components/asset-management/asset-management.component.scss")).default]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AssetManagementModule", function() { return AssetManagementModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _asset_management_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./asset-management-routing.module */ "./src/app/components/asset-management/asset-management-routing.module.ts");
/* harmony import */ var _asset_management_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./asset-management.component */ "./src/app/components/asset-management/asset-management.component.ts");
/* harmony import */ var _supplier_master_supplier_master_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./supplier-master/supplier-master.component */ "./src/app/components/asset-management/supplier-master/supplier-master.component.ts");
/* harmony import */ var _location_location_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./location/location.component */ "./src/app/components/asset-management/location/location.component.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _category_category_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./category/category.component */ "./src/app/components/asset-management/category/category.component.ts");
/* harmony import */ var _asset_assignment_asset_assignment_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./asset-assignment/asset-assignment.component */ "./src/app/components/asset-management/asset-assignment/asset-assignment.component.ts");
/* harmony import */ var _asset_purchase_asset_purchase_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./asset-purchase/asset-purchase.component */ "./src/app/components/asset-management/asset-purchase/asset-purchase.component.ts");
...
/* harmony import */ var _services_user_management_role_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../.././services/user-management/role.service */ "./src/app/services/user-management/role.service.ts");
/* harmony import */ var _services_export_to_pdf_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../services/export-to-pdf.service */ "./src/app/services/export-to-pdf.service.ts");
...
let AssetManagementModule = /** @class */ (() => {
    let AssetManagementModule = class AssetManagementModule {
    };
    AssetManagementModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_asset_management_component__WEBPACK_IMPORTED_MODULE_3__["AssetManagementComponent"],
                _supplier_master_supplier_master_component__WEBPACK_IMPORTED_MODULE_4__["SupplierMasterComponent"],
                ...
                _asset_assignment_asset_assignment_component__WEBPACK_IMPORTED_MODULE_8__["AssetAssignmentComponent"],
                _asset_purchase_asset_purchase_component__WEBPACK_IMPORTED_MODULE_9__["AssetPurchaseComponent"],
            ],
            imports: [
                _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
                _asset_management_routing_module__WEBPACK_IMPORTED_MODULE_2__["AssetManagementRoutingModule"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AssetPurchaseComponent", function() { return AssetPurchaseComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
...
/* harmony import */ var _services_export_to_pdf_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../services/export-to-pdf.service */ "./src/app/services/export-to-pdf.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let AssetPurchaseComponent = /** @class */ (() => {
    let AssetPurchaseComponent = class AssetPurchaseComponent {
        constructor(httpService, auth, router, msgService, temp, _pdfService, excelService) {
            this.httpService = httpService;
            this.auth = auth;
            this.router = router;
            this.msgService = msgService;
        ...
        getPurchaseDetails() {
            this.auth.showLoader();
            this.httpService.getMethod('api/v2/asset/purchase/all?pageOffset=' + this.pageIndex + '&pageSize=' + this.displayBatchSize + '&instituteId=' + this.model.institute_id, null).subscribe((res) => {
        ...
        deleteRow(obj) {
            this.auth.showLoader();
            this.httpService.deleteMethod('/api/v2/asset/purchase/delete/' + obj + '?instituteId=' + this.model.institute_id).then((res) => {
                this.auth.hideLoader();
                this.msgService.showErrorMessage('success', '', 'Deleted Successfully');
                this.getPurchaseDetails();
                $('#deletesModal').modal('hide');
        ...
        searchDatabase() {
            if (this.searchParams == undefined || this.searchParams == null) {
                ...
                this.httpService.getMethod('api/v2/asset/purchase/search?searchString=' + this.searchParams + '&instituteId=' + this.model.institute_id, null).subscribe((res) => {
                    this.purchaseAllData = res.result.response;
                    this.staticPageData = res.result.response;
                    this.totalRecords = res.result.total_elements;
                    this.tempLocationList = res.result.response;
        ...
        getVendorDetails() {
            this.httpService.getMethod('api/v2/asset/supplier/all?all=1&instituteId=' + this.model.institute_id, null).subscribe((res) => {
        ...
        getCategoryData(obj) {
            this.categorydata = [];
            this.httpService.getMethod('api/v2/asset/supplier/assetsBySupplier/' + this.model.institute_id + '/' + obj, null).subscribe((res) => {
        ...
        //
        get_purchase_by() {
            this.temp.getData('/api/v1/profiles/' + this.model.institute_id + '/user-by-type?type=3,0,9').subscribe((res) => {
        ...
        downloadPdf() {
            this.httpService.getMethod('api/v2/asset/purchase/all?all=1&instituteId=' + this.model.institute_id, null).subscribe((res) => {
                ...
                let arr = [];
                this.purchaseDataforDownload.map((ele) => {
                    let json = [
                        // ele.id,
                        ele.asset_name,
                        ele.quantity,
        ...
        exportToExcel() {
            this.httpService.getMethod('api/v2/asset/purchase/all?all=1&instituteId=' + this.model.institute_id, null).subscribe((res) => {
                ...
                this.excelService.exportAsExcelFile(Excelarr, 'asset_Purchase');
                this.auth.hideLoader();
            }, err => {
                this.auth.hideLoader();
            });
    ...
    AssetPurchaseComponent.ctorParameters = () => [
    ...
    AssetPurchaseComponent.propDecorators = {
        assePurchaseForm: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"], args: ['assePurchaseForm', { static: false },] }]
    };
    AssetPurchaseComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-asset-purchase',
            template: __importDefault(__webpack_require__(/*! raw-loader!./asset-purchase.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/asset-management/asset-purchase/asset-purchase.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./asset-purchase.component.scss */ "./src/app/components/asset-management/asset-purchase/asset-purchase.component.scss")).default]
        }),
        __metadata("design:paramtypes", [_services_products_service__WEBPACK_IMPORTED_MODULE_4__["ProductService"],
            ...
            _services_export_to_pdf_service__WEBPACK_IMPORTED_MODULE_9__["ExportToPdfService"],
...
let CategoryComponent = /** @class */ (() => {
    let CategoryComponent = class CategoryComponent {
        ...
        getCategoryDetails() {
            this.auth.showLoader();
            this.httpService.getMethod('api/v2/asset/category/all?all=1&instituteId=' + this.category_model.institute_id, null).subscribe((res) => {
                this.assetcategoryData = res.result.response;
                this.staticPageData = res.result.response;
                this.totalRecords = res.result.total_elements;
        ...
        deleteRow(object) {
            this.httpService.deleteMethod('api/v2/asset/category/delete/' + object + '?instituteId=' + this.category_model.institute_id).then((res) => {
                this.auth.hideLoader();
                this.msgService.showErrorMessage('success', '', 'Deleted Successfully');
                this.getCategoryDetails();
                $('#deletesModal').modal('hide');
        ...
        getLocationDetails() {
            this.auth.showLoader();
            this.httpService.getMethod('api/v2/asset/location/all?all=1&instituteId=' + this.institute_id, null).subscribe((res) => {
                this.auth.hideLoader();
        ...
        saveAssetDetails() {
            if (this.assetaddForm.valid) {
                ...
                let newasset = [];
                let location_ids = obj.location_ids;
        ...
        getAssetDetails() {
            this.auth.showLoader();
            this.httpService.getMethod('api/v2/asset/all?pageOffset=' + this.pageIndex + '&pageSize=' + this.displayBatchSize + '&instituteId=' + this.model.institute_id, null).subscribe((res) => {
        ...
        deleteAssetRow(object) {
            this.httpService.deleteMethod('api/v2/asset/delete/' + object + '?instituteId=' + this.model.institute_id).then((res) => {
                this.auth.hideLoader();
                this.msgService.showErrorMessage('success', '', 'Deleted Successfully');
                this.getAssetDetails();
        ...
        searchDatabase() {
            ...
            if (this.searchParams == undefined || this.searchParams == null) {
                ...
                this.auth.showLoader();
                this.httpService.getMethod('api/v2/asset/search?searchString=' + this.searchParams + '&instituteId=' + this.model.institute_id, null).subscribe((res) => {
                    this.assetAllData = res.result.response;
                    this.staticPageData = res.result.response;
                    this.tempLocationList = res.result.response;
                    this.totalRecords = res.result.total_elements;
        ...
        exportToExcel() {
            this.httpService.getMethod('api/v2/asset/category/all?all=1&instituteId=' + this.category_model.institute_id, null).subscribe((res) => {
                ...
                let Excelarr = [];
                this.catDataToDownload.map((ele) => {
                    let json = {};
                ...
                this.excelService.exportAsExcelFile(Excelarr, 'asset_category');
                this.auth.hideLoader();
            }, err => {
                this.auth.hideLoader();
            });
        ...
        assetExportToExcel() {
            ...
            this.httpService.getMethod('api/v2/asset/all?all=1&instituteId=' + this.model.institute_id, null).subscribe((res) => {
                ...
                let Excelarr = [];
                this.assetDataToDownload.map((ele) => {
                    let json = {};
                ...
                this.excelService.exportAsExcelFile(Excelarr, 'asset_data');
                this.auth.hideLoader();
            }, err => {
                this.auth.hideLoader();
            });
    ...
    CategoryComponent.propDecorators = {
        assetcat: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"], args: ['assetcat', { static: false },] }],
        assetaddForm: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"], args: ['assetaddForm', { static: false },] }]
    };
    CategoryComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-category',
            template: __importDefault(__webpack_require__(/*! raw-loader!./category.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/asset-management/category/category.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./category.component.scss */ "./src/app/components/asset-management/category/category.component.scss")).default]
        }),
        __metadata("design:paramtypes", [_services_products_service__WEBPACK_IMPORTED_MODULE_3__["ProductService"],
...
/* harmony import */ var _services_authenticator_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../services/authenticator.service */ "./src/app/services/authenticator.service.ts");
/* harmony import */ var _services_products_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../services/products.service */ "./src/app/services/products.service.ts");
/* harmony import */ var _location__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./location */ "./src/app/components/asset-management/location/location.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
...
let LocationComponent = /** @class */ (() => {
    let LocationComponent = class LocationComponent {
        constructor(httpService, auth, router, msgService, currentRout, _pdfService, excelService, toastCtrl) {
            this.httpService = httpService;
            this.auth = auth;
            this.router = router;
            this.msgService = msgService;
        ...
        saveLocationDetails() {
            if (this.locationaddForm.valid) {
                ...
                obj.active = true;
                this.httpService.postMethod('api/v2/asset/location/create', obj).then((res) => {
                    this.submitted = true;
        ...
        getLocationDetails() {
            this.auth.showLoader();
            this.httpService.getMethod('api/v2/asset/location/all?pageOffset=' + this.pageIndex + '&pageSize=' + this.displayBatchSize + '&instituteId=' + this.model.institute_id, null).subscribe((res) => {
                this.staticPageData = res.result.response;
                this.tempLocationList = res.result.response;
                this.totalRecords = res.result.total_elements;
                this.auth.hideLoader();
        ...
        deleteRow(obj) {
            this.httpService.deleteMethod('api/v2/asset/location/delete/' + obj + '?instituteId=' + this.model.institute_id).then((res) => {
                this.auth.hideLoader();
                this.msgService.showErrorMessage('success', '', 'Deleted Successfully');
                $('#deletesModal').modal('hide');
                this.getLocationDetails();
        ...
        searchDatabase() {
            if (this.searchParams == undefined || this.searchParams == null) {
                ...
                this.auth.showLoader();
                this.httpService.getMethod('api/v2/asset/location/search?searchString=' + this.searchParams + '&instituteId=' + this.model.institute_id, null).subscribe((res) => {
                    this.staticPageData = res.result.response;
                    this.tempLocationList = res.result.response;
                    this.totalRecords = res.result.total_elements;
                    this.auth.hideLoader();
        ...
        //download pdf
        downloadPdf() {
            this.httpService.getMethod('api/v2/asset/location/all?all=1&instituteId=' + this.model.institute_id, null).subscribe((res) => {
                ...
                let arr = [];
                this.locationDataforDownload.map((ele) => {
                    let json = [
                        // ele.id,
                        ele.location_code,
                        ele.location_name,
        ...
        exportToExcel() {
            this.httpService.getMethod('api/v2/asset/location/all?all=1&instituteId=' + this.model.institute_id, null).subscribe((res) => {
                ...
                this.excelService.exportAsExcelFile(Excelarr, 'asset_location');
                this.auth.hideLoader();
            }, err => {
                this.auth.hideLoader();
            });
    ...
    LocationComponent.propDecorators = {
        locationaddForm: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"], args: ['locationaddForm', { static: false },] }]
    };
    LocationComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-location',
            template: __importDefault(__webpack_require__(/*! raw-loader!./location.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/asset-management/location/location.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./location.component.scss */ "./src/app/components/asset-management/location/location.component.scss")).default]
        }),
        __metadata("design:paramtypes", [_services_products_service__WEBPACK_IMPORTED_MODULE_4__["ProductService"],
            _services_authenticator_service__WEBPACK_IMPORTED_MODULE_3__["AuthenticatorService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"],
...
let SupplierMasterComponent = /** @class */ (() => {
    let SupplierMasterComponent = class SupplierMasterComponent {
        ...
        saveVendorDetails() {
            if (this.addVendorForm.valid) {
                ...
                //for cat
                let newcat = [];
                let category_ids = this.model.category_ids;
                ...
                this.httpService.postMethod('api/v2/asset/supplier/create ', obj).then((res) => {
        ...
        getAssetsForSelectedCat(object) {
            ...
            if (categoryselectedid === undefined) {
                ...
                this.httpService.getMethod('api/v2/asset/getAssetsWithCategoryName?categoryIdList=' + categoryselectedid + '&instituteId=' + this.model.institute_id, null).subscribe((res) => {
                    let result = res.result;
                    let keys = Object.keys(result);
                    let temp = [];
                    for (let i = 0; i < keys.length; i++) {
        ...
        getVendorDetails() {
            this.auth.showLoader();
            this.httpService.getMethod('api/v2/asset/supplier/all?pageOffset=' + this.pageIndex + '&pageSize=' + this.displayBatchSize + '&instituteId=' + this.model.institute_id, null).subscribe((res) => {
                this.staticPageData = res.result.response;
                this.tempLocationList = res.result.response;
                this.totalRecords = res.result.total_elements;
                this.auth.hideLoader();
        ...
        updateVendorDetails() {
            if (this.addVendorForm.valid) {
                ...
                //for cat
                let newcat = [];
                let category_ids = obj.category_ids;
                for (let data in category_ids) {
                    newcat.push(category_ids[data].id);
                }
                obj.category_ids = newcat;
        ...
        deleteRow(obj) {
            this.httpService.deleteMethod('api/v2/asset/supplier/delete/' + obj + '?instituteId=' + this.model.institute_id).then((res) => {
                this.auth.hideLoader();
                this.msgService.showErrorMessage('success', '', 'Deleted Successfully');
                this.getVendorDetails();
                $('#deletesModal').modal('hide');
        ...
        searchDatabase() {
            ...
            if (this.searchParams == undefined || this.searchParams == null) {
                ...
                this.auth.showLoader();
                this.httpService.getMethod('api/v2/asset/supplier/search?searchString=' + this.searchParams + '&instituteId=' + this.model.institute_id, null).subscribe((res) => {
                    this.assetAllData = res.result.response;
                    this.staticPageData = res.result.response;
                    this.tempLocationList = res.result.response;
                    this.totalRecords = res.result.total_elements;
        ...
        downloadPdf() {
            this.httpService.getMethod('api/v2/asset/supplier/all?all=1&instituteId=' + this.model.institute_id, null).subscribe((res) => {
                ...
                let arr = [];
                this.supplierDataforDownload.map((ele) => {
                    let json = [
                        // ele.id,
                        ele.supplier_name,
                        ele.email_id,
        ...
        exportToExcel() {
            this.httpService.getMethod('api/v2/asset/supplier/all?all=1&instituteId=' + this.model.institute_id, null).subscribe((res) => {
                ...
                this.excelService.exportAsExcelFile(Excelarr, 'asset_Supplier');
                this.auth.hideLoader();
            }, err => {
                this.auth.hideLoader();
            });
    ...
    SupplierMasterComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __importDefault(__webpack_require__(/*! raw-loader!./supplier-master.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/asset-management/supplier-master/supplier-master.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./supplier-master.component.scss */ "./src/app/components/asset-management/supplier-master/supplier-master.component.scss")).default]
        }),
        __metadata("design:paramtypes", [_services_products_service__WEBPACK_IMPORTED_MODULE_3__["ProductService"],
            _services_authenticator_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticatorService"],
            _services_message_show_service__WEBPACK_IMPORTED_MODULE_1__["MessageShowService"],
...
//# sourceMappingURL=components-asset-management-asset-management-module-es2015.js.map