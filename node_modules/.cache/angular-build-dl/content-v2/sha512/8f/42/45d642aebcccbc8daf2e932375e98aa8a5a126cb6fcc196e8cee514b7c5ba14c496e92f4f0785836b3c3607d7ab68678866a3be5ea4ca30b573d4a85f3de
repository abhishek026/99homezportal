(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-course-module-online-assignment-online-assignment-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsCourseModuleOnlineAssignmentListAssignmentListAssignmentComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsCourseModuleOnlineAssignmentManageAssignmentManageAssignmentComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsCourseModuleOnlineAssignmentOnlineAssignmentComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsCourseModuleOnlineAssignmentReviewAssignmentReviewAssignmentComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsCourseModuleOnlineAssignmentListAssignmentListAssignmentComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsCourseModuleOnlineAssignmentListAssignmentListAssignmentComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ListAssignmentComponent", function () {
      ...
      var ListAssignmentComponent =
      /** @class */
      function () {
        var ListAssignmentComponent = /*#__PURE__*/function () {
          function ListAssignmentComponent(msgService, httpService, router, auth) {
            var _this = this;

            _classCallCheck(this, ListAssignmentComponent);
            ...
            this.endDate = moment__WEBPACK_IMPORTED_MODULE_5__(new Date()).format("YYYY-MM-DD"); // FOR PAGINATION
          ...
          _createClass(ListAssignmentComponent, [{
            key: "ngOnInit",
            ...
            value: function getAllAssignment(obj) {
              var _this2 = this;

              this.auth.showLoader();
              var url = "/api/v2/onlineAssignment/getAssignmentsDetail";
              this.httpService.postData(url, obj).subscribe(function (res) {
                _this2.auth.hideLoader();

                if (res.statusCode >= 200 && res.statusCode < 300) {
                  _this2.assignmentList = res.result;
                  _this2.tempAssignmnetList = res.result;
                  _this2.allData = res.result;
                  _this2.totalCount = _this2.allData.length;
                  _this2.pageIndex = 1;

                  _this2.fectchTableDataByPage(_this2.pageIndex);
                } else {
                  _this2.msgService.showErrorMessage(_this2.msgService.toastTypes.error, '', res.message);
                }
              }, function (err) {
                _this2.auth.hideLoader();
            ...
            value: function searchDatabase() {
              ...
              if (this.searchText == undefined || this.searchText == null) {
                ...
                var searchData = this.tempAssignmnetList.filter(function (item) {
            ...
            value: function deleteAssignment(file_id) {
              ...
              if (prompt) {
                this.auth.showLoader();
                var obj = {};
                var url = "/api/v2/onlineAssignment/delete/".concat(this.jsonFlag.institute_id, "/").concat(file_id);
                this.httpService.deleteData(url, obj).subscribe(function (res) {
                  if (res.statusCode >= "200" && res.statusCode < "300") {
                    _this4.msgService.showErrorMessage('success', '', 'Assignment deleted successfully');

                    _this4.getAssignmentList();

                    _this4.router.navigate(['/view/course/online-assignment']);
                  } else {
                    _this4.msgService.showErrorMessage('error', '', res.message);
                  }
        ...
        ListAssignmentComponent.ctorParameters = function () {
          return [{
        ...
        ListAssignmentComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          selector: 'app-list-assignment',
          template: __importDefault(__webpack_require__(
          /*! raw-loader!./list-assignment.component.html */
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/course-module/online-assignment/list-assignment/list-assignment.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./list-assignment.component.scss */
          "./src/app/components/course-module/online-assignment/list-assignment/list-assignment.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [_services_message_show_service__WEBPACK_IMPORTED_MODULE_4__["MessageShowService"], _services_http_service__WEBPACK_IMPORTED_MODULE_3__["HttpService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _services_authenticator_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticatorService"]])], ListAssignmentComponent);
        return ListAssignmentComponent;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsCourseModuleOnlineAssignmentManageAssignmentManageAssignmentComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsCourseModuleOnlineAssignmentManageAssignmentManageAssignmentComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _data_setup_master_tag_master_tag_component_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../../data-setup/master-tag/master-tag.component.service */
      ...
      function () {
        var ManageAssignmentComponent = /*#__PURE__*/function () {
          function ManageAssignmentComponent(msgService, tagSrvc, httpService, auth, router) {
            var _this5 = this;
            ...
            this.showMarks = false; // File upload
            ...
            this.selectedFiles = [];
            this.fileArray = []; // Edit Assignment
            ...
            this.auth.institute_type.subscribe(function (res) {
              if (res == 'LANG') {
                _this5.jsonFlag.isProfessional = true;
                _this5.jsonFlag.type = 'batch';
              } else {
                _this5.jsonFlag.isProfessional = false;
                _this5.jsonFlag.type = 'course';
              }
            });
            this.auth.schoolModel.subscribe(function (res) {
              _this5.schoolModel = false;

              if (res) {
                _this5.schoolModel = true;
              }
            });
            this.jsonFlag.institute_id = sessionStorage.getItem('institution_id');
          }
          ...
          _createClass(ManageAssignmentComponent, [{
            ...
            value: function ngOnInit() {
              ...
              arr.push(this.getTagList()); // console.log("before promise")

              Promise.all(promises).then(function (response) {
                var currentURL = window.location.href;

                if (currentURL.includes('create')) {
                  _this6.sectionName = 'Add';
                } else {
                  _this6.sectionName = 'Edit';
                  var splitURL = currentURL.split("/");
                  _this6.editFileId = splitURL[splitURL.length - 1]; // console.log("before edit")

                  _this6.getEditAssignmentDetails();
                }
              });
            }
          }, {
            key: "getEditAssignmentDetails",
            value: function getEditAssignmentDetails() {
              var _this7 = this;

              this.auth.showLoader();
              var url = "/api/v2/onlineAssignment/get/".concat(this.jsonFlag.institute_id, "/").concat(this.editFileId);
              this.httpService.getData(url).subscribe(function (res) {
                _this7.auth.hideLoader();

                _this7.editAssignmentDetails = res.result; // console.log("edit");

                _this7.setEditDetails();
              }, function (err) {
                _this7.auth.hideLoader();
            ...
            value: function setEditDetails() {
              ...
              if (this.editAssignmentDetails.tag_lists) {
                for (var i = 0; i < this.editAssignmentDetails.tag_lists.length; i++) {
              ...
              if (this.editAssignmentDetails.start_time != null) {
                var start = this.editAssignmentDetails.start_time.split(' ')[0];
                var min = this.editAssignmentDetails.start_time.split(':')[1];
                var shh = start.split(':')[0];
              ...
              if (this.editAssignmentDetails.end_time != null) {
                var _start = this.editAssignmentDetails.end_time.split(' ')[0];
                var _min = this.editAssignmentDetails.end_time.split(':')[1];

                var _shh = _start.split(':')[0];

                _start = _shh + " " + this.editAssignmentDetails.end_time.split(' ')[1];
                this.assignmentDetails.endHr = _start;
                this.assignmentDetails.endMin = _min.split(' ')[0];
              }

              if (this.editAssignmentDetails.attachment_lists) {
                for (var index = 0; index < this.editAssignmentDetails.attachment_lists.length; index++) {
            ...
            value: function getBatchList() {
              ...
              this.auth.showLoader();
              var url = "/api/v1/batches/fetchCombinedBatchData/".concat(this.jsonFlag.institute_id, "/?standard_id=-1&subject_id=-1&assigned=Y");
              this.httpService.getData(url).subscribe(function (res) {
                _this8.auth.hideLoader();

                _this8.masterCourseList = res.standardLi;
                _this8.batchList = res.batchLi;
              }, function (err) {
                _this8.auth.hideLoader();
            ...
            value: function updateCoursesList() {
              ...
              var url = "/api/v1/batches/fetchCombinedBatchData/".concat(this.jsonFlag.institute_id, "/?standard_id=").concat(this.assignmentDetails.masterCourse, "&subject_id=-1&assigned=Y");
              this.auth.showLoader();
              this.httpService.getData(url).subscribe(function (res) {
                ...
                var result;
                result = res;
                _this9.courseList = result.subjectLi;
                _this9.batchList = result.batchLi;

                _this9.auth.hideLoader();

                _this9.updateSubjectsList();
              }, function (err) {
                _this9.auth.hideLoader();

                _this9.msgService.showErrorMessage(_this9.msgService.toastTypes.error, '', err);
              });
            }
          }, {
            ...
            value: function updateSubjectsList() {
              ...
              this.auth.showLoader();
              var url = "/api/v1/batches/fetchCombinedBatchData/".concat(this.jsonFlag.institute_id, "/?standard_id=").concat(this.assignmentDetails.masterCourse, "&subject_id=").concat(this.assignmentDetails.course, "&assigned=Y");
              this.auth.showLoader();
              this.httpService.getData(url).subscribe(function (res) {
                ...
                var result;
                result = res;
                _this10.batchList = result.batchLi;
              }, function (err) {
                _this10.auth.hideLoader();
            ...
            key: "getStudentsListForBatch",
            value: function getStudentsListForBatch() {
              var _this11 = this;

              if (this.assignmentDetails.batch != '-1') {
                this.auth.showLoader();
                var url = "/api/v1/studentBatchMap/batches/".concat(this.assignmentDetails.batch);
                this.auth.showLoader();
                this.httpService.postData(url, null).subscribe(function (res) {
                  _this11.auth.hideLoader();

                  var result;
                  result = res;
                  _this11.studentsList = result;
                }, function (err) {
                  _this11.auth.hideLoader();
            ...
            value: function getMasterCourse() {
              ...
              // } else {
              this.auth.showLoader();
              var url = "/api/v1/courseMaster/fetch/".concat(this.jsonFlag.institute_id, "/all");
              this.httpService.getData(url).subscribe(function (res) {
                _this12.auth.hideLoader();

                _this12.courseModelList = res;
                _this12.masterCourseList = _this12.courseModelList;
                console.log("master c");

                if (_this12.sectionName == 'Edit') {
                  _this12.getCourses();
                }
              }, function (err) {
                _this12.auth.hideLoader();

                _this12.msgService.showErrorMessage(_this12.msgService.toastTypes.error, '', err);
              }); // }
            }
          }, {
            key: "getStandard",
            value: function getStandard() {
              ...
              this.auth.showLoader();
              this.httpService.getData('/api/v1/courseMaster/standard-section-list/' + sessionStorage.getItem('institute_id')).subscribe(function (res) {
                _this13.auth.hideLoader();

                _this13.masterCourseList = res.result;

                if (_this13.sectionName == 'Edit') {
                  _this13.getCourseList(_this13.assignmentDetails.standard_id);
                }
              }, function (err) {
                _this13.auth.hideLoader();

                _this13.msgService.showErrorMessage(_this13.msgService.toastTypes.error, '', 'Please check your internet connection or contact at support@proctur.com if the issue persist');
              });
            }
          }, {
            key: "getCourseList",
            value: function getCourseList(ev) {
              ...
              if (this.assignmentDetails.standard_id != "-1") {
                this.courseList = [];
                var standard_obj = this.masterCourseList.filter(function (standard) {
            ...
            value: function getSchoolSubjects() {
              var _this14 = this;

              this.auth.showLoader();
              this.subjectList = [];
              var url = "/api/v1/courseMaster/fetch/courses/" + sessionStorage.getItem('institute_id') + '/' + this.assignmentDetails.course;
              this.httpService.getData(url).subscribe(function (res) {
                _this14.auth.hideLoader(); //console.log('Subject', res);


                _this14.subjectList = res.batchesList;

                if (_this14.sectionName == 'Edit' && _this14.assignmentDetails.subject != "0") {
                  _this14.getTopic();
                }
              }, function (err) {
                _this14.msgService.showErrorMessage('error', '', err.error.message);

                _this14.auth.hideLoader(); //console.log(err);
            ...
            value: function getCourses() {
              if (this.assignmentDetails.masterCourse != "-1") {
                for (var index = 0; index < this.masterCourseList.length; index++) {
            ...
            value: function getSubjects() {
              if (this.assignmentDetails.course != "-1") {
                ...
                if (this.schoolModel) {
                  ...
                  for (var index = 0; index < this.courseList.length; index++) {
            ...
            value: function getTopic() {
              ...
              if (!this.jsonFlag.isProfessional) {
                if (this.assignmentDetails.subject != "-1") {
                  url = "/api/v1/topic_manager/standards/-1/subjects/".concat(this.assignmentDetails.subject, "/topics");
                } else {
                  this.topicList = [];
                  this.subTopicList = []; // this.studentsList = [];
                ...
                if (this.assignmentDetails.batch != "-1") {
                  for (var i = 0; i < this.batchList.length; i++) {
                    if (this.batchList[i].batch_id == this.assignmentDetails.batch) {
                      url = "/api/v1/topic_manager/standards/-1/subjects/".concat(this.batchList[i].subject_id, "/topics");
                      break;
                    }
                  }
                } else {
              ...
              if (url != '') {
                ...
                this.httpService.getData(url).subscribe(function (res) {
                  ...
                  _this15.topicList = res;

                  if (_this15.sectionName == 'Edit') {
                    _this15.getSubTopic();
                  }
                }, function (err) {
                  _this15.auth.hideLoader();
            ...
            key: "getSubTopic",
            value: function getSubTopic() {
              if (this.assignmentDetails.topic != "-1") {
                for (var index = 0; index < this.topicList.length; index++) {
            ...
            key: "getFacultyList",
            value: function getFacultyList() {
              var _this16 = this;

              this.auth.showLoader();
              var url = "/api/v1/teachers/all/".concat(this.jsonFlag.institute_id, "/?active=Y");
              this.httpService.getData(url).subscribe(function (res) {
                _this16.auth.hideLoader();

                _this16.facultyList = res;
              }, function (err) {
                _this16.auth.hideLoader();
            ...
            value: function getTagList() {
              ...
              this.auth.showLoader();
              var url = "/api/v2/tag_master/getAll/".concat(this.jsonFlag.institute_id);
              this.httpService.getData(url).subscribe(function (res) {
            ...
            value: function getStudentsList() {
              ...
              this.auth.showLoader();
              var url = "/api/v1/studentBatchMap/manageBatchStudent/".concat(this.jsonFlag.institute_id);
              this.httpService.postData(url, obj).subscribe(function (res) {
                _this18.auth.hideLoader();

                _this18.studentsList = res;
                console.log(_this18.studentsList);

                if (_this18.sectionName == 'Edit') {
                  var studentArr = [];

                  for (var i = 0; i < _this18.studentsList.length; i++) {
                    for (var j = 0; j < _this18.editAssignmentDetails.studentId_lists.length; j++) {
                      if (_this18.studentsList[i].student_id == _this18.editAssignmentDetails.studentId_lists[j]) {
                        studentArr.push(_this18.studentsList[i]);
                      }
                    }
                  }

                  _this18.selectedStudentList = studentArr;
                }
              }, function (err) {
                _this18.auth.hideLoader();

                _this18.msgService.showErrorMessage(_this18.msgService.toastTypes.error, '', err);
              });
            }
          }, {
            key: "saveAsDraft",
            value: function saveAsDraft() {
              ...
              this.assignmentDetails.students = [];
              var start_date = moment__WEBPACK_IMPORTED_MODULE_5__(this.assignmentDetails.startDate);
              var todaysDate = moment__WEBPACK_IMPORTED_MODULE_5__(new Date());
              ...
              for (var _i = 0; _i < this.selectedStudentList.length; _i++) {
                this.assignmentDetails.students.push(this.selectedStudentList[_i].student_id);
              }
                            ...
                            if (this.checkFileAndURL()) {
                              if (this.getEventHourTo()) {
                                if (this.checkEvaluationDate()) {
                                  ...
                                  var shr = this.assignmentDetails.startHr.split(' ');
                                  var ehr = this.assignmentDetails.endHr.split(' ');
                                  var obj = {
                                    institute_id: this.jsonFlag.institute_id,
                                    category_id: "255",
                                    course_id: this.assignmentDetails.course,
            ...
            value: function saveAssignment() {
              ...
              for (var _i2 = 0; _i2 < this.selectedStudentList.length; _i2++) {
                this.assignmentDetails.students.push(this.selectedStudentList[_i2].student_id);
              }
                ...
                if (this.assignmentDetails.startHr.trim() != '' && this.assignmentDetails.startMin.trim() != '') {
                  if (!this.schoolModel && this.assignmentDetails.masterCourse != '-1' || this.schoolModel && this.assignmentDetails.standard_id != '-1') {
                    if (this.assignmentDetails.course != '-1') {
                      ...
                      var msg = this.schoolModel ? 'Please seclect section' : 'Please select course';
                      this.msgService.showErrorMessage('error', '', msg);
                    }
                  } else {
                    var _msg = this.schoolModel ? 'Please seclect standard' : 'Please select master course';

                    this.msgService.showErrorMessage('error', '', _msg);
                  }
                } else {
                  this.msgService.showErrorMessage('error', '', "Please select assignment start time hrs & mins");
                }
            ...
            key: "createOnlineAssignment",
            value: function createOnlineAssignment(obj) {
              var _this19 = this;
                ...
                if (newxhr.readyState == 4) {
                  ...
                  if (newxhr.status >= 200 && newxhr.status < 300) {
                    ...
                    if (data.statusCode >= 200 && data.statusCode < 300) {
                      _this19.msgService.showErrorMessage('success', '', 'Assignment created successfully');

                      _this19.router.navigate(['/view/course/online-assignment']);
                    } else {
                      _this19.msgService.showErrorMessage('error', '', data.message);
                    }
                  } else {
                    var _data = JSON.parse(newxhr.response);

                    _this19.msgService.showErrorMessage('error', '', _data.message);
                  }
                }
              };
            ...
            value: function fillFiles(files) {
              ...
              if (preview != null || preview != undefined) {
                setTimeout(function () {
                  ...
                  _this20.selectedFiles.push(filesArr[0]);

                  _this20.customFileArr = _this20.generateFilePreview(filesArr);
            ...
            key: "checkFileAndURL",
            value: function checkFileAndURL() {
            ...
            key: "isUrlValid",
            value: function isUrlValid(userInput) {
              var res = userInput.match(/(http(s)?:\/\/.)?(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&//=]*)/g);
              if (res == null) return false;else return true;
            }
          }, {
            key: "removeLink",
            value: function removeLink(display_name) {
              for (var index = 0; index < this.assignmentDetails.urlLists.length; index++) {
            ...
            value: function getEventHourFrom(e) {
              ...
              if (this.assignmentDetails.startHr != "" && this.assignmentDetails.startHr != null && this.assignmentDetails.startMin != "" && this.assignmentDetails.startMin != null && this.assignmentDetails.endHr != "" && this.assignmentDetails.endHr != null && this.assignmentDetails.endMin != "" && this.assignmentDetails.endMin != null) {
                this.getEventHourTo();
              }
            }
          }, {
            ...
            value: function getEventHourTo() {
              var fromTime = moment__WEBPACK_IMPORTED_MODULE_5__(this.assignmentDetails.startDate).format('YYYY-MM-DD') + " " + this.assignmentDetails.startHr.split(' ')[0] + ":" + this.assignmentDetails.startMin + " " + this.assignmentDetails.startHr.split(' ')[1];
              var toTime = moment__WEBPACK_IMPORTED_MODULE_5__(this.assignmentDetails.endDate).format('YYYY-MM-DD') + " " + this.assignmentDetails.endHr.split(' ')[0] + ":" + this.assignmentDetails.endMin + " " + this.assignmentDetails.endHr.split(' ')[1];
              var fromTimeT = moment__WEBPACK_IMPORTED_MODULE_5__(fromTime).format('YYYY-MM-DD hh:mm a');
              var toTimeT = moment__WEBPACK_IMPORTED_MODULE_5__(toTime).format('YYYY-MM-DD hh:mm a');
            ...
            value: function checkEvaluationDate() {
              var evaluationDate = moment__WEBPACK_IMPORTED_MODULE_5__(this.assignmentDetails.evaluation_date).format('YYYY-MM-DD');
              var toTime = moment__WEBPACK_IMPORTED_MODULE_5__(this.assignmentDetails.endDate).format('YYYY-MM-DD') + " " + this.assignmentDetails.endHr.split(' ')[0] + ":" + this.assignmentDetails.endMin + " " + this.assignmentDetails.endHr.split(' ')[1];
              var lateSubmissionDate = moment__WEBPACK_IMPORTED_MODULE_5__(this.assignmentDetails.assignment_late_submission_date).format('YYYY-MM-DD');
              var evaluationTimeT = moment__WEBPACK_IMPORTED_MODULE_5__(evaluationDate).format('YYYY-MM-DD hh:mm a');
              var toTimeT = moment__WEBPACK_IMPORTED_MODULE_5__(toTime).format('YYYY-MM-DD hh:mm a');
              var lateSubT = moment__WEBPACK_IMPORTED_MODULE_5__(lateSubmissionDate).format('YYYY-MM-DD hh:mm a');
            ...
            key: "removeOldLink",
            value: function removeOldLink(display_name) {
              for (var index = 0; index < this.editUrlList.length; index++) {
            ...
            key: "removeOldFile",
            value: function removeOldFile(file_id) {
              for (var index = 0; index < this.editAttachmentList.length; index++) {
            ...
            value: function createMasterTag() {
              ...
              this.tagSrvc.addMasterTagInInstitute(payload).subscribe(function (data) {
                ...
                _this21.msgService.showErrorMessage('success', '', temp.message);

                _this21.auth.hideLoader();

                _this21.newTagDescription = '';
                _this21.newTagName = '';
                $('#addTag').modal('hide');
                ...
                _this21.msgService.showErrorMessage(_this21.msgService.toastTypes.error, '', error.error.message);
              }); //}
            }
          }]);
        ...
        ManageAssignmentComponent.ctorParameters = function () {
          return [{
        ...
        ManageAssignmentComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          selector: 'app-manage-assignment',
          template: __importDefault(__webpack_require__(
          /*! raw-loader!./manage-assignment.component.html */
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/course-module/online-assignment/manage-assignment/manage-assignment.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./manage-assignment.component.scss */
          "./src/app/components/course-module/online-assignment/manage-assignment/manage-assignment.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [_services_message_show_service__WEBPACK_IMPORTED_MODULE_3__["MessageShowService"], _data_setup_master_tag_master_tag_component_service__WEBPACK_IMPORTED_MODULE_4__["MasterTagService"], _services_http_service__WEBPACK_IMPORTED_MODULE_2__["HttpService"], _services_authenticator_service__WEBPACK_IMPORTED_MODULE_1__["AuthenticatorService"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"]])], ManageAssignmentComponent);
        return ManageAssignmentComponent;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsCourseModuleOnlineAssignmentOnlineAssignmentRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "OnlineAssignmentRoutingModule", function () {
      ...
      var _online_assignment_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./online-assignment.component */
      "./src/app/components/course-module/online-assignment/online-assignment.component.ts");
      /* harmony import */


      var _list_assignment_list_assignment_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./list-assignment/list-assignment.component */
      "./src/app/components/course-module/online-assignment/list-assignment/list-assignment.component.ts");
      /* harmony import */


      var _manage_assignment_manage_assignment_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./manage-assignment/manage-assignment.component */
      "./src/app/components/course-module/online-assignment/manage-assignment/manage-assignment.component.ts");
      /* harmony import */


      var _review_assignment_review_assignment_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./review-assignment/review-assignment.component */
      ...
      var OnlineAssignmentRoutingModule =
      /** @class */
      function () {
        var OnlineAssignmentRoutingModule = function OnlineAssignmentRoutingModule() {
          _classCallCheck(this, OnlineAssignmentRoutingModule);
        };

        OnlineAssignmentRoutingModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
    ...
    /***/
    function srcAppComponentsCourseModuleOnlineAssignmentOnlineAssignmentComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsCourseModuleOnlineAssignmentOnlineAssignmentComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "OnlineAssignmentComponent", function () {
      ...
      var OnlineAssignmentComponent =
      /** @class */
      function () {
        var OnlineAssignmentComponent = /*#__PURE__*/function () {
          function OnlineAssignmentComponent() {
            _classCallCheck(this, OnlineAssignmentComponent);
          }

          _createClass(OnlineAssignmentComponent, [{
            key: "ngOnInit",
            value: function ngOnInit() {}
          }]);
        ...
        OnlineAssignmentComponent.ctorParameters = function () {
          return [];
        };

        OnlineAssignmentComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          selector: 'app-online-assignment',
          template: __importDefault(__webpack_require__(
          /*! raw-loader!./online-assignment.component.html */
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/course-module/online-assignment/online-assignment.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./online-assignment.component.scss */
          "./src/app/components/course-module/online-assignment/online-assignment.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [])], OnlineAssignmentComponent);
        return OnlineAssignmentComponent;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsCourseModuleOnlineAssignmentOnlineAssignmentModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "OnlineAssignmentModule", function () {
      ...
      var _online_assignment_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./online-assignment-routing.module */
      "./src/app/components/course-module/online-assignment/online-assignment-routing.module.ts");
      /* harmony import */
      ...
      var _list_assignment_list_assignment_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./list-assignment/list-assignment.component */
      "./src/app/components/course-module/online-assignment/list-assignment/list-assignment.component.ts");
      /* harmony import */


      var _manage_assignment_manage_assignment_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./manage-assignment/manage-assignment.component */
      "./src/app/components/course-module/online-assignment/manage-assignment/manage-assignment.component.ts");
      /* harmony import */


      var _review_assignment_review_assignment_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./review-assignment/review-assignment.component */
      "./src/app/components/course-module/online-assignment/review-assignment/review-assignment.component.ts");
      /* harmony import */


      var _online_assignment_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./online-assignment.component */
      "./src/app/components/course-module/online-assignment/online-assignment.component.ts");
      /* harmony import */
      ...
      var OnlineAssignmentModule =
      /** @class */
      function () {
        var OnlineAssignmentModule = function OnlineAssignmentModule() {
          _classCallCheck(this, OnlineAssignmentModule);
        };

        OnlineAssignmentModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], // BsDatepickerModule,
          primeng_primeng__WEBPACK_IMPORTED_MODULE_4__["FileUploadModule"], primeng_primeng__WEBPACK_IMPORTED_MODULE_4__["SplitButtonModule"], _online_assignment_routing_module__WEBPACK_IMPORTED_MODULE_2__["OnlineAssignmentRoutingModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_10__["SharedModule"], ng_multiselect_dropdown__WEBPACK_IMPORTED_MODULE_9__["NgMultiSelectDropDownModule"].forRoot()],
          declarations: [_online_assignment_component__WEBPACK_IMPORTED_MODULE_8__["OnlineAssignmentComponent"], _list_assignment_list_assignment_component__WEBPACK_IMPORTED_MODULE_5__["ListAssignmentComponent"], _manage_assignment_manage_assignment_component__WEBPACK_IMPORTED_MODULE_6__["ManageAssignmentComponent"], _review_assignment_review_assignment_component__WEBPACK_IMPORTED_MODULE_7__["ReviewAssignmentComponent"]]
    ...
    /***/
    function srcAppComponentsCourseModuleOnlineAssignmentReviewAssignmentReviewAssignmentComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsCourseModuleOnlineAssignmentReviewAssignmentReviewAssignmentComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ReviewAssignmentComponent", function () {
      ...
      var ReviewAssignmentComponent =
      /** @class */
      function () {
        var ReviewAssignmentComponent = /*#__PURE__*/function () {
          function ReviewAssignmentComponent(msgService, httpService, auth, cd) {
            var _this22 = this;

            _classCallCheck(this, ReviewAssignmentComponent);

            this.msgService = msgService;
            this.httpService = httpService;
            this.auth = auth;
            this.cd = cd; // global variables
            ...
            this.rowSelectedId = []; // file upload
            ...
            this.auth.institute_type.subscribe(function (res) {
              if (res == 'LANG') {
                _this22.jsonFlag.isProfessional = true;
                _this22.jsonFlag.type = 'batch';
              } else {
                _this22.jsonFlag.isProfessional = false;
                _this22.jsonFlag.type = 'course';
              }
            });
            this.jsonFlag.institute_id = sessionStorage.getItem('institution_id');
          }

          _createClass(ReviewAssignmentComponent, [{
            key: "ngOnInit",
            value: function ngOnInit() {
              var currentURL = window.location.href;
              var splitURL = currentURL.split("/");
            ...
            value: function checkEvaluateButton() {
              var end_date = '';
              ...
              var currentDate = moment__WEBPACK_IMPORTED_MODULE_4__(new Date()).format('YYYY-MM-DD');
            ...
            value: function getAssignmentDetails() {
              ...
              this.auth.showLoader();
              var url = "/api/v2/onlineAssignment/get/".concat(this.jsonFlag.institute_id, "/").concat(this.reviewAssignmentId);
              this.httpService.getData(url).subscribe(function (res) {
                _this23.auth.hideLoader();

                _this23.assignmentDetails = res.result;

                if (_this23.assignmentDetails.enable_grade) {
                  _this23.getGradeDetails();
                }

                _this23.checkEvaluateButton();
              }, function (err) {
                _this23.auth.hideLoader();

                _this23.msgService.showErrorMessage(_this23.msgService.toastTypes.error, '', err);
              });
            }
          }, {
            key: "getStudentsList",
            value: function getStudentsList() {
              ...
              this.auth.showLoader();
              var url = "/api/v2/onlineAssignment/getStudentsDetail";
              this.httpService.postData(url, obj).subscribe(function (res) {
                _this24.auth.hideLoader();

                _this24.studentList = res.result;
                _this24.tempStudentList = res.result;

                for (var i; i < _this24.studentList.length; i++) {
                  _this24.studentList[i].uiSelected = false;
                }
              }, function (err) {
                _this24.auth.hideLoader();

                _this24.msgService.showErrorMessage(_this24.msgService.toastTypes.error, '', err);
              });
            }
          }, {
            key: "updateStatus",
            value: function updateStatus(student) {
              var _this25 = this;
              ...
              this.editStatus.teacher_comment = student.teacher_comment; // this.editStatus.teacher_status = 'Done';

              this.auth.showLoader();
              var url = "/api/v2/onlineAssignment/studentAttachmentsDetail/".concat(this.jsonFlag.institute_id, "/").concat(this.editStatus.student_id, "/").concat(this.reviewAssignmentId);
              this.httpService.getData(url).subscribe(function (res) {
                ...
                if (res.result.student_attachment && res.result.student_attachment != null) {
                  for (var i = 0; i < res.result.student_attachment.length; i++) {
                    if (res.result.student_attachment[i].attachment_name == 'URL') {
                      _this25.editStudentAttachments.urlList.push(res.result.student_attachment[i]);
                    } else {
                      _this25.editStudentAttachments.attachmentList.push(res.result.student_attachment[i]);
                    }
                  }
                }

                if (res.result.teacher_attachment && res.result.teacher_attachment != null) {
                  for (var _i3 = 0; _i3 < res.result.teacher_attachment.length; _i3++) {
                    if (res.result.teacher_attachment[_i3].attachment_name == 'URL') {
                      _this25.editTeacherAttachments.urlList.push(res.result.teacher_attachment[_i3]);
                    } else {
                      _this25.editTeacherAttachments.attachmentList.push(res.result.teacher_attachment[_i3]);
                    }
                  }
                }
              }, function (err) {
                ...
                _this25.msgService.showErrorMessage(_this25.msgService.toastTypes.error, '', err);
              });
            ...
            key: "getGradeDetails",
            value: function getGradeDetails() {
              var _this26 = this;

              var url = "/api/v1/grade_manager/getDetail/" + sessionStorage.getItem('institute_id');
              this.httpService.getData(url).subscribe(function (res) {
                _this26.gradeDetails = res;
              }, function (err) {});
            }
          }, {
            key: "updateUpdateFile",
            value: function updateUpdateFile(files) {
              var _this27 = this;

              var preview = document.getElementById('updateUploadFile').files[0];

              if (preview != null || preview != undefined) {
                setTimeout(function () {
                  var manualUploadedFileList = document.getElementById('updateUploadFile').files;
                  var filesArr = Array.from(manualUploadedFileList);

                  _this27.facultyAttachments.push(filesArr[0]);
            ...
            value: function removeNewlyAddedFile(fileName) {
              for (var index = 0; index < this.facultyAttachments.length; index++) {
            ...
            key: "updateUploadURL",
            value: function updateUploadURL() {
            ...
            key: "removeUpdateLink",
            value: function removeUpdateLink(attachment_display_name) {
              for (var index = 0; index < this.editTeacherAttachments.urlList.length; index++) {
            ...
            value: function removeNewlyAddedLink(display_name) {
              for (var index = 0; index < this.facultyUrlList.length; index++) {
            ...
            value: function updateStudentStatus() {
              var _this28 = this;
              ...
              for (var i = 0; i < this.facultyAttachments.length; i++) {
                formData.append("files", this.facultyAttachments[i]);
              }

              var base = this.auth.getBaseUrl();
              var urlPostXlsDocument = base + "/api/v2/onlineAssignment/updateStudentAssignment";
              var newxhr = new XMLHttpRequest();
              var auths = {
                userid: sessionStorage.getItem('userid'),
                userType: sessionStorage.getItem('userType'),
              ...
              newxhr.onreadystatechange = function () {
                if (newxhr.readyState == 4) {
                  if (newxhr.status >= 200 && newxhr.status < 300) {
                    ...
                    _this28.msgService.showErrorMessage('success', '', 'Updated successfully');

                    $('#updateStudent').modal('hide');
                    _this28.editStatus.evaluation_marks = 0;
                    _this28.editStatus.evaluation_required = "";
                    _this28.editStatus.file_id = "";
                    _this28.editStatus.student_comment = "";
                    _this28.editStatus.student_display_id = "";
                    _this28.editStatus.student_email = "";
                    _this28.editStatus.student_id = "";
                    _this28.editStatus.student_marks = "";
                    _this28.editStatus.student_name = "";
                    _this28.editStatus.student_phone = "";
                    _this28.editStatus.student_status = "Open";
                    _this28.editStatus.teacher_comment = ""; // this.editStatus.teacher_status = "Open";

                    _this28.editStudentAttachments.urlList = [];
                    _this28.editStudentAttachments.attachmentList = [];
                    _this28.editTeacherAttachments.urlList = [];
                    _this28.editTeacherAttachments.attachmentList = [];
                    _this28.removedAttchedDocsIds = [];
                    _this28.facultyAttachments = [];
                    _this28.facultyUrlList = [];

                    _this28.getStudentsList();
                  } else {
                    _this28.msgService.showErrorMessage('error', '', newxhr.response.message);
                  }
                }
              };
            ...
            value: function removeFacultyAttachment(id) {
              for (var index = 0; index < this.editTeacherAttachments.attachmentList.length; index++) {
            ...
            value: function uploadAttachments() {
              ...
              var base = this.auth.getBaseUrl();
              var urlPostXlsDocument = base + "/api/v2/onlineAssignment/uploadAssignmentSolution";
              var newxhr = new XMLHttpRequest();
              var auths = {
                userid: sessionStorage.getItem('userid'),
                userType: sessionStorage.getItem('userType'),
              ...
              newxhr.onreadystatechange = function () {
                if (newxhr.readyState == 4) {
                  if (newxhr.status >= 200 && newxhr.status < 300) {
                    ...
                    _this29.msgService.showErrorMessage('success', '', 'Solution uploaded successfully');

                    $('#bulk').modal('hide');
                  } else {
                    _this29.msgService.showErrorMessage('error', '', newxhr.response.message);
                  }
                }
              };
            ...
            value: function fillFiles() {
              ...
              if (preview != null || preview != undefined) {
                setTimeout(function () {
                  ...
                  _this30.selectedFiles.push(filesArr[0]);

                  _this30.customFileArr = _this30.generateFilePreview(filesArr);
                  document.getElementById('uploadFileControl').value = null;
                }, 500);
              } else {
                this.msgService.showErrorMessage('error', '', "No file selected");
            ...
            value: function removeFile(file) {
              for (var index = 0; index < this.fileArray.length; index++) {
            ...
            key: "removeLink",
            value: function removeLink(display_name) {
              for (var index = 0; index < this.bulkUrlList.length; index++) {
            ...
            key: "selectAllRows",
            value: function selectAllRows(ev) {
              this.cd.reattach();
              ...
              if (ev.target.checked) {
                this.studentList.forEach(function (x) {
                  return x.uiSelected = ev.target.checked;
                });
            ...
            value: function getSelectedRows() {
              ...
              this.studentList.forEach(function (e) {
                if (e.uiSelected) {
                  _this31.rowSelectedId.push(e.student_id);
                }
              });
            }
          }, {
            ...
            value: function isAllChecked() {
              return this.studentList.every(function (_) {
                return _.uiSelected;
              });
            }
          }, {
            key: "removeFromSelectedArr",
            value: function removeFromSelectedArr(id) {
              return this.rowSelectedId.filter(function (e) {
                return e != id;
              });
            }
          }, {
            key: "rowCheckboxChange",
            value: function rowCheckboxChange(eve) {
              this.cd.markForCheck();
              var status = eve.uiSelected;
            ...
            value: function downloadFile(object) {
              ...
              this.auth.showLoader();
              var url = "/api/v2/onlineAssignment/downloadFile";
              this.httpService.postData(url, obj).subscribe(function (res) {
                ...
                hiddenDownloader.click(); // if (result.data != '' && result.data != null) {
                ...
                _this32.msgService.showErrorMessage(_this32.msgService.toastTypes.error, '', err);
              });
            }
          }]);
        ...
        ReviewAssignmentComponent.ctorParameters = function () {
          return [{
            type: _services_message_show_service__WEBPACK_IMPORTED_MODULE_3__["MessageShowService"]
          }, {
            type: _services_http_service__WEBPACK_IMPORTED_MODULE_2__["HttpService"]
        ...
        ReviewAssignmentComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          selector: 'app-review-assignment',
          template: __importDefault(__webpack_require__(
          /*! raw-loader!./review-assignment.component.html */
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/course-module/online-assignment/review-assignment/review-assignment.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./review-assignment.component.scss */
          "./src/app/components/course-module/online-assignment/review-assignment/review-assignment.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [_services_message_show_service__WEBPACK_IMPORTED_MODULE_3__["MessageShowService"], _services_http_service__WEBPACK_IMPORTED_MODULE_2__["HttpService"], _services_authenticator_service__WEBPACK_IMPORTED_MODULE_1__["AuthenticatorService"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"]])], ReviewAssignmentComponent);
        return ReviewAssignmentComponent;
      }();
      /***/
...
//# sourceMappingURL=components-course-module-online-assignment-online-assignment-module-es5.js.map