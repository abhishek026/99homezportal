(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["website-configuration-static-pages-static-pages-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsWebsiteConfigurationStaticPagesAddEditAddEditComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsWebsiteConfigurationStaticPagesListListComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsWebsiteConfigurationStaticPagesStaticPagesComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsWebsiteConfigurationStaticPagesAddEditAddEditComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsWebsiteConfigurationStaticPagesAddEditAddEditComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      function () {
        var AddEditComponent = /*#__PURE__*/function () {
          ...
          _createClass(AddEditComponent, [{
            ...
            key: "getPageDataById",
            value: function getPageDataById() {
              var _this2 = this;

              this.auth.showLoader();
              this.productService.getMethod('/api/v2/website/page/' + this.selectedPageId, null).subscribe(function (res) {
                _this2.auth.hideLoader();

                _this2.pageModel = res.result; //this.fetchTableDataByPage(this.pageIndex);
              }, function (err) {
                _this2.auth.hideLoader();
              });
            } // saveData() {
            ...
            value: function saveData() {
              ...
              var file = document.getElementById('uploadFileControl').files[0]; // if (this.checkValidation(file)) {
              ...
              if (this.pageModel.page_title != '') {
                if (this.pageModel.page_route != '') {
                  ...
                  var urlPostXlsDocument = this.selectedPageId ? base + "/prod/api/v2/website/page/update" : base + "/prod/api/v2/website/page/create";
                    ...
                    newxhr.onreadystatechange = function () {
                      ...
                      if (newxhr.readyState == 4) {
                        if (newxhr.status >= 200 && newxhr.status < 300) {
                          ...
                          // this.refreshList();
                          var msg = _this3.selectedPageId ? 'Page Updated successfully' : 'Page Added Successfully';

                          _this3.msgService.showErrorMessage(_this3.msgService.toastTypes.success, '', msg);

                          _this3.cancel();
                        } else {
                          _this3.msgService.showErrorMessage(_this3.msgService.toastTypes.error, '', JSON.parse(newxhr.response).message);
                        }
                      }
                    };
        ...
        AddEditComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          ...
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/website-configuration/static-pages/add-edit/add-edit.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./add-edit.component.scss */
          "./src/app/components/website-configuration/static-pages/add-edit/add-edit.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], _services_authenticator_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticatorService"], _services_products_service__WEBPACK_IMPORTED_MODULE_3__["ProductService"], _services_message_show_service__WEBPACK_IMPORTED_MODULE_4__["MessageShowService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]])], AddEditComponent);
        return AddEditComponent;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsWebsiteConfigurationStaticPagesListListComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsWebsiteConfigurationStaticPagesListListComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      function () {
        var ListComponent = /*#__PURE__*/function () {
          function ListComponent(httpService, auth, router, msgService) {
          ...
          _createClass(ListComponent, [{
            ...
            value: function getStaticPageData() {
              ...
              this.auth.showLoader();
              this.httpService.getMethod('/api/v2/website/page/institute/' + sessionStorage.getItem('institute_id'), null).subscribe(function (res) {
                _this4.auth.hideLoader();

                _this4.staticPageDataSouece = res.result;
                _this4.totalRecords = _this4.staticPageDataSouece.length;
                _this4.staticPageData = _this4.getDataFromDataSource(0);

                if (_this4.staticPageDataSouece && _this4.staticPageDataSouece.length) {
                  _this4.staticPageDataSouece.forEach(function (element) {
            ...
            value: function deleteRow(obj) {
              ...
              this.auth.showLoader();
              this.httpService.deleteFile('/prod/api/v2/website/page/' + obj.data.id).subscribe(function (res) {
                _this5.auth.hideLoader();

                _this5.msgService.showErrorMessage('success', '', 'Page Deleted Successfully');

                _this5.getStaticPageData();
              }, function (err) {
                _this5.auth.hideLoader();
              });
            }
        ...
        ListComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          ...
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/website-configuration/static-pages/list/list.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./list.component.scss */
          "./src/app/components/website-configuration/static-pages/list/list.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [_services_products_service__WEBPACK_IMPORTED_MODULE_4__["ProductService"], _services_authenticator_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticatorService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _services_message_show_service__WEBPACK_IMPORTED_MODULE_3__["MessageShowService"]])], ListComponent);
        return ListComponent;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsWebsiteConfigurationStaticPagesStaticPagesRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _static_pages_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      function () {
        ...
        StaticPagesRoutingModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
    ...
    /***/
    function srcAppComponentsWebsiteConfigurationStaticPagesStaticPagesComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsWebsiteConfigurationStaticPagesStaticPagesComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      function () {
        var StaticPagesComponent = /*#__PURE__*/function () {
          function StaticPagesComponent(httpService, auth, router, productService, msgService) {
          ...
          _createClass(StaticPagesComponent, [{
            ...
            value: function getPageDataById() {
              ...
              this.productService.getMethod('/api/v2/website/page/' + this.selectedPageId, null).subscribe(function (res) {
                ...
                _this6.pageModel = res.result; //this.fetchTableDataByPage(this.pageIndex);
              }, function (err) {
                _this6.auth.hideLoader();
              });
            }
            ...
            value: function getStaticPageData() {
              ...
              this.httpService.getMethod('/api/v2/website/page/institute/' + sessionStorage.getItem('institute_id'), null).subscribe(function (res) {
                ...
                _this7.staticPageDataSouece = res.result;
                _this7.totalRecords = _this7.staticPageDataSouece.length;
                _this7.staticPageData = _this7.getDataFromDataSource(0);

                if (_this7.staticPageDataSouece && _this7.staticPageDataSouece.length) {
                  _this7.staticPageDataSouece.forEach(function (element) {
                    if (element.page_status != null && element.page_status != '') {
                      element.page_status = element.page_status.charAt(0).toUpperCase() + element.page_status.substr(1).toLowerCase();
                      element.in_navbar = element.in_navbar ? 'Yes' : 'No';
                    }
            ...
            value: function editRow(object) {
              ...
              console.log(object); //this.router.navigate(['view/website-configuration/static-pages/edit/' + object.data.id])
            }
          }, {
            key: "deleteRow",
            value: function deleteRow(obj) {
              ...
              this.auth.showLoader();
              this.httpService.deleteFile('/prod/api/v2/website/page/' + obj.id).subscribe(function (res) {
                _this8.auth.hideLoader();

                _this8.msgService.showErrorMessage('success', '', 'Page Deleted Successfully');

                _this8.getStaticPageData();
              }, function (err) {
                _this8.auth.hideLoader();
              });
            }
                    ...
                    newxhr.onreadystatechange = function () {
                      ...
                      if (newxhr.readyState == 4) {
                        if (newxhr.status >= 200 && newxhr.status < 300) {
                          // this.clearuploadObject();
                          // this.refreshList();
                          var msg = _this9.selectedPageId ? 'Page Updated successfully' : 'Page Added Successfully';

                          _this9.msgService.showErrorMessage(_this9.msgService.toastTypes.success, '', msg);

                          _this9.cancel();

                          _this9.getStaticPageData();

                          $('#myModal').modal('hide');
                        } else {
                          _this9.msgService.showErrorMessage(_this9.msgService.toastTypes.error, '', JSON.parse(newxhr.response).message);
                        }
                      }
                    };
        ...
        StaticPagesComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          selector: 'app-static-pages',
          template: __importDefault(__webpack_require__(
          /*! raw-loader!./static-pages.component.html */
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/website-configuration/static-pages/static-pages.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./static-pages.component.scss */
          "./src/app/components/website-configuration/static-pages/static-pages.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [_services_products_service__WEBPACK_IMPORTED_MODULE_4__["ProductService"], _services_authenticator_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticatorService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _services_products_service__WEBPACK_IMPORTED_MODULE_4__["ProductService"], _services_message_show_service__WEBPACK_IMPORTED_MODULE_3__["MessageShowService"]])], StaticPagesComponent);
        return StaticPagesComponent;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsWebsiteConfigurationStaticPagesStaticPagesModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _static_pages_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./static-pages.component */
      "./src/app/components/website-configuration/static-pages/static-pages.component.ts");
      /* harmony import */
      ...
      var _services_authenticator_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../../../services/authenticator.service */
      "./src/app/services/authenticator.service.ts");
      /* harmony import */
      ...
      function () {
        ...
        StaticPagesModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
          ...
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _static_pages_routing_module__WEBPACK_IMPORTED_MODULE_2__["StaticPagesRoutingModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_6__["SharedModule"], _tinymce_tinymce_angular__WEBPACK_IMPORTED_MODULE_9__["EditorModule"]],
          providers: [_services_products_service__WEBPACK_IMPORTED_MODULE_8__["ProductService"], _services_authenticator_service__WEBPACK_IMPORTED_MODULE_7__["AuthenticatorService"]]
        })], StaticPagesModule);
        return StaticPagesModule;
      }();
      /***/
...
//# sourceMappingURL=website-configuration-static-pages-static-pages-module-es5.js.map