...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GuestUserRoutingModule", function() { return GuestUserRoutingModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _guest_user_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./guest-user.component */ "./src/app/components/guest-user/guest-user.component.ts");
/* harmony import */ var _register_register_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./register/register.component */ "./src/app/components/guest-user/register/register.component.ts");
...
let GuestUserRoutingModule = /** @class */ (() => {
    let GuestUserRoutingModule = class GuestUserRoutingModule {
    };
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GuestUserComponent", function() { return GuestUserComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
let GuestUserComponent = /** @class */ (() => {
    let GuestUserComponent = class GuestUserComponent {
        constructor() { }
        ngOnInit() {
        }
    };
    GuestUserComponent.ctorParameters = () => [];
    GuestUserComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-guest-user',
            template: __importDefault(__webpack_require__(/*! raw-loader!./guest-user.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/guest-user/guest-user.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./guest-user.component.scss */ "./src/app/components/guest-user/guest-user.component.scss")).default]
        }),
...
/* harmony import */ var _guest_user_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./guest-user-routing.module */ "./src/app/components/guest-user/guest-user-routing.module.ts");
/* harmony import */ var _guest_user_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./guest-user.component */ "./src/app/components/guest-user/guest-user.component.ts");
/* harmony import */ var _register_register_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./register/register.component */ "./src/app/components/guest-user/register/register.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let GuestUserModule = /** @class */ (() => {
    let GuestUserModule = class GuestUserModule {
    };
    GuestUserModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [
                ...
                _node_modules_angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"],
                _guest_user_routing_module__WEBPACK_IMPORTED_MODULE_4__["GuestUserRoutingModule"]
            ],
...
/* harmony import */ var _services_login_services_login_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../services/login-services/login.service */ "./src/app/services/login-services/login.service.ts");
...
let RegisterComponent = /** @class */ (() => {
    let RegisterComponent = class RegisterComponent {
        constructor(login, router, msgService, auth) {
            this.login = login;
            this.router = router;
        ...
        alternateLoginOTPVerification() {
            ...
            this.login.validateOTPCode(this.otpVerificationInfo).subscribe((res) => {
                if (res) {
                    // institute
                        ...
                        if (this.loginDataForm.mobile_no.length == 10) {
                            if (this.loginDataForm.password.length >= 5 && this.loginDataForm.confirmPassword.length >= 5) {
                                if (this.loginDataForm.password == this.loginDataForm.confirmPassword) {
                                    this.auth.showLoader();
                                    this.login.guestUserRegistration(this.loginDataForm).subscribe((res) => {
                                        ...
                                        if (res.institutesList != null) {
                                            ...
                                            this.countDown = Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["timer"])(0, 1000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["take"])(this.counter), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(() => --this.counter));
                                        }
                                    }, err => {
                                        console.log(err);
                                        this.isView = 'register';
        ...
        alternateLoginOTPRegenerate() {
            this.auth.showLoader();
            this.login.regenerateOTP(this.otpVerificationInfo).subscribe((res) => {
                if (res) {
                    // institute
                    this.auth.hideLoader();
                    this.otpVerificationInfo = res;
    ...
    RegisterComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
            ...
            template: __importDefault(__webpack_require__(/*! raw-loader!./register.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/guest-user/register/register.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./register.component.scss */ "./src/app/components/guest-user/register/register.component.scss")).default]
        }),
        __metadata("design:paramtypes", [_services_login_services_login_service__WEBPACK_IMPORTED_MODULE_5__["LoginService"],
...
//# sourceMappingURL=app-components-guest-user-guest-user-module-es2015.js.map