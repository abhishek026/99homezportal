(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-course-module-analytics-analytics-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsCourseModuleAnalyticsAllVideosAllVideosComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsCourseModuleAnalyticsDateWiseDateWiseComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsCourseModuleAnalyticsAllVideosAllVideosComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsCourseModuleAnalyticsAllVideosAllVideosComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AllVideosComponent", function () {
      ...
      var AllVideosComponent =
      /** @class */
      function () {
        var AllVideosComponent = /*#__PURE__*/function () {
          function AllVideosComponent(_http, msgService, auth) {
            _classCallCheck(this, AllVideosComponent);
          ...
          _createClass(AllVideosComponent, [{
            key: "ngOnInit",
            value: function ngOnInit() {
              this.allVideo = true; // let url = '/api/v1/instFileSystem/videoReport/institute/' + sessionStorage.getItem('institute_id') + '?pageSize=15&pageOffset=0&sortBy=totalConsumedBandwidth ASC';

              this.allvideo(10, 1);
            }
          }, {
            key: "allvideo",
            value: function allvideo(batch, page) {
              var _this = this;

              var url = '/api/v1/instFileSystem/videoReport/institute/' + sessionStorage.getItem('institute_id') + '?pageSize=' + batch + '&pageOffset=' + page;

              this._http.getData(url).subscribe(function (resp) {
                // this.pageSize = resp.result.pageSize;
                _this.allVideoData = resp.result.response;
                _this.totalRecords = resp.result.totalElements;
                console.log(_this.allVideoData);
              }, function (err) {
            ...
            key: "totalVideoTitle",
            value: function totalVideoTitle(val, t, batch, page) {
              var _this2 = this;
              ...
              this.allVideo = false;
              this.userwiseDetail = [];
              var url = '/api/v1/instFileSystem/videoReport/video/' + val + '?pageSize=' + batch + '&pageOffset=' + page + '&sortBy=createdDate ASC'; // let url = '/api/v1/instFileSystem/videoReport/17841/' + val + '?pageSize=' + batch + '&pageOffset=' + page + '&sortBy=createdDate ASC';

              this._http.getData(url).subscribe(function (resp) {
                _this2.userwiseDetail = resp.result.video_list.response;
                _this2.totalRecords = resp.result.video_list.totalElements;
                console.log(_this2.userwiseDetail);
              }, function (err) {
            ...
            value: function fetchTableDataByPage(index) {
              if (this.allVideo) {
                ...
                var _startindex = this.displayBatchSize * (index - 1);

                this.userwiseDetail = this.getDataFromDataSource(_startindex);
              }
            }
          }, {
            key: "fetchNext",
        ...
        AllVideosComponent.ctorParameters = function () {
          return [{
        ...
        AllVideosComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          selector: 'app-all-videos',
          template: __importDefault(__webpack_require__(
          /*! raw-loader!./all-videos.component.html */
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/course-module/analytics/all-videos/all-videos.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./all-videos.component.scss */
          "./src/app/components/course-module/analytics/all-videos/all-videos.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [_services_http_service__WEBPACK_IMPORTED_MODULE_2__["HttpService"], _services_message_show_service__WEBPACK_IMPORTED_MODULE_3__["MessageShowService"], _services_authenticator_service__WEBPACK_IMPORTED_MODULE_1__["AuthenticatorService"]])], AllVideosComponent);
        return AllVideosComponent;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsCourseModuleAnalyticsAnalyticsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _all_videos_all_videos_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./all-videos/all-videos.component */
      "./src/app/components/course-module/analytics/all-videos/all-videos.component.ts");
      /* harmony import */
      ...
      var _date_wise_date_wise_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./date-wise/date-wise.component */
      ...
      function () {
        ...
        AnalyticsRoutingModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
    ...
    /***/
    function srcAppComponentsCourseModuleAnalyticsAnalyticsModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _all_videos_all_videos_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./all-videos/all-videos.component */
      "./src/app/components/course-module/analytics/all-videos/all-videos.component.ts");
      /* harmony import */
      ...
      function () {
        ...
        AnalyticsModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
          declarations: [_date_wise_date_wise_component__WEBPACK_IMPORTED_MODULE_4__["DateWiseComponent"], _all_videos_all_videos_component__WEBPACK_IMPORTED_MODULE_5__["AllVideosComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_2__["SharedModule"], _analytics_routing_module__WEBPACK_IMPORTED_MODULE_3__["AnalyticsRoutingModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_6__["MatPaginatorModule"]]
        })], AnalyticsModule);
        return AnalyticsModule;
      }();
      /***/
    ...
    /***/
    function srcAppComponentsCourseModuleAnalyticsDateWiseDateWiseComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentsCourseModuleAnalyticsDateWiseDateWiseComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "DateWiseComponent", function () {
      ...
      var DateWiseComponent =
      /** @class */
      function () {
        var DateWiseComponent = /*#__PURE__*/function () {
          function DateWiseComponent(_http, msgService, auth) {
            _classCallCheck(this, DateWiseComponent);
          ...
          _createClass(DateWiseComponent, [{
            key: "ngOnInit",
            value: function ngOnInit() {
            ...
            value: function custom() {
              var url = '/api/v1/instFileSystem//videoReport/report/' + sessionStorage.getItem('institute_id') + '?from=' + moment__WEBPACK_IMPORTED_MODULE_2__(this.from_date).format('DD-MM-YYYY') + '&to=' + moment__WEBPACK_IMPORTED_MODULE_2__(this.to_date).format('DD-MM-YYYY') + '&reportType=0';
              this.chartFormat = 'DD-MMM-YYYY';
              this.dailyReport(url);
            }
          }, {
            key: "dailyReport",
            value: function dailyReport(url) {
              var _this3 = this;
              ...
              this._http.getData(url).subscribe(function (resp) {
                ...
                _this3.weekDataSource = resp.result.response;
                _this3.max_graph_value = Math.round(resp.result.max_graph_value);
                _this3.weekData = _this3.getDataFromDataSource(0);
                console.log('week', _this3.weekData);
                _this3.totalRecords = _this3.weekDataSource.length;

                _this3.generateChartData(_this3.weekDataSource);
              }, function (err) {
                _this3.auth.hideLoader();
            ...
            value: function generateChartData(res) {
              ...
              var band = [];
              res.map(function (e) {
                dateMap.push(moment__WEBPACK_IMPORTED_MODULE_2__(e.date).format(_this4.chartFormat));
            ...
            key: "videoWise",
            value: function videoWise(val, batch, page) {
              var _this5 = this;

              this.PageIndex = page;
              this.selectType = "video";
              var to = moment__WEBPACK_IMPORTED_MODULE_2__(val).format('DD-MM-YYYY');
              var from = moment__WEBPACK_IMPORTED_MODULE_2__(val).format('DD-MM-YYYY');
              ...
              this.dateWiseSelection = false;
              this.videoData = [];
              var url = '/api/v1/instFileSystem/videoReport/institute/' + sessionStorage.getItem('institute_id') + '?pageSize=' + batch + '&pageOffset=' + page + '&from=' + to + '&to=' + from;

              this._http.getData(url).subscribe(function (resp) {
                _this5.videoData = resp.result.response;
                sessionStorage.setItem('fromDate', val); // this.videoData = this.getDataFromDataSource(0);
                // if (this.videoWiseSelection) {
                // this.totalElements = resp.result.totalElements;

                _this5.totalRecords = resp.result.totalElements; // }

                console.log(_this5.videoData);
              }, function (err) {
            ...
            key: "userwise",
            value: function userwise(val, t, batch, page) {
              var _this6 = this;
              ...
              this.userwiseDetail = []; // this.totalElements = 

              this.userWiseSelection = true;
              this.videoWiseSelection = false;
              var date = sessionStorage.getItem('fromDate');
              var url = '/api/v1/instFileSystem/videoReport/video/' + val + '?pageSize=' + batch + '&pageOffset=' + page + '&sortBy=createdDate ASC';

              if (date != '' && date != null) {
                var to = moment__WEBPACK_IMPORTED_MODULE_2__(date).format('DD-MM-YYYY');
                var from = moment__WEBPACK_IMPORTED_MODULE_2__(date).format('DD-MM-YYYY');
              ...
              this._http.getData(url).subscribe(function (resp) {
                _this6.userwiseDetail = resp.result.video_list.response; // this.userwiseDetail = this.getDataFromDataSource(0);

                console.log(" this.userwiseDetail", _this6.userwiseDetail);
                _this6.totalRecords = resp.result.video_list.totalElements;
              }, function (err) {
            ...
            value: function searchDatabase() {
              ...
              if (this.searchText != "" && this.searchText != null) {
                var searchData;
                searchData = this.videoData.filter(function (item) {
                  return Object.keys(item).some(function (k) {
                    return item[k] != null && item[k].toString().toLowerCase().includes(_this7.searchText.toLowerCase());
                  });
                });
            ...
            key: "searchDatabaseUser",
            value: function searchDatabaseUser() {
              var _this8 = this;

              if (this.searchText1 != "" && this.searchText1 != null) {
                var searchData;
                searchData = this.userwiseDetail.filter(function (item) {
                  return Object.keys(item).some(function (k) {
                    return item[k] != null && item[k].toString().toLowerCase().includes(_this8.searchText1.toLowerCase());
                  });
                });
            ...
            value: function fetchTableDataByPage(index) {
              if (this.dateWiseSelection) {
                ...
                var _startindex2 = this.displayBatchSize * (index - 1);

                this.videoData = this.getDataFromDataSource(_startindex2);
              } else if (this.userWiseSelection) {
                this.PageIndex = index;

                var _startindex3 = this.displayBatchSize * (index - 1);

                this.userwiseDetail = this.getDataFromDataSource(_startindex3);
              }
            }
          }, {
            key: "fetchNext",
            ...
            value: function getDataFromDataSource(startindex) {
              if (this.dateWiseSelection) {
                var t = this.weekDataSource.slice(startindex, startindex + this.displayBatchSize);
                return t;
              } else if (this.videoWiseSelection) {
                this.videoWise(sessionStorage.getItem('videWise'), this.displayBatchSize, this.PageIndex); // let t = this.videoDataSource.slice(startindex, startindex + this.displayBatchSize);
                // return t;
              } else if (this.userWiseSelection) {
                this.userwise(sessionStorage.getItem('userWise'), sessionStorage.getItem('title'), this.displayBatchSize, this.PageIndex); // let t = this.userDataSource.slice(startindex, startindex + this.displayBatchSize);
                // return t;
              }
            }
          }, {
            ...
            value: function dateValidationForFuture(e) {
              ...
              var selected = moment__WEBPACK_IMPORTED_MODULE_2__(e);
              var diff = moment__WEBPACK_IMPORTED_MODULE_2__(selected.diff(today))['_i'];
        ...
        DateWiseComponent.ctorParameters = function () {
          return [{
        ...
        DateWiseComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
          selector: 'app-date-wise',
          template: __importDefault(__webpack_require__(
          /*! raw-loader!./date-wise.component.html */
          "./node_modules/raw-loader/dist/cjs.js!./src/app/components/course-module/analytics/date-wise/date-wise.component.html"))["default"],
          styles: [__importDefault(__webpack_require__(
          /*! ./date-wise.component.scss */
          "./src/app/components/course-module/analytics/date-wise/date-wise.component.scss"))["default"]]
        }), __metadata("design:paramtypes", [_services_http_service__WEBPACK_IMPORTED_MODULE_4__["HttpService"], _services_message_show_service__WEBPACK_IMPORTED_MODULE_5__["MessageShowService"], _services_authenticator_service__WEBPACK_IMPORTED_MODULE_3__["AuthenticatorService"]])], DateWiseComponent);
        return DateWiseComponent;
      }();
      /***/
...
//# sourceMappingURL=components-course-module-analytics-analytics-module-es5.js.map